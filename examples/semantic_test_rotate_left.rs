...
pub fn rotate_left_element(a: i32, b: i32, c: i32, d: i32, e: i32, idx: i32) -> i32 {
    let _cse_temp_0 = idx == 0;
    if _cse_temp_0 {
        return c;
    }
    let _cse_temp_1 = idx == 1;
    if _cse_temp_1 {
        return d;
    }
    let _cse_temp_2 = idx == 2;
    if _cse_temp_2 {
        return e;
    }
    let _cse_temp_3 = idx == 3;
    if _cse_temp_3 {
        return a;
    }
    b
...
#[doc = " Depyler: proven to terminate"]
pub fn main() {
    println!("{}", rotate_left_element(1, 2, 3, 4, 5, 0));
}
