...
pub fn main() {
    let data: std::collections::HashMap<String, DepylerValue> = {
        ...
        map.insert("count".to_string(), DepylerValue::Int(42 as i64));
        map.insert("enabled".to_string(), DepylerValue::Bool(true));
        map.insert("rate".to_string(), DepylerValue::Float(3.14 as f64));
        map.insert(
            "items".to_string(),
