...
pub fn range_sum(start: i32, end: i32) -> i32 {
...
mod tests {
    ...
    #[test]
    fn test_range_sum_examples() {
        assert_eq!(range_sum(0, 0), 0);
        assert_eq!(range_sum(1, 2), 3);
        assert_eq!(range_sum(-1, 1), 0);
    }
}
