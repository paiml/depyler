...
pub fn test_nested_access() -> Result<String, Box<dyn std::error::Error>> {
    let d: std::collections::HashMap<String, std::collections::HashMap<String, String>> = {
        let mut map: HashMap<String, std::collections::HashMap<String, String>> = HashMap::new();
