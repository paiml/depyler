...
impl LinkedNode {
    ...
    pub fn set_next(&mut self, node_id: i32) {
        self.next = node_id;
    }
...
#[doc = "Test stack operations."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn test_stack() -> i32 {
...
#[doc = "Test config operations."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn test_config() -> String {
    let mut c: Config = Config::new("test".to_string());
    c.enable_debug();
    c.add_tag("production".to_string());
    c.name
}
#[doc = "Test counter operations."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
...
mod tests {
    ...
    #[test]
    fn test_test_stack_examples() {
        let _ = test_stack();
    }
    #[test]
    fn test_test_counter_examples() {
        let _ = test_counter();
    }
}