...
impl DataProcessor {
    ...
    pub fn add_data(&mut self, value: i32) {
        self.data.push(DepylerValue::Int(value as i64));
    }
    pub fn get_count(&self) -> i32 {
        return self.data.clone().len() as i32;
    }
...
pub fn process_data(items: &Vec<i32>) -> HashMap<String, i32> {
    ...
    stats.insert("count".to_string(), _cse_temp_0);
    let _cse_temp_1 = items.iter().sum::<i32>();
    stats.insert("sum".to_string(), _cse_temp_1);
    stats
}
#[cfg(test)]
mod tests {
