...
pub fn parse_json_string(json_str: &str) -> std::collections::HashMap<DepylerValue, DepylerValue> {
    std::collections::HashMap::<String, DepylerValue>::new()
}
#[doc = "Convert data to JSON string"]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn to_json_string(data: &std::collections::HashMap<DepylerValue, DepylerValue>) -> String {
    format!("{:?}", data)
}
...
pub fn parse_json_with_default(
    json_str: &str,
    default: std::collections::HashMap<DepylerValue, DepylerValue>,
) -> std::collections::HashMap<DepylerValue, DepylerValue> {
