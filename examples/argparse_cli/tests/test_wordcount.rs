...
impl TestCountFile {
    ...
    pub fn test_count_file_success(&self, tmp_path: serde_json::Value) {
        ...
        let mut stats = wordcount.count_file(test_file);
    ...
    pub fn test_count_file_empty(&self, tmp_path: serde_json::Value) {
        let mut test_file = tmp_path / "empty.txt".to_string();
    ...
    pub fn test_count_file_single_line_no_newline(&self, tmp_path: serde_json::Value) {
        let mut test_file = tmp_path / "single.txt".to_string();
    ...
    pub fn test_count_file_multiple_spaces(&self, tmp_path: serde_json::Value) {
        let mut test_file = tmp_path / "spaces.txt".to_string();
    ...
    pub fn test_count_file_blank_lines(&self, tmp_path: serde_json::Value) {
        let mut test_file = tmp_path / "blanks.txt".to_string();
        test_file.write_text("line1\n\nline3\n\n".to_string());
        let mut stats = wordcount.count_file(test_file);
    ...
    pub fn test_count_file_unicode(&self, tmp_path: serde_json::Value) {
        let mut test_file = tmp_path / "unicode.txt".to_string();
    ...
    pub fn test_count_file_ioerror(&self, tmp_path: serde_json::Value, capsys: serde_json::Value) {
        let mut nonexistent = tmp_path / "nonexistent.txt".to_string();
        let mut stats = wordcount.count_file(nonexistent);
        assert!(stats.lines == 0);
        assert!(stats.words == 0);
        assert!(stats.chars == 0);
...
impl TestFormatStats {
    ...
    pub fn test_format_stats_with_filename(&self) {
        let mut stats = wordcount.Stats(10, 20, 30, "test.txt".to_string());
        let mut result = wordcount.format_stats(stats);
        assert!(result == "      10       20       30 test.txt".to_string());
    }
    pub fn test_format_stats_without_filename(&self) {
        let mut stats = wordcount.Stats(5, 15, 25, "test.txt".to_string());
        let mut result = wordcount.format_stats(stats);
    ...
    pub fn test_format_stats_default_with_filename(&self) {
        let mut stats = wordcount.Stats(1, 2, 3, "file.txt".to_string());
        let mut result = wordcount.format_stats(stats);
        assert!(result.contains(&"file.txt".to_string()));
    }
    pub fn test_format_stats_alignment(&self) {
        let mut stats = wordcount.Stats(999, 8888, 77777, "test.txt".to_string());
        let mut result = wordcount.format_stats(stats);
...
impl TestMainFunction {
    ...
    pub fn test_main_single_file(
        ...
        let mut exit_code = wordcount.main();
        assert!(exit_code == 0);
        let mut captured = capsys.readouterr();
    ...
    pub fn test_main_multiple_files(
        ...
        let mut file1 = tmp_path / "file1.txt".to_string();
        file1.write_text("one\ntwo\n".to_string());
        let mut file2 = tmp_path / "file2.txt".to_string();
    ...
    pub fn test_main_nonexistent_file(
        ...
        let mut nonexistent = tmp_path / "doesnotexist.txt".to_string();
        monkeypatch.setattr(
            sys,
            "argv".to_string(),
...
impl TestPropertyBased {
    ...
    pub fn test_count_file_chars_property(
        ...
        let mut tmp_path = tmp_path_factory.mktemp("data".to_string());
        let mut test_file = tmp_path / "test.txt".to_string();
        test_file.write_text(content);
        let mut stats = wordcount.count_file(test_file);
        assert!(stats.chars == content.len());
    }
    pub fn test_count_file_words_property(
        ...
        let mut tmp_path = tmp_path_factory.mktemp("data".to_string());
        let mut test_file = tmp_path / "test.txt".to_string();
        let mut content = words.join(" ".to_string());
        test_file.write_text(content);
        let mut stats = wordcount.count_file(test_file);
        let mut expected_words = content
            .split_whitespace()
            .map(|s| s.to_string())
            .collect::<Vec<String>>()
            .len();
    ...
    pub fn test_count_file_lines_property(
        ...
        test_file.write_text(content);
        let mut stats = wordcount.count_file(test_file);
        let mut expected_lines = content.splitlines().len();
    ...
    pub fn test_format_stats_property(
        ...
        let mut stats = wordcount.Stats(lines, words, chars, "test.txt".to_string());
        let mut result = wordcount.format_stats(stats);
        let mut parts = result
            .split_whitespace()
            .map(|s| s.to_string())
...
impl TestIntegration {
    ...
    pub fn test_main_entry_point_via_subprocess(&self, tmp_path: serde_json::Value) {
        ...
        let mut test_file = tmp_path / "test.txt".to_string();
        test_file.write_text("hello world\n".to_string());
        let mut result = subprocess.run(vec![
            sys.executable,
    ...
    pub fn test_sample_file_exact_output(
        ...
        let mut sample = tmp_path / "sample.txt".to_string();
    ...
    pub fn test_mixed_existing_and_nonexistent_files(
        ...
        let mut valid_file = tmp_path / "valid.txt".to_string();
        valid_file.write_text("content".to_string());
        let mut invalid_file = tmp_path / "invalid.txt".to_string();
        monkeypatch.setattr(
            sys,
            "argv".to_string(),
            vec![
    ...
    pub fn test_all_flags_with_multiple_files(
        ...
        let mut file1 = tmp_path / "f1.txt".to_string();
        file1.write_text("one two\nthree\n".to_string());
        let mut file2 = tmp_path / "f2.txt".to_string();
