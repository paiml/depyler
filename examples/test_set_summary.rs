...
pub fn test_all_set_features() -> std::collections::HashSet<i32> {
    let mut s1: std::collections::HashSet<i32> = {
    ...
    let mut s2: std::collections::HashSet<i32> = vec![4, 5, 6]
        .into_iter()
        .collect::<std::collections::HashSet<_>>();
    let empty: std::collections::HashSet<i32> = std::collections::HashSet::<i32>::new();
    let _cse_temp_0 = s1
        .union(&s2)
        .cloned()
        .collect::<std::collections::HashSet<_>>();
    let union = _cse_temp_0.clone();
    let _cse_temp_1 = {
        let mut set = std::collections::HashSet::new();
        set.insert(1);
        set.insert(2);
    ...
    .cloned()
    .collect::<std::collections::HashSet<_>>();
    let intersection = _cse_temp_1.clone();
    let _cse_temp_2 = ({
        let mut set = std::collections::HashSet::new();
        set.insert(1);
        set.insert(2);
    ...
    let difference = _cse_temp_2.clone();
    let _cse_temp_3 = {
        let mut set = std::collections::HashSet::new();
        set.insert(1);
        set.insert(2);
    ...
    .cloned()
    .collect::<std::collections::HashSet<_>>();
    let symmetric_diff = _cse_temp_3.clone();
    s1.insert(4);
    s2.remove(&5);
