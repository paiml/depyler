...
pub fn calculate_statistics(
    ...
    stats.insert("min".to_string().to_string(), min_val);
    stats.insert("max".to_string().to_string(), max_val);
    stats.insert("range".to_string().to_string(), max_val - min_val);
...
pub fn calculate_percentiles(
    ...
    percentiles.insert("iqr".to_string().to_string(), _cse_temp_7);
    Ok(percentiles)
}
