...
pub fn apply_func(x: i32, f: impl Fn(i32) -> i32) -> i32 {
    f(x)
}
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn test_lambda_passing() -> i32 {
    let result1: i32 = apply_func(10, move |x: i64| (x).py_mul(2));
    let result2: i32 = apply_func(5, move |x: i64| (x).py_add(10));
    let triple = move |x: i64| (x).py_mul(3);
...
mod tests {
    ...
    #[test]
    fn test_test_lambda_passing_examples() {
        let _ = test_lambda_passing();
    }
}
