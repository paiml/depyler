...
pub fn main() {
    let data: std::collections::HashMap<String, i32> = {
        ...
        map.insert("one".to_string(), (1) as i32);
        map.insert("two".to_string(), (2) as i32);
        map.insert("three".to_string(), (3) as i32);
        map.insert("four".to_string(), (4) as i32);
        map
    };
    println!("{}", dict_size(&data));
}
