...
pub fn test_min_max() -> Result<tuple, IndexError> {
...
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn calculate_quartiles(data: Vec<f64>) -> tuple {
...
pub fn calculate_iqr(data: Vec<f64>) -> Result<f64, IndexError> {
    let quartiles: tuple = calculate_quartiles(&data)?;
    let q1: f64 = {
        let base = &quartiles;
        let idx: i32 = 0;
        let actual_idx = if idx < 0 {
...
pub fn calculate_correlation(x: Vec<f64>, y: Vec<f64>) -> Result<f64, ZeroDivisionError> {
    ...
    let x_stdev: f64 = ((x_var_sum as f64) / ((x.len() as i32) as f64 as f64)).sqrt();
    let mut y_total: f64 = 0.0;
    ...
    let y_stdev: f64 = ((y_var_sum as f64) / ((y.len() as i32) as f64 as f64)).sqrt();
...
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn test_all_statistics_features() {
