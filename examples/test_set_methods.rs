// Generated by: depyler transpile ./examples/test_set_methods.py
// Source: ./examples/test_set_methods.py
// Command: depyler transpile ./examples/test_set_methods.py
...
#[doc = " Depyler: verified panic-free"] #[doc = " Depyler: proven to terminate"] pub fn test_set_clear()  -> DynamicType {
    ...
    let mut _cse_temp_1 = _cse_temp_0 == 0;
    return _cse_temp_1;
