...
pub fn mul_floats(a: f64, b: f64) -> f64 {
    (a).py_mul(b)
}
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn main() {
    let result: f64 = mul_floats(2.0, 3.0);
...
mod tests {
    ...
    #[test]
    fn quickcheck_mul_floats() {
        fn prop(a: f64, b: f64) -> TestResult {
            if a.is_nan() || b.is_nan() || a.is_infinite() || b.is_infinite() {
                return TestResult::discard();
            }
            let result1 = mul_floats(a.clone(), b.clone());
            let result2 = mul_floats(b.clone(), a.clone());
            if result1 != result2 {
