...
pub fn range_product(start: i32, end: i32) -> i32 {
...
mod tests {
    ...
    #[test]
    fn test_range_product_examples() {
        assert_eq!(range_product(0, 0), 0);
        assert_eq!(range_product(1, 2), 3);
        assert_eq!(range_product(-1, 1), 0);
    }
}
