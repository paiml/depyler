...
pub fn create_nested_path<'b, 'a>(
    ...
    path = std::path::PathBuf::from(&base);
    for part in parts.iter().cloned() {
        path = (path).py_div(part);
    }
...
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn get_file_info(filepath: &str) -> (DepylerValue, DepylerValue, DepylerValue) {
...
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn check_path_exists(filepath: &str) -> bool {
