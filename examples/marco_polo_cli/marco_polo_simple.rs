...
pub fn format_statistics(
    ...
    let _cse_temp_1 = ((result).py_add("Score: ")).py_add(_cse_temp_0);
    result = (_cse_temp_1).py_add("\n");
    let _cse_temp_2 = (attempts).to_string();
    let _cse_temp_3 = ((result).py_add("Attempts: ")).py_add(_cse_temp_2);
    result = (_cse_temp_3).py_add("\n");
    let _cse_temp_4 = (avg).to_string();
    let _cse_temp_5 = ((result).py_add("Average: ")).py_add(_cse_temp_4);
    result = (_cse_temp_5).py_add("\n");
    Ok(result.to_string())
}
