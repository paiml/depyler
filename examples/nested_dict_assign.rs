// Generated by: depyler transpile ./examples/nested_dict_assign.py
// Source: ./examples/nested_dict_assign.py
// Command: depyler transpile ./examples/nested_dict_assign.py
