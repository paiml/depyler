...
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn test_set_comp_with_condition() -> std::collections::HashSet<i32> {
    (0..(10))
        .into_iter()
        .filter(|x| {
            let x = x.clone();
...
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn test_set_comp_from_list() -> std::collections::HashSet<String> {
    let words = vec![
        "hello".to_string(),
        "world".to_string(),
        "hello".to_string(),
...
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn test_set_comp_complex_expr() -> std::collections::HashSet<i32> {
...
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn test_set_comp_with_expression() -> std::collections::HashSet<i32> {
    (0..(5))
        .into_iter()
        .filter(|x| {
            let x = x.clone();
