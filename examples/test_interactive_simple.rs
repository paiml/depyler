#[doc = "Add two numbers."] #[doc = " Depyler: verified panic-free"] #[doc = " Depyler: proven to terminate"] pub fn add_numbers(a: i32, b: i32)  -> i32 {
    return a + b;
   
}
#[doc = "Multiply two numbers."] #[doc = " Depyler: verified panic-free"] #[doc = " Depyler: proven to terminate"] pub fn multiply(x: i32, y: i32)  -> i32 {
    let _cse_temp_0 = x * y;
