...
pub fn showcase_dictionary_assignment() -> (
    std::collections::HashMap<
        String,
        std::collections::HashMap<String, std::collections::HashMap<DepylerValue, DepylerValue>>,
    >,
    std::collections::HashMap<DepylerValue, DepylerValue>,
) {
    let mut d = {
    ...
    coords.insert(
        (10, 20).to_string(),
        DepylerValue::Str("location A".to_string()),
    );
    coords.insert(
        (30, 40).to_string(),
        DepylerValue::Str("location B".to_string()),
    );
    (nested, coords)
}
...
pub fn showcase_set_operations() -> (
    ...
    let difference = (set1).py_sub(set2);
...
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn showcase_frozen_sets() -> (
    DepylerValue,
    std::collections::HashMap<DepylerValue, String>,
) {
