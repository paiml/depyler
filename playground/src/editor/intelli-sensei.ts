...
export class IntelliSensei {
  ...
  private registerDepylerLanguage() {
    // Skip language registration - already done in CodeEditor
    // Enhanced Python language with Depyler annotations
    // this.monaco.languages.register({ id: "python-depyler" });

    // Skip tokenizer setup - already done in CodeEditor to avoid conflicts
        ...
        suggestions: [
          {
            ...
            documentation:
              "Enable energy-efficient optimizations including CPU and memory usage reduction",
