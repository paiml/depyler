...
export function PerformanceChart({ executionResult, width = 400, height = 300 }: PerformanceChartProps) {
  ...
  useEffect(() => {
    ...
    const speedup = executionResult.python.execution_time_ms / executionResult.rust.execution_time_ms;
    if (speedup > 1) {
      g.append('text')
        .attr('x', innerWidth / 2)
        .attr('y', -5)
