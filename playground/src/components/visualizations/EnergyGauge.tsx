    ...
    <div className="mt-6 space-y-4">
        ...
        <div className="bg-yellow-50 rounded-lg p-4 border border-yellow-200">
          ...
          <div className="space-y-1 text-sm">
            <div className="flex justify-between">
              ...
              <span className="font-mono text-yellow-900">{formatEnergy(energyData.python.joules)}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-yellow-700">CO₂:</span>
              <span className="font-mono text-yellow-900">{formatCO2(energyData.python.co2Grams)}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-yellow-700">CPU:</span>
              <span className="font-mono text-yellow-900">{formatEnergy(energyData.python.breakdown.cpu)}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-yellow-700">Memory:</span>
              <span className="font-mono text-yellow-900">{formatEnergy(energyData.python.breakdown.memory)}</span>
            </div>
          </div>
        </div>
        ...
        <div className="bg-green-50 rounded-lg p-4 border border-green-200">
          ...
          <div className="space-y-1 text-sm">
            <div className="flex justify-between">
              ...
              <span className="font-mono text-green-900">{formatEnergy(energyData.rust.joules)}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-green-700">CO₂:</span>
              <span className="font-mono text-green-900">{formatCO2(energyData.rust.co2Grams)}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-green-700">CPU:</span>
              <span className="font-mono text-green-900">{formatEnergy(energyData.rust.breakdown.cpu)}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-green-700">Memory:</span>
              <span className="font-mono text-green-900">{formatEnergy(energyData.rust.breakdown.memory)}</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-blue-50 rounded-lg p-4 border border-blue-200">
        ...
        <div className="text-sm text-blue-700">
          ...
          <p>
            <strong>CO₂ reduction:</strong> {formatCO2(energyData.python.co2Grams - energyData.rust.co2Grams)} per execution
          </p>
        </div>
      </div>
    </div>
