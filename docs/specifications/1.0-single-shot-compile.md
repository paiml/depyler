...
**Version**: 1.83.0 (DEPYLER-1138: Property-to-Method Promotion)
**Date**: 2026-01-15
...
*   **DEPYLER-1136**: COMPLETE — **Alias Stub Generation**. Resolved the #1 Pareto blocker (E0425). When `import X as Y` is encountered, the transpiler now generates a Rust module or struct alias `Y` so that `Y.method()` calls are resolved. **Result: 138 E0425 errors eliminated.**
...
138. [ ] **Numeric Coercion** **PENDING**: Unify mixed int/float operations in PyOps traits. (DEPYLER-1135)
