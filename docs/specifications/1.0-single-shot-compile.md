...
*   **DEPYLER-1135**: IN PROGRESS — **Numeric Coercion**. Implementing Universal Numeric Promotion for PyOps traits to handle mixed int/float operations found in NumPy aggregations.
...
139. [ ] **Numeric Coercion** **PENDING**: Unify mixed int/float operations in PyOps traits. (DEPYLER-1135)
