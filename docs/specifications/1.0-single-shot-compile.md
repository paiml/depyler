...
**Key Insight**: 80% of corpus is Tier 1 (typed Python). The theoretical ceiling is **82.1%**. Current true success is **2.2%** (4 files) — a valid starting point to expand from.
...
| **SEMANTIC** | 100% | 🔴 ALL compiling files fail parity |
