...
**Version**: 2.6.0 (PHASE 0 COMPLETE: 19 Files on GREEN LIST, 10.6% True Success)
**Date**: 2026-01-25
...
| Metric | Value | Notes |
|--------|-------|-------|
| **GREEN LIST** | **19 files** | 🟢 Verified semantic parity |
| **TRUE Success Rate** | **10.6%** | 19/178 files with correct output |
| **Compile Rate** | ~10% | Raw compilation (not meaningful alone) |
...
```
┌─────────────────────────────────────────────────────────────────┐
│  OPERATION BREAKOUT: PHASE 0 RESULTS                            │
│                                                                 │
│  TRUE Success Rate:  0% → 10.6% (+10.6pp)                       │
│  GREEN LIST:         0 → 19 files                               │
│                                                                 │
│  Level 1: Pure functions     ████████████████████ 8/8  (100%)   │
│  Level 2: String operations  ███████████████████  3/3  (100%)   │
│  Level 3: List operations    █████████████        2/3  (67%)    │
│  Level 4: Control flow       ████████████████████ 4/4  (100%)   │
│  Level 5: Boolean operations ████████████████████ 2/2  (100%)   │
│                                                                 │
│  TOTAL: 19/22 systematic tests passing (86%)                    │
└─────────────────────────────────────────────────────────────────┘
```

### GREEN LIST (19 Verified Files)

| Level | Files | Pass Rate |
|-------|-------|-----------|
| **1: Pure Functions** | add, subtract, multiply, divide, floor_div, modulo, power, abs | 8/8 (100%) |
| **2: String Ops** | concat, repeat, upper | 3/3 (100%) |
| **3: List Ops** | sum, indexing | 2/3 (67%) |
...
|--------|-------|------------|--------|
| **DEPYLER-1365** | `Ok(3)` instead of `3` | println uses `{:?}` with Result | +3 files if fixed |
...
**Key Insight**: 80% of corpus is Tier 1 (typed Python). The theoretical ceiling is **82.1%**. Current true success is **10.6%** (19 files) — validated foundation to expand from.
...
| **SEMANTIC** | 89.4% | 🟡 159/178 files need parity validation |
