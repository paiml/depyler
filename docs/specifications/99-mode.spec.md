...
*Last measured: 2026-02-11*

| Corpus | Files | Compile Rate | Gap to 99% |
|--------|-------|--------------|------------|
| Internal examples | 1410 | 97.4% | 1.6 pp |

**Measured Compile Rates (2026-02-11, DEPYLER-99MODE-S9)**:
- Internal examples: 1374/1410 = 97.4% (rustc --crate-type=lib validation)
...
- 2026-02-11: 96.9% (1144/1180) → 97.0% (1174/1210) → 97.1% (1224/1260) → **97.4% (1374/1410)**
