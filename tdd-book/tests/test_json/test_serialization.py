# tests/test_json/test_serialization.py
"""
TDD examples for json module - JSON encoding and decoding.
...
class TestJsonLoads:
    ...
    def test_loads_invalid_json_raises(self):
        ...
        with pytest.raises(json.JSONDecodeError):
            json.loads("[1, 2,]")  # Trailing comma not allowed
...
class TestJsonDumps:
    ...
    def test_dumps_ensure_ascii(self):
        ...
        data = {"emoji": "❤"}
        # Default: ensure_ascii=True, escapes unicode
...
class TestJsonEdgeCases:
    ...
    def test_inf_nan_allowed_by_default(self):
        ...
        # Python's json module allows these by default, though not in JSON spec
    ...
    def test_float_precision_quirks(self):
        ...
        # Some floats can't be represented exactly
        original = 0.1 + 0.2  # Actually 0.30000000000000004
        json_str = json.dumps(original)
        result = json.loads(json_str)
...
__module_link__ = "https://docs.python.org/3/library/json.html"
__test_count__ = 32
__coverage__ = 0.80  # ~80% of common json functions and parameters
