# tests/test_functools/test_higher_order.py
"""
TDD examples for functools module - higher-order functions and decorators.
...
__module_name__ = "functools"
__module_link__ = "https://docs.python.org/3/library/functools.html"
__test_count__ = 28
__coverage__ = 0.85  # ~85% of common functools functions
