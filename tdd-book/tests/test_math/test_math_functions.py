"""Test math module - Mathematical functions.

This module tests math for numeric operations, trigonometry, and special
...
class TestIntegerMath:
    ...
    def test_isqrt(self):
        ...
        assert math.isqrt(10) == 3  # Floor of sqrt(10)
...
class TestFloatingPoint:
    ...
    def test_isclose(self):
        ...
        # Default rel_tol is 1e-9, so values must be very close
    ...
    def test_isclose_abs_tol(self):
        ...
        assert math.isclose(0, 0.00001, abs_tol=0.0001)
...
class TestSpecialFunctions:
    ...
    def test_remainder(self):
        ...
        # remainder vs fmod: remainder can be negative
    ...
    def test_frexp(self):
        ...
        assert exponent == 4
        # Verify: mantissa * 2^exponent == original
