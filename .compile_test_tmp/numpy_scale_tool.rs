...
pub fn main() {
    ...
    let _cse_temp_0 = matches!(args.command, Some(Commands::Scale3 { .. }));
    match &args.command {
        Some(Commands::Scale3 {
            ref a,
            ref b,
            ref c,
            ref scalar,
            ...
            let _cse_temp_1 = arr.scale(scalar as f32).unwrap();
        ...
        Some(Commands::Scale4 {
            ...
            let _cse_temp_3 = arr.scale(scalar as f32).unwrap();
        ...
        Some(Commands::Scale2 {
            ...
            let _cse_temp_5 = arr.scale(scalar as f32).unwrap();
