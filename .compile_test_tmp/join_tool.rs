...
#[doc = "Join three strings with underscores.\n\n   >>>join_underscore(\"hello\", \"world\", \"test\")\n    'hello_world_test'\n   >>>join_underscore(\"\", \"x\", \"\")\n    '_x_'\n    "]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn join_underscore<'b, 'c, 'a>(a: &'a str, b: &'b str, c: &'c str) -> String {
    format!(
        "{}{}",
        format!("{}{}", format!("{}{}", format!("{}{}", a, "_"), b), "_"),
        c
    )
}
#[doc = "Join three strings with dashes.\n\n   >>>join_dash(\"foo\", \"bar\", \"baz\")\n    'foo-bar-baz'\n   >>>join_dash(\"2025\", \"11\", \"29\")\n    '2025-11-29'\n    "]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn join_dash<'c, 'b, 'a>(a: &'a str, b: &'b str, c: &'c str) -> String {
    format!(
        "{}{}",
...
#[doc = "Join three strings with dots.\n\n   >>>join_dot(\"192\", \"168\", \"1\")\n    '192.168.1'\n   >>>join_dot(\"a\", \"b\", \"c\")\n    'a.b.c'\n    "]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn join_dot<'b, 'a, 'c>(a: &'a str, b: &'b str, c: &'c str) -> String {
    format!(
        "{}{}",
        format!("{}{}", format!("{}{}", format!("{}{}", a, "."), b), "."),
        c
...
pub fn main() {
    ...
    let _cse_temp_0 = matches!(args.command, Some(Commands::Underscore { .. }));
    match &args.command {
        Some(Commands::Underscore {
            ref a,
            ref b,
            ref c,
            ..
        }) => {
            println!("{}", join_underscore(&a, &b, &c));
        }
        Some(Commands::Dash {
            ref a,
            ref b,
