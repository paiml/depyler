...
#[doc = "Calculate mean. Depyler: proven to terminate"]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn cmd_mean(numbers: &[String]) {
    let nums = numbers.into_iter().map(|n| (n) as f64).collect::<Vec<_>>();
    println!(
        "{}",
        format!("Mean: {}", {
            let data = nums;
...
#[doc = "Calculate median. Depyler: proven to terminate"]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn cmd_median(numbers: &[String]) {
    let nums = numbers.into_iter().map(|n| (n) as f64).collect::<Vec<_>>();
    println!(
        "{}",
        format!("Median: {}", {
...
#[doc = "Calculate standard deviation. Depyler: proven to terminate"]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn cmd_stdev(numbers: &[String]) {
    let nums = numbers.into_iter().map(|n| (n) as f64).collect::<Vec<_>>();
    println!(
        "{}",
        format!("Stdev: {}", {
...
#[doc = "Calculate mode. Depyler: proven to terminate"]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn cmd_mode(numbers: &[String]) {
    let nums = numbers.into_iter().map(|n| (n) as f64).collect::<Vec<_>>();
    println!(
        "{}",
        format!("Mode: {}", {
...
pub fn main() {
    ...
    ({
        ...
        map.insert("mean".to_string(), cmd_mean);
        map.insert("median".to_string(), cmd_median);
        map.insert("stdev".to_string(), cmd_stdev);
        map.insert("mode".to_string(), cmd_mode);
        map
    }
