...
#[doc = "Sum of five integers.\n\n   >>>sum_five(1, 1, 1, 1, 1)\n    5\n   >>>sum_five(0, 0, 0, 0, 0)\n    0\n   >>>sum_five(10, 20, 30, 40, 50)\n    150\n    "]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn sum_five(a: i32, b: i32, c: i32, d: i32, e: i32) -> i32 {
    a + b + c + d + e
}
#[doc = "Product of three integers.\n\n   >>>product_three(1, 2, 3)\n    6\n   >>>product_three(0, 5, 5)\n    0\n   >>>product_three(2, 2, 2)\n    8\n    "]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn product_three(a: i32, b: i32, c: i32) -> i32 {
    a * b * c
}
#[doc = "Average of three integers.\n\n   >>>average_three(1, 2, 3)\n    2.0\n   >>>average_three(10, 20, 30)\n    20.0\n   >>>average_three(0, 0, 0)\n    0.0\n    "]
#[doc = " Depyler: proven to terminate"]
pub fn average_three(a: f64, b: f64, c: f64) -> Result<f64, Box<dyn std::error::Error>> {
    let _cse_temp_0 = a + b + c;
    let total = _cse_temp_0;
    Ok(((total) as f64) / ((3) as f64))
}
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    match &args.command {
        Some(Commands::Add {
            ...
            let d = *d;
            let e = *e;
            println!("{}", sum_five(a, b, c, d, e));
        }
        Some(Commands::Product {
            ref a,
            ref b,
            ref c,
            ..
