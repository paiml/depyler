...
#[doc = "Compute square of integer.\n\n   >>>square(0)\n    0\n   >>>square(4)\n    16\n   >>>square(-3)\n    9\n    "]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn square(x: i32) -> i32 {
    x * x
}
#[doc = "Compute cube of integer.\n\n   >>>cube(0)\n    0\n   >>>cube(2)\n    8\n   >>>cube(-2)\n    -8\n    "]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn cube(x: i32) -> i32 {
    x * x * x
}
#[doc = "Compute base raised to exp.\n\n   >>>power(2, 0)\n    1\n   >>>power(2, 3)\n    8\n   >>>power(3, 4)\n    81\n    "]
#[doc = " Depyler: verified panic-free"]
...
pub fn main() {
    ...
    let _cse_temp_0 = matches!(args.command, Some(Commands::Square { .. }));
    match &args.command {
        Some(Commands::Square { ref x, .. }) => {
            let x = *x;
            println!("{}", square(x));
        }
        Some(Commands::Cube { ref x, .. }) => {
            let x = *x;
            println!("{}", cube(x));
        }
        Some(Commands::Power {
