...
#![allow(dead_code)]
#[doc = "// NOTE: Map Python module 'colorsys'(tracked in DEPYLER-0424)"]
...
enum Commands {
    #[default]
    __DepylerNone,
    Rgb2hsv { r: i32, g: i32, b: i32 },
    Hsv2rgb { h: f64, s: f64, v: f64 },
    Hex { r: i32, g: i32, b: i32 },
    Rgb2hls { r: i32, g: i32, b: i32 },
}
#[derive(Default)]
...
#[doc = "RGB to HSV. Depyler: proven to terminate"]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn cmd_rgb2hsv(b: i32, g: i32, r: i32) {
    ...
    println!("{}", format!("HSV: {:?}, {:?}, {:?}", h, s, v));
}
#[doc = "HSV to RGB. Depyler: proven to terminate"]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn cmd_hsv2rgb(h: f64, s: f64, v: f64) {
    let (r, g, b) = {
...
#[doc = "RGB to HLS. Depyler: proven to terminate"]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn cmd_rgb2hls(b: i32, g: i32, r: i32) {
    let (r, g, b) = (r / 255, g / 255, b / 255);
    let (h, light, s) = {
        let (r, g, b) = (r as f64, g as f64, b as f64);
        let max_c = r.max(g).max(b);
    ...
    println!("{}", format!("HLS: {:?}, {:?}, {:?}", h, light, s));
}
#[doc = "RGB to Hex. Depyler: proven to terminate"]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn cmd_hex(b: i32, g: i32, r: i32) {
    println!("{}", format!("#{}{}{}", r, g, b));
}
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn main() {
    ...
    ({
        ...
        map.insert("rgb2hsv".to_string().to_string(), cmd_rgb2hsv);
        map.insert("hsv2rgb".to_string().to_string(), cmd_hsv2rgb);
        map.insert("rgb2hls".to_string().to_string(), cmd_rgb2hls);
        map.insert("hex".to_string().to_string(), cmd_hex);
        map
    }
