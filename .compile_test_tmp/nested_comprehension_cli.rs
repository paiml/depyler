...
#[doc = "Flatten 2D list to 1D."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn flatten_2d(matrix: &Vec<Vec<i32>>) -> Vec<i32> {
    matrix
        .into_iter()
        .flat_map(|row| row.into_iter().cloned())
        .collect::<Vec<_>>()
}
#[doc = "Flatten 3D list to 1D."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn flatten_3d(cube: &Vec<Vec<Vec<i32>>>) -> Vec<i32> {
    cube.into_iter()
        .flat_map(|plane| {
            plane
                .into_iter()
                .flat_map(move |row| row.into_iter().cloned())
        })
        .collect::<Vec<_>>()
}
#[doc = "Flatten and filter values above threshold."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn flatten_with_filter(matrix: &Vec<Vec<i32>>, threshold: i32) -> Vec<i32> {
    matrix
        .into_iter()
        .flat_map(|row| row.into_iter().filter(|x| x > threshold).cloned())
        .collect::<Vec<_>>()
}
#[doc = "Convert matrix to list of(row_idx, col_idx, value) tuples."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn matrix_to_pairs(matrix: &Vec<Vec<i32>>) -> Vec<(i32, i32, i32)> {
    (0..(matrix.len() as i32))
        .into_iter()
        .flat_map(|i| {
            (0..(matrix
...
#[doc = "Element-wise matrix multiplication."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn multiply_matrices_element<'b, 'a>(
    m1: &'a Vec<Vec<i32>>,
    m2: &'b Vec<Vec<i32>>,
) -> Vec<Vec<i32>> {
    (0..(m1.len() as i32))
...
#[doc = "Transpose matrix using nested comprehension."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
    ...
    (0..(matrix
        ...
        .map(|i| {
            matrix
                .iter()
                .cloned()
                .map(|row| [row.0, row.1][i as usize])
                .collect::<Vec<_>>()
        })
        .collect::<Vec<_>>()
}
#[doc = "Generate n x n matrix of squares."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn nested_squares(n: i32) -> Vec<Vec<i32>> {
    (0..(n))
        .into_iter()
        .map(|i| (0..(n)).into_iter().map(|j| i * j).collect::<Vec<_>>())
        .collect::<Vec<_>>()
}
#[doc = "Generate matrix with conditional values."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn nested_with_condition(n: i32) -> Vec<Vec<i32>> {
    (0..(n))
        .into_iter()
        .map(|i| {
            (0..(n))
...
#[doc = "Keep only rows with sum>= min_sum."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn filter_rows_by_sum(matrix: &Vec<Vec<i32>>, min_sum: i32) -> Vec<Vec<i32>> {
    matrix
        .iter()
        .cloned()
        .filter(|row| {
            let row = row.clone();
            row.iter().sum::<i32>() >= min_sum
        })
        .map(|row| row)
        .collect::<Vec<_>>()
}
#[doc = "Filter rows and double values."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn filter_and_transform(matrix: &Vec<Vec<i32>>) -> Vec<Vec<i32>> {
    matrix
        .iter()
        .cloned()
        .filter(|row| {
        ...
        .map(|row| row.iter().cloned().map(|x| x * 2).collect::<Vec<_>>())
        .collect::<Vec<_>>()
}
#[doc = "Cartesian product of two lists."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn cross_product<'b, 'a>(list1: &'a Vec<i32>, list2: &'b Vec<i32>) -> Vec<(i32, i32)> {
    list1
        .into_iter()
        .flat_map(|x| list2.into_iter().map(move |y| (x, y)))
        .collect::<Vec<_>>()
}
#[doc = "Cartesian product with filter."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn cross_product_filtered<'a, 'b>(list1: &'a Vec<i32>, list2: &'b Vec<i32>) -> Vec<(i32, i32)> {
    list1
        .into_iter()
        .flat_map(|x| list2.into_iter().filter(|y| x != y).map(move |y| (x, y)))
        .collect::<Vec<_>>()
}
#[doc = "Pairs that sum to target."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn cross_product_sum<'b, 'a>(
    list1: &'a Vec<i32>,
    list2: &'b Vec<i32>,
    target: i32,
) -> Vec<(i32, i32)> {
...
#[doc = "Extract all characters from all words."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn nested_strings(words: &Vec<String>) -> Vec<String> {
    words
        .into_iter()
        .flat_map(|word| word.into_iter().cloned())
        .collect::<Vec<_>>()
}
#[doc = "Extract vowels from all words."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn nested_strings_filtered(words: &Vec<String>) -> Vec<String> {
...
#[doc = "Group words by length using comprehension."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
...
#[doc = "Enumerate 2D matrix."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn nested_enumerate(matrix: &Vec<Vec<i32>>) -> Vec<(i32, i32, i32)> {
    matrix
        .iter()
        .cloned()
        .enumerate()
...
#[doc = "Get diagonal elements."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn diagonal_elements(matrix: &Vec<Vec<i32>>) -> Vec<i32> {
    (0..(depyler_min(
        (matrix.len() as i32).clone(),
        (if !matrix.is_empty() {
            matrix
                .get(0usize)
                .cloned()
...
#[doc = "Get anti-diagonal elements."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn anti_diagonal_elements(matrix: &Vec<Vec<i32>>) -> Vec<i32> {
...
#[doc = "Get upper triangular elements."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn upper_triangular(matrix: &Vec<Vec<i32>>) -> Vec<i32> {
    (0..(matrix.len() as i32))
        .into_iter()
        .flat_map(|i| {
            (0..(matrix
...
#[doc = "Get lower triangular elements."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn lower_triangular(matrix: &Vec<Vec<i32>>) -> Vec<i32> {
    (0..(matrix.len() as i32))
        .into_iter()
        .flat_map(|i| {
            (0..(matrix
...
#[doc = "Extract sliding windows from matrix."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn sliding_window_2d(
    matrix: &Vec<Vec<i32>>,
    size: i32,
) -> Result<Vec<Vec<Vec<i32>>>, Box<dyn std::error::Error>> {
    let _cse_temp_0 = matrix.len() as i32;
    let rows = _cse_temp_0;
    ...
    Ok((0..(rows - size + 1))
        .into_iter()
        .flat_map(|i| {
            (0..(cols - size + 1)).into_iter().map(move |j| {
                (0..(size))
                    .into_iter()
                    .map(|di| {
                        (0..(size))
...
#[doc = "Flatten dictionary values."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn flatten_dict_values(d: &std::collections::HashMap<String, Vec<i32>>) -> Vec<i32> {
    d.values()
        .cloned()
        .collect::<Vec<_>>()
        .into_iter()
        .flat_map(|values| values.into_iter().cloned())
        .collect::<Vec<_>>()
}
#[doc = "Flatten nested dict to tuples."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn flatten_nested_dict(
    ...
    d.iter()
        ...
        .flat_map(|(k1, inner)| {
            inner
                ...
                .collect::<Vec<_>>()
                .into_iter()
                .map(move |(k2, v)| (k1, k2, v))
        })
        .collect::<Vec<_>>()
}
#[doc = "Simple combinations with replacement for r=2."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn combinations_with_replacement(items: &Vec<i32>, r: i32) -> Vec<(i32, DepylerValue)> {
    let _cse_temp_0 = r != 2;
    if _cse_temp_0 {
        return vec![];
    }
...
#[doc = "All 2-permutations."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn permutations_2(items: &Vec<i32>) -> Vec<(i32, i32)> {
    items
        .iter()
        .cloned()
        .enumerate()
...
pub fn main() {
    ...
    let _cse_temp_0 = matches!(args.command, Some(Commands::Flatten { .. }));
    match &args.command {
        Some(Commands::Flatten { ref matrix, .. }) => {
            let mut matrix = ast.literal_eval(matrix);
            let mut result = flatten_2d(&matrix);
            println!("{:?}", result);
        }
        Some(Commands::Transpose { ref matrix, .. }) => {
            let mut matrix = ast.literal_eval(matrix);
            let mut result = transpose(&matrix);
            println!("{:?}", result);
        }
        Some(Commands::Cross {
            ref list1,
            ...
            let list1 = ast.literal_eval(list1);
            let list2 = ast.literal_eval(list2);
            let mut result = cross_product(&list1, &list2);
            println!("{:?}", result);
        }
        Some(Commands::Squares { ref n, .. }) => {
            let n = *n;
            let mut result = nested_squares(n);
            for row in result.iter().cloned() {
                println!("{:?}", row);
            }
        }
...
mod tests {
    ...
    #[test]
    fn test_flatten_3d_examples() {
        assert_eq!(flatten_3d(vec![]), vec![]);
        assert_eq!(flatten_3d(vec![1]), vec![1]);
    }
    #[test]
    fn test_matrix_to_pairs_examples() {
        assert_eq!(matrix_to_pairs(vec![]), vec![]);
        assert_eq!(matrix_to_pairs(vec![1]), vec![1]);
    }
    #[test]
    ...
    #[test]
    fn test_filter_and_transform_examples() {
        assert_eq!(filter_and_transform(vec![]), vec![]);
        assert_eq!(filter_and_transform(vec![1]), vec![1]);
    }
    #[test]
    fn test_nested_strings_examples() {
        assert_eq!(nested_strings(vec![]), vec![]);
        assert_eq!(nested_strings(vec![1]), vec![1]);
    }
    #[test]
    fn test_nested_strings_filtered_examples() {
        assert_eq!(nested_strings_filtered(vec![]), vec![]);
        assert_eq!(nested_strings_filtered(vec![1]), vec![1]);
    }
    #[test]
    fn test_nested_enumerate_examples() {
        assert_eq!(nested_enumerate(vec![]), vec![]);
        assert_eq!(nested_enumerate(vec![1]), vec![1]);
    }
    #[test]
    fn test_diagonal_elements_examples() {
        assert_eq!(diagonal_elements(vec![]), vec![]);
        assert_eq!(diagonal_elements(vec![1]), vec![1]);
    }
    #[test]
    fn test_anti_diagonal_elements_examples() {
        assert_eq!(anti_diagonal_elements(vec![]), vec![]);
        assert_eq!(anti_diagonal_elements(vec![1]), vec![1]);
    }
    #[test]
    fn test_upper_triangular_examples() {
        assert_eq!(upper_triangular(vec![]), vec![]);
        assert_eq!(upper_triangular(vec![1]), vec![1]);
    }
    #[test]
    fn test_lower_triangular_examples() {
        assert_eq!(lower_triangular(vec![]), vec![]);
        assert_eq!(lower_triangular(vec![1]), vec![1]);
    }
    #[test]
    fn test_permutations_2_examples() {
        assert_eq!(permutations_2(vec![]), vec![]);
        assert_eq!(permutations_2(vec![1]), vec![1]);
    }
}
