...
pub fn main() -> Result<(), Box<dyn std::error::Error>> {
    let mut d2_c1: f64 = Default::default();
    let mut d1_c1: f64 = Default::default();
    let mut d2_c0: f64 = Default::default();
    let mut d1_c0: f64 = Default::default();
    let mut d3_c1: f64 = Default::default();
    let mut l3: f64 = Default::default();
    let mut count1: f64 = Default::default();
    let mut d0_c1: f64 = Default::default();
    let mut l2: f64 = Default::default();
    let mut sum0: f64 = Default::default();
    let mut d3_c0: f64 = Default::default();
    let mut l1: f64 = Default::default();
    let mut sum1: f64 = Default::default();
    let mut count0: f64 = Default::default();
    let mut l0: f64 = Default::default();
    let mut d0_c0: f64 = Default::default();
    ...
    while iter_count < (iters as f64) {
        ...
        if count0 > 0.0 {
            c0 = ((sum0) as f64) / ((count0) as f64);
        }
        if count1 > 0.0 {
            c1 = ((sum1) as f64) / ((count1) as f64);
        }
        iter_count = iter_count + 1.0;
    }
    let _cse_temp_0 = args.mode == "cluster";
    if _cse_temp_0 {
        println!("{}", format!("l0={} l1={} l2={} l3={}", l0, l1, l2, l3));
    } else {
        let _cse_temp_1 = args.mode == "centroid";
        if _cse_temp_1 {
            println!("{}", format!("c0={} c1={}", c0, c1));
        }
    }
    Ok(())
}
