...
pub fn main() {
    ...
    let _cse_temp_0 = matches!(args.command, Some(Commands::Cos3 { .. }));
    match &args.command {
        Some(Commands::Cos3 {
            ref a,
            ref b,
        ...
        Some(Commands::Cos2 { ref a, ref b, .. }) => {
            let a = *a;
            let b = *b;
        ...
        Some(Commands::Cos1 { ref a, .. }) => {
            let a = *a;
            let mut result = a.cos();
