...
pub fn main() {
    ...
    let _cse_temp_0 = matches!(args.command, Some(Commands::Exp3 { .. }));
    match &args.command {
        Some(Commands::Exp3 {
            ref a,
            ref b,
        ...
        Some(Commands::Exp2 { ref a, ref b, .. }) => {
            let a = *a;
            let b = *b;
        ...
        Some(Commands::Exp1 { ref a, .. }) => {
            let a = *a;
            let mut result = a.exp();
