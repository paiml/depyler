...
enum Commands {
    ...
    Distance { x1: f64, y1: f64, x2: f64, y2: f64 },
}
#[derive(Default)]
...
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn log_natural(x: f64) -> f64 {
    (x as f64).ln()
}
#[doc = "Logarithm with custom base."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
...
#[doc = "Check if two floats are close."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
...
#[doc = "Return fractional and integer parts."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
...
#[doc = "Return mantissa and exponent."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
...
pub fn ldexp(x: f64, i: i32) -> f64 {
    (x as f64) * 2.0f64.powi(i as i32)
}
#[doc = "Copy sign of y to x."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn copysign(x: f64, y: f64) -> f64 {
    (x as f64).copysign(y as f64)
}
#[doc = "Solve quadratic equation ax^2 + bx + c = 0."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn solve_quadratic(a: f64, b: f64, c: f64) -> Vec<f64> {
    let _cse_temp_0 = b * b;
    let _cse_temp_1 = 4f64 * a;
    let _cse_temp_2 = _cse_temp_1 * c;
    let discriminant = _cse_temp_0 - _cse_temp_2;
    let _cse_temp_3 = discriminant < 0f64;
    if _cse_temp_3 {
        return vec![];
    }
    let _cse_temp_4 = discriminant == 0f64;
    if _cse_temp_4 {
        return vec![((-b) as f64) / ((2f64 * a) as f64)];
    }
    let sqrt_d = (discriminant as f64).sqrt();
    vec![
        ((-b + sqrt_d) as f64) / ((2f64 * a) as f64),
        ((-b - sqrt_d) as f64) / ((2f64 * a) as f64),
    ]
}
#[doc = "Euclidean distance in 2D."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn distance_2d(x1: f64, y1: f64, x2: f64, y2: f64) -> f64 {
    (({ x2 - x1 } as f64).powf({ 2 } as f64) + ({ y2 - y1 } as f64).powf({ 2 } as f64) as f64)
        .sqrt()
}
#[doc = "Euclidean distance in 3D."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn distance_3d(x1: f64, y1: f64, z1: f64, x2: f64, y2: f64, z2: f64) -> f64 {
    (({ x2 - x1 } as f64).powf({ 2 } as f64)
        + ({ y2 - y1 } as f64).powf({ 2 } as f64)
        + ({ z2 - z1 } as f64).powf({ 2 } as f64) as f64)
        .sqrt()
}
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn main() {
    ...
    let _cse_temp_0 = matches!(args.command, Some(Commands::Sqrt { .. }));
    match &args.command {
        Some(Commands::Sqrt { ref x, .. }) => {
            let x = *x;
            println!("{}", sqrt(x));
        }
        Some(Commands::Pow {
        ...
        Some(Commands::Sin { ref x, .. }) => {
            let x = *x;
            println!("{}", sin(x));
        }
        Some(Commands::Cos { ref x, .. }) => {
            let x = *x;
            println!("{}", cos(x));
        }
        Some(Commands::Tan { ref x, .. }) => {
            let x = *x;
            println!("{}", tan(x));
        }
        Some(Commands::Log { ref x, .. }) => {
            let x = *x;
            println!("{}", log_natural(x));
        }
        Some(Commands::Exp { ref x, .. }) => {
            let x = *x;
            println!("{}", exp(x));
        }
        ...
        Some(Commands::Gcd { ref a, ref b, .. }) => {
            let a = *a;
            let b = *b;
            println!("{}", gcd(a, b));
        }
        Some(Commands::Quadratic {
            ref a,
            ref b,
            ref c,
            ..
        ...
        Some(Commands::Distance {
            ...
            let y1 = *y1;
            let y2 = *y2;
            println!("{}", distance_2d(x1, y1, x2, y2));
        }
...
mod tests {
    ...
    #[test]
    fn test_isqrt_examples() {
        assert_eq!(isqrt(0), 0);
        assert_eq!(isqrt(1), 1);
        assert_eq!(isqrt(-1), -1);
    }
    #[test]
    fn test_is_finite_examples() {
        let _ = is_finite(Default::default());
    }
    #[test]
    fn test_is_inf_examples() {
        let _ = is_inf(Default::default());
    }
    #[test]
    fn test_is_nan_examples() {
        let _ = is_nan(Default::default());
    }
}
