...
pub fn main() {
    ...
    let dy0 = args.dy0;
    let dy1 = args.dy1;
    let _cse_temp_0 = args.mode == "forward";
    if _cse_temp_0 {
        let _cse_temp_1 = w00 * x0;
        let _cse_temp_2 = w01 * x1;
        let _cse_temp_3 = _cse_temp_1 + _cse_temp_2 + b0;
        let y0 = _cse_temp_3;
        let _cse_temp_4 = w10 * x0;
        let _cse_temp_5 = w11 * x1;
        let _cse_temp_6 = _cse_temp_4 + _cse_temp_5 + b1;
        let y1 = _cse_temp_6;
        println!("{}", format!("y0={:?} y1={:?}", y0, y1));
    } else {
        let _cse_temp_7 = args.mode == "backward";
        if _cse_temp_7 {
            let _cse_temp_8 = w00 * dy0;
            let _cse_temp_9 = w10 * dy1;
            let dx0 = _cse_temp_8 + _cse_temp_9;
            let _cse_temp_10 = w01 * dy0;
            let _cse_temp_11 = w11 * dy1;
            let dx1 = _cse_temp_10 + _cse_temp_11;
            let _cse_temp_12 = dy0 * x0;
            let dw00 = _cse_temp_12;
            let _cse_temp_13 = dy0 * x1;
            let dw01 = _cse_temp_13;
            let _cse_temp_14 = dy1 * x0;
            let dw10 = _cse_temp_14;
            let _cse_temp_15 = dy1 * x1;
            let dw11 = _cse_temp_15;
            let db0 = dy0;
            let db1 = dy1;
            println!(
                "{}",
                format!(
                    "dx0={:?} dx1={:?} dw00={:?} dw01={:?} dw10={:?} dw11={:?} db0={:?} db1={:?}",
                    dx0, dx1, dw00, dw01, dw10, dw11, db0, db1
                )
            );
        }
