...
pub fn main() {
    ...
    if _cse_temp_0 {
        ...
        println!(
            "{}",
            format!("c00={:?} c01={:?} c10={:?} c11={:?}", c00, c01, c10, c11)
        );
    } else {
        let _cse_temp_1 = args.mode == "mul";
        if _cse_temp_1 {
            let _cse_temp_2 = a00 * b00;
            c00 = _cse_temp_2;
            let _cse_temp_3 = a01 * b01;
            c01 = _cse_temp_3;
            let _cse_temp_4 = a10 * b10;
            c10 = _cse_temp_4;
            let _cse_temp_5 = a11 * b11;
            c11 = _cse_temp_5;
            println!(
                "{}",
                format!("c00={:?} c01={:?} c10={:?} c11={:?}", c00, c01, c10, c11)
            ...
            let _cse_temp_6 = args.mode == "matmul";
            if _cse_temp_6 {
                let _cse_temp_7 = a00 * b00;
                let _cse_temp_8 = a01 * b10;
                c00 = _cse_temp_7 + _cse_temp_8;
                let _cse_temp_9 = a00 * b01;
                let _cse_temp_10 = a01 * b11;
                c01 = _cse_temp_9 + _cse_temp_10;
                let _cse_temp_11 = a10 * b00;
                let _cse_temp_12 = a11 * b10;
                c10 = _cse_temp_11 + _cse_temp_12;
                let _cse_temp_13 = a10 * b01;
                let _cse_temp_14 = a11 * b11;
                c11 = _cse_temp_13 + _cse_temp_14;
                println!(
                    "{}",
                    format!("c00={:?} c01={:?} c10={:?} c11={:?}", c00, c01, c10, c11)
                );
