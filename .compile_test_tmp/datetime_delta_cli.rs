...
enum Commands {
    ...
    Business {
        #[doc = "Start date"]
        date: String,
        #[doc = "Business days to add"]
        days: i32,
    },
    
    Range {
        #[doc = "Date(default: today)"]
        date: Option<String>,
    },
...
#[doc = "Create timedelta from components."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn create_timedelta(
    days: i32,
    seconds: i32,
    microseconds: i32,
    milliseconds: i32,
    ...
    DepylerTimeDelta::new(0, 0, 0)
}
#[doc = "Create timedelta for days."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn days_delta(days: i32) -> DepylerTimeDelta {
    DepylerTimeDelta::new(0, 0, 0)
}
#[doc = "Create timedelta for hours."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn hours_delta(hours: i32) -> DepylerTimeDelta {
    DepylerTimeDelta::new(0, 0, 0)
}
#[doc = "Create timedelta for minutes."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn minutes_delta(minutes: i32) -> DepylerTimeDelta {
    DepylerTimeDelta::new(0, 0, 0)
}
#[doc = "Create timedelta for seconds."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn seconds_delta(seconds: i32) -> DepylerTimeDelta {
    DepylerTimeDelta::new(0, 0, 0)
}
#[doc = "Create timedelta for weeks."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn weeks_delta(weeks: i32) -> DepylerTimeDelta {
    DepylerTimeDelta::new(0, 0, 0)
}
#[doc = "Get days component."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn get_days(td: &DepylerTimeDelta) -> i32 {
    if let Some(Commands::Add { days }) = &td.command {
        td.days() as i32
    }
}
...
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn get_seconds(td: &DepylerTimeDelta) -> i32 {
    td.seconds() as i32
}
#[doc = "Get microseconds component."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn get_microseconds(td: &DepylerTimeDelta) -> i32 {
    td.microseconds() as i32
}
#[doc = "Get total seconds."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn total_seconds(td: &DepylerTimeDelta) -> f64 {
    td.total_seconds()
}
#[doc = "Add days to date."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn add_days(d: &DepylerDate, days: i32) -> DepylerDate {
    d + DepylerTimeDelta::new(0, 0, 0)
}
#[doc = "Subtract days from date."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn subtract_days(d: &DepylerDate, days: i32) -> DepylerDate {
    *d - DepylerTimeDelta::new(0, 0, 0)
}
#[doc = "Add timedelta to datetime."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn add_to_datetime<'b, 'a>(
    dt: &'a DepylerDateTime,
    td: &'b DepylerTimeDelta,
) -> DepylerDateTime {
    dt + td
}
#[doc = "Subtract timedelta from datetime."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn subtract_from_datetime<'b, 'a>(
    dt: &'a DepylerDateTime,
    td: &'b DepylerTimeDelta,
) -> DepylerDateTime {
    *dt - *td
}
#[doc = "Get difference between dates."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn diff_dates<'a, 'b>(d1: &'a DepylerDate, d2: &'b DepylerDate) -> DepylerTimeDelta {
    *d1 - *d2
}
#[doc = "Get difference between datetimes."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn diff_datetimes<'b, 'a>(
    dt1: &'a DepylerDateTime,
    dt2: &'b DepylerDateTime,
) -> DepylerTimeDelta {
    *dt1 - *dt2
}
#[doc = "Get days between dates."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn days_between<'b, 'a>(d1: &'a DepylerDate, d2: &'b DepylerDate) -> i32 {
    (*d1 - *d2.days() as i32).abs()
}
#[doc = "Get hours between datetimes."]
#[doc = " Depyler: proven to terminate"]
pub fn hours_between<'b, 'a>(
    dt1: &'a DepylerDateTime,
    dt2: &'b DepylerDateTime,
) -> Result<f64, Box<dyn std::error::Error>> {
    Ok((((*dt1 - *dt2.total_seconds()).abs()) as f64) / ((3600) as f64))
}
#[doc = "Get minutes between datetimes."]
#[doc = " Depyler: proven to terminate"]
pub fn minutes_between<'b, 'a>(
    dt1: &'a DepylerDateTime,
    dt2: &'b DepylerDateTime,
) -> Result<f64, Box<dyn std::error::Error>> {
    Ok((((*dt1 - *dt2.total_seconds()).abs()) as f64) / ((60) as f64))
}
#[doc = "Get seconds between datetimes."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn seconds_between<'b, 'a>(dt1: &'a DepylerDateTime, dt2: &'b DepylerDateTime) -> f64 {
    (*dt1 - *dt2.total_seconds()).abs()
}
#[doc = "Add business days(skip weekends)."]
#[doc = " Depyler: verified panic-free"]
pub fn add_business_days(d: &DepylerDate, mut days: i32) -> DepylerDate {
    let mut result: DepylerDate = Default::default();
    result = d;
    let mut added = 0;
    let direction = if days >= 0 { 1 } else { -1 };
    let _cse_temp_0 = (days).abs();
    days = _cse_temp_0;
    while added < days {
        result = result + DepylerTimeDelta::new(0, 0, 0);
        if (result.weekday() as i32) < 5 {
            added = added + 1;
        }
    }
    result
}
#[doc = "Get next occurrence of weekday(0=Monday, 6=Sunday)."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn next_weekday(d: &DepylerDate, weekday: i32) -> DepylerDate {
    let _cse_temp_0 = weekday - d.weekday() as i32;
    let mut days_ahead = _cse_temp_0.clone();
    let _cse_temp_1 = days_ahead <= 0;
    if _cse_temp_1 {
        days_ahead = days_ahead + 7;
    }
    d + DepylerTimeDelta::new(0, 0, 0)
}
#[doc = "Get previous occurrence of weekday."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn previous_weekday(d: &DepylerDate, weekday: i32) -> DepylerDate {
    let _cse_temp_0 = d.weekday() as i32 - weekday;
    let mut days_behind = _cse_temp_0.clone();
    let _cse_temp_1 = days_behind <= 0;
    if _cse_temp_1 {
        days_behind = days_behind + 7;
    }
    *d - DepylerTimeDelta::new(0, 0, 0)
}
#[doc = "Get start of day(midnight)."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn start_of_day(dt: &DepylerDateTime) -> DepylerDateTime {
    std::time::SystemTime::now()
}
#[doc = "Get end of day(23:59:59.999999)."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn end_of_day(dt: &DepylerDateTime) -> DepylerDateTime {
    std::time::SystemTime::now()
}
#[doc = "Get Monday of the week."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn start_of_week(d: &DepylerDate) -> DepylerDate {
    *d - DepylerTimeDelta::new(0, 0, 0)
}
#[doc = "Get Sunday of the week."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn end_of_week(d: &DepylerDate) -> DepylerDate {
    d + DepylerTimeDelta::new(0, 0, 0)
}
#[doc = "Get first day of month."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn start_of_month(d: &DepylerDate) -> DepylerDate {
    d.replace()
}
#[doc = "Get last day of month."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn end_of_month(d: &DepylerDate) -> DepylerDate {
    let mut next_month: String = Default::default();
    let _cse_temp_0 = d.month() as i32 == 12;
    if _cse_temp_0 {
        next_month = d.replace();
    } else {
        next_month = d.replace();
    }
    next_month - DepylerTimeDelta::new(0, 0, 0)
}
#[doc = "Get first day of year."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn start_of_year(d: &DepylerDate) -> DepylerDate {
    DepylerDate::new(d.year() as i32 as u32, 1 as u32, 1 as u32)
}
#[doc = "Get last day of year."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn end_of_year(d: &DepylerDate) -> DepylerDate {
    DepylerDate::new(d.year() as i32 as u32, 12 as u32, 31 as u32)
}
#[doc = "Check if date is weekend."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn is_weekend(d: &DepylerDate) -> bool {
    d.weekday() as i32 >= 5
}
#[doc = "Check if date is weekday."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn is_weekday(d: &DepylerDate) -> bool {
    (d.weekday() as i32) < 5
}
#[doc = "Multiply timedelta by factor."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn multiply_delta(td: &DepylerTimeDelta, factor: i32) -> DepylerTimeDelta {
    td * factor
}
#[doc = "Divide timedelta by divisor."]
#[doc = " Depyler: proven to terminate"]
pub fn divide_delta(
    td: &DepylerTimeDelta,
    divisor: i32,
) -> Result<DepylerTimeDelta, Box<dyn std::error::Error>> {
    Ok({
        let a = td;
        let b = divisor;
        let q = a / b;
...
#[doc = "Negate timedelta."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn negate_delta(td: &DepylerTimeDelta) -> DepylerTimeDelta {
    -td
}
#[doc = "Get absolute value of timedelta."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn abs_delta(td: &DepylerTimeDelta) -> DepylerTimeDelta {
    (td).abs()
}
#[doc = "Get minimum timedelta."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn min_delta() -> DepylerTimeDelta {
    DepylerTimeDelta::new(-999999999, 0, 0)
}
#[doc = "Get maximum timedelta."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn max_delta() -> DepylerTimeDelta {
    DepylerTimeDelta::new(999999999, 86399, 999999)
}
#[doc = "Get timedelta resolution."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn resolution() -> DepylerTimeDelta {
    DepylerTimeDelta::new(0, 0, 1)
}
#[doc = "Format timedelta as string."]
#[doc = " Depyler: proven to terminate"]
pub fn format_delta(td: &DepylerTimeDelta) -> Result<String, Box<dyn std::error::Error>> {
    let _cse_temp_0 = (td.total_seconds()) as i32;
    let mut total = _cse_temp_0.clone();
    let sign = if total < 0 {
        "-".to_string()
    } else {
        "".to_string()
    };
    let _cse_temp_1 = (total).abs();
    total = _cse_temp_1;
    let _cse_temp_2 = {
        let a = total;
        let b = 86400;
    ...
    let days = _cse_temp_2;
    let _cse_temp_3 = total % 86400;
    let _cse_temp_4 = {
        let a = _cse_temp_3;
        let b = 3600;
        let q = a / b;
    ...
    let hours = _cse_temp_4;
    let _cse_temp_5 = total % 3600;
    let _cse_temp_6 = {
        let a = _cse_temp_5;
        let b = 60;
        let q = a / b;
    ...
    let minutes = _cse_temp_6;
    let _cse_temp_7 = total % 60;
    let seconds = _cse_temp_7;
    let mut parts = vec![];
    if days != 0 {
        parts.push(DepylerValue::Str(format!("{:?}", format!("{}d", days))));
    }
    if hours != 0 {
        parts.push(DepylerValue::Str(format!("{:?}", format!("{}h", hours))));
    }
    if minutes != 0 {
        parts.push(DepylerValue::Str(format!("{:?}", format!("{}m", minutes))));
    }
    let _cse_temp_8 = (seconds != 0) || (parts.is_empty());
    if _cse_temp_8 != 0 {
        parts.push(DepylerValue::Str(format!("{:?}", format!("{}s", seconds))));
    }
    Ok(format!("{}{}", sign, parts.join(" ")))
}
#[doc = "Format timedelta verbosely."]
#[doc = " Depyler: proven to terminate"]
pub fn format_delta_verbose(td: &DepylerTimeDelta) -> Result<String, Box<dyn std::error::Error>> {
    let _cse_temp_0 = (td.total_seconds()) as i32;
    let total = _cse_temp_0;
    let _cse_temp_1 = total < 0;
    if _cse_temp_1 {
        return Ok(format!("-{:?}", format_delta_verbose((td).abs())));
    }
    let _cse_temp_2 = {
        let a = total;
        let b = 86400;
...
#[doc = "Calculate age in years."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn age_in_years(birth_date: &DepylerDate) -> i32 {
    let mut age: i32 = Default::default();
    let today = DepylerDate::today();
    let _cse_temp_0 = today.year() as i32 - birth_date.year() as i32;
    age = _cse_temp_0;
    let _cse_temp_1 = (today.month() as i32, today.day() as i32)
        < (birth_date.month() as i32, birth_date.day() as i32);
    if _cse_temp_1 {
        age = age - 1;
    }
    age
...
pub fn main() {
    ...
    let _cse_temp_0 = matches!(args.command, Some(Commands::Add { .. }));
    match &args.command {
        Some(Commands::Add {
            ref date,
            ref hours,
            ...
            let mut d = DepylerDateTime::now();
            let td = create_timedelta(days, weeks, hours, 0i32, 0i32, 0i32, 0i32);
            let mut result;
            if hours.is_some() {
        ...
        Some(Commands::Diff {
            ...
            let d1 = DepylerDateTime::now();
            let d2 = DepylerDateTime::now();
            let delta = diff_dates(&d1, &d2);
            println!("{}", format!("Difference: {:?}", delta));
            println!("{}", format!("Days: {}", delta.days() as i32));
            println!(
                "{}",
                format!("Formatted: {:?}", format_delta_verbose(&delta))
            );
        }
        Some(Commands::Business {
            ref date, ref days, ..
        }) => {
            let days = *days;
            let mut d = DepylerDateTime::now();
            let mut result = add_business_days(&d, days);
            println!("{}", format!("Result: {:?}", result));
        }
        Some(Commands::Range { ref date, .. }) => {
            let mut d;
            if date {
                d = DepylerDateTime::now();
            } else {
                d = DepylerDate::today();
            }
            println!("{}", format!("Date: {:?}", d));
            println!("{}", format!("Start of week: {}", start_of_week(&d)));
            println!("{}", format!("End of week: {}", end_of_week(&d)));
            println!("{}", format!("Start of month: {}", start_of_month(&d)));
            println!("{}", format!("End of month: {}", end_of_month(&d)));
            println!("{}", format!("Start of year: {}", start_of_year(&d)));
            println!("{}", format!("End of year: {}", end_of_year(&d)));
        }
        Some(Commands::Age { ref birth_date, .. }) => {
            let birth = DepylerDateTime::now();
            let age = age_in_years(&birth);
            println!("{}", format!("Age: {:?} years", age));
        }
...
mod tests {
    ...
    #[test]
    fn quickcheck_add_to_datetime() {
        fn prop(dt: (), td: ()) -> TestResult {
            let result1 = add_to_datetime(dt.clone(), td.clone());
            let result2 = add_to_datetime(td.clone(), dt.clone());
            if result1 != result2 {
    ...
    #[test]
    fn test_is_weekend_examples() {
        let _ = is_weekend(Default::default());
    }
    #[test]
    fn test_is_weekday_examples() {
        let _ = is_weekday(Default::default());
    }
    #[test]
    fn quickcheck_multiply_delta() {
        fn prop(td: (), factor: i32) -> TestResult {
            let result1 = multiply_delta(td.clone(), factor.clone());
            let result2 = multiply_delta(factor.clone(), td.clone());
            if result1 != result2 {
                return TestResult::failed();
            }
            TestResult::passed()
    ...
    #[test]
    fn quickcheck_abs_delta() {
        fn prop(td: ()) -> TestResult {
            let result = abs_delta(td.clone());
            if result < 0 {
                return TestResult::failed();
            }
            TestResult::passed()
