...
pub fn main() {
    ...
    let _cse_temp_0 = matches!(args.command, Some(Commands::Name { .. }));
    match &args.command {
        Some(Commands::Name { ref num, .. }) => {
            let num = *num;
            let _cse_temp_1 = num == 9;
            if _cse_temp_1 {
                println!("{}", "SIGKILL");
            } else {
                let _cse_temp_2 = num == 15;
                if _cse_temp_2 {
                    println!("{}", "SIGTERM");
                } else {
                    let _cse_temp_3 = num == 2;
                    if _cse_temp_3 {
                        println!("{}", "SIGINT");
                    }
                }
        ...
        Some(Commands::Number { ref name, .. }) => {
            let name = name.to_string();
            let _cse_temp_5 = name == "KILL";
            if _cse_temp_5 {
                println!("{}", 9);
            } else {
                let _cse_temp_6 = name == "TERM";
                if _cse_temp_6 {
                    println!("{}", 15);
                } else {
                    let _cse_temp_7 = name == "INT";
                    if _cse_temp_7 {
                        println!("{}", 2);
                    }
                }
        ...
        Some(Commands::List { .. }) => {
            println!("{}", "SIGINT SIGTERM SIGKILL");
        }
