...
pub fn main() {
    ...
    let _cse_temp_0 = matches!(args.command, Some(Commands::Sin3 { .. }));
    match &args.command {
        Some(Commands::Sin3 {
            ref a,
            ref b,
        ...
        Some(Commands::Sin2 { ref a, ref b, .. }) => {
            let a = *a;
            let b = *b;
        ...
        Some(Commands::Sin1 { ref a, .. }) => {
            let a = *a;
            let mut result = a.sin();
