...
#[doc = "Memoized fibonacci. Depyler: proven to terminate"]
...
#[doc = "Memoized factorial. Depyler: proven to terminate"]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
...
pub fn main() {
    ...
    let _cse_temp_0 = matches!(args.command, Some(Commands::Fib { .. }));
    match &args.command {
        Some(Commands::Fib { ref n, .. }) => {
            let n = *n;
            println!("{}", format!("fib({}) = {}", n, fibonacci(n)));
        }
        Some(Commands::Fact { ref n, .. }) => {
            let n = *n;
            println!("{}", format!("fact({}) = {}", n, factorial(n)));
        }
