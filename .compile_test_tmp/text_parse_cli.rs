...
#[doc = "Split text by delimiter."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn split_by<'b, 'a>(text: &'a str, delimiter: &'b str) -> Vec<String> {
    text.split(delimiter)
        .map(|s| s.to_string())
        .collect::<Vec<String>>()
}
#[doc = "Split text into characters."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn split_chars(text: &str) -> Vec<String> {
    text.chars().collect::<Vec<_>>()
}
#[doc = "Join lines with newline."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn join_lines(lines: &Vec<String>) -> String {
    lines.join("\n")
}
#[doc = "Join words with space."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn join_words(words: &Vec<String>) -> String {
    words.join(" ")
}
#[doc = "Join items with delimiter."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn join_by<'b, 'a>(items: &'a Vec<String>, delimiter: &'b str) -> String {
...
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn strip_left(text: &str) -> String {
    text.trim_start().to_string()
}
#[doc = "Strip trailing whitespace."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn strip_right(text: &str) -> String {
    text.trim_end().to_string()
}
#[doc = "Strip specific characters."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn strip_chars<'a, 'b>(text: &'a str, chars: &'b str) -> String {
    text.trim_matches(|c: char| chars.contains(c)).to_string()
}
...
#[doc = "Aggressive lowercase for comparison."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
...
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn replace<'a, 'b, 'c>(text: &'a str, old: &'b str, new: &'c str) -> String {
    text.replace(old, new)
}
#[doc = "Replace first occurrence."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn replace_first<'c, 'b, 'a>(text: &'a str, old: &'b str, new: &'c str) -> String {
    text.replacen(old, new, 1 as usize)
}
#[doc = "Check if starts with prefix."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn startswith<'b, 'a>(text: &'a str, prefix: &'b str) -> bool {
    text.starts_with(prefix)
}
#[doc = "Check if ends with suffix."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn endswith<'b, 'a>(text: &'a str, suffix: &'b str) -> bool {
    text.ends_with(suffix)
}
#[doc = "Check if contains substring."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn contains<'b, 'a>(text: &'a str, substring: &'b str) -> bool {
    text.contains(&*substring)
}
#[doc = "Count occurrences of substring."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn count<'b, 'a>(text: &'a str, substring: &'b str) -> i32 {
    text.matches(&*substring).count() as i32 as i32
}
#[doc = "Find first occurrence, -1 if not found."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn find<'a, 'b>(text: &'a str, substring: &'b str) -> i32 {
    text.find(substring).map(|i| i as i32).unwrap_or(-1)
}
#[doc = "Find last occurrence, -1 if not found."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn rfind<'b, 'a>(text: &'a str, substring: &'b str) -> i32 {
    text.rfind(substring).map(|i| i as i32).unwrap_or(-1)
}
#[doc = "Find first occurrence, raise if not found."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn index<'b, 'a>(text: &'a str, substring: &'b str) -> i32 {
    text.iter()
        .position(|x| x == &substring)
        .map(|i| i as i32)
        .expect("ValueError: value is not in list")
}
#[doc = "Check if all alphabetic."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn is_alpha(text: &str) -> bool {
    text.chars().all(|c| c.is_alphabetic())
}
#[doc = "Check if all digits."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn is_digit(text: &str) -> bool {
    text.chars().all(|c| c.is_numeric())
}
#[doc = "Check if all alphanumeric."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn is_alnum(text: &str) -> bool {
    text.chars().all(|c| c.is_alphanumeric())
}
#[doc = "Check if all whitespace."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn is_space(text: &str) -> bool {
    text.chars().all(|c| c.is_whitespace())
}
#[doc = "Check if all uppercase."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn is_upper(text: &str) -> bool {
    text.chars().all(|c| !c.is_alphabetic() || c.is_uppercase())
}
#[doc = "Check if all lowercase."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn is_lower(text: &str) -> bool {
    text.chars().all(|c| !c.is_alphabetic() || c.is_lowercase())
}
#[doc = "Check if title case."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
...
#[doc = "Check if numeric."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn is_numeric(text: &str) -> bool {
    text.chars().all(|c| c.is_numeric())
}
#[doc = "Check if decimal."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn is_decimal(text: &str) -> bool {
    text.chars().all(|c| c.is_ascii_digit())
}
#[doc = "Check if valid identifier."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
...
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn length(text: &str) -> i32 {
    text.len() as i32 as i32
}
#[doc = "Reverse string."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
...
#[doc = " Depyler: proven to terminate"]
pub fn char_at(text: &str, index: i32) -> Result<String, Box<dyn std::error::Error>> {
...
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn substring(text: &str, start: i32, end: i32) -> String {
    {
        let base = text;
...
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn remove_prefix(text: String, prefix: &str) -> String {
    if text.starts_with(prefix) {
        return {
            let base = text;
            let start_idx: i32 = prefix.len() as i32;
            let len = base.chars().count() as i32;
            let actual_start = if start_idx < 0 {
                (len + start_idx).max(0) as usize
            } else {
...
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn remove_suffix(text: String, suffix: &str) -> String {
    if text.ends_with(suffix) {
        return {
            let base = text;
            let stop_idx: i32 = -suffix.len() as i32;
            let len = base.chars().count() as i32;
            let actual_stop = if stop_idx < 0 {
                (len + stop_idx).max(0) as usize
            } else {
...
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn center(text: &str, width: i32) -> String {
    {
        let s = text;
...
#[doc = "Left justify string."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn ljust(text: &str, width: i32) -> String {
    {
        let s = text;
        let width = width as usize;
        let fillchar = " ";
...
#[doc = "Right justify string."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn rjust(text: &str, width: i32) -> String {
    {
        let s = text;
        let width = width as usize;
        let fillchar = " ";
...
#[doc = "Partition on first separator."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn partition<'b, 'a>(text: &'a str, sep: &'b str) -> (String, String, String) {
    text.partition(sep)
}
#[doc = "Partition on last separator."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn rpartition<'a, 'b>(text: &'a str, sep: &'b str) -> (String, String, String) {
    text.rpartition(sep)
}
#[doc = "Expand tabs to spaces."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn expandtabs(text: &str, tabsize: i32) -> String {
...
#[doc = "Decode from UTF-8."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn decode_utf8(data: &Vec<u8>) -> String {
...
#[doc = "Count characters in text."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn char_count(text: &str, include_spaces: bool) -> i32 {
    if include_spaces {
        return text.len() as i32 as i32;
    }
    text.replace(" ", "")
        .replace("\n", "")
        .replace("\t", "")
...
#[doc = "Get character frequency."]
#[doc = " Depyler: verified panic-free"]
pub fn char_frequency(text: &str) -> HashMap<String, i32> {
    ...
    for _char in text.chars() {
        ...
        freq.insert(
            char.to_string().clone(),
            freq.get(&char).cloned().unwrap_or(0) + 1,
        );
    }
    freq
}
#[doc = "Get word frequency."]
#[doc = " Depyler: verified panic-free"]
pub fn word_frequency(text: &str) -> HashMap<String, i32> {
        ...
        .collect::<Vec<String>>()
    {
        freq.insert(
            ...
            freq.get(&word).cloned().unwrap_or(0) + 1,
        );
    }
    freq
}
...
pub fn main() {
    ...
    let _cse_temp_0 = matches!(args.command, Some(Commands::Split { .. }));
    match &args.command {
        Some(Commands::Split {
            ref delimiter,
            ref lines,
            ...
            if lines {
                ...
                if words {
                    ...
                    if delimiter.is_some() {
                        result = split_by(&text, &delimiter);
                    } else {
                        result = split_words(&text);
                    }
                }
        ...
        Some(Commands::Join {
            ...
            result = join_by(&items, &delimiter);
            println!("{:?}", result);
        }
        Some(Commands::Case {
            ref lower,
        ...
        Some(Commands::Count {
            ...
            let words = *words;
            if words {
                println!("{}", format!("Words: {}", word_count(&text)));
            } else {
                if lines {
                    println!("{}", format!("Lines: {}", line_count(&text)));
                } else {
                    if chars {
                        println!("{}", format!("Characters: {}", char_count(&text, true)));
                    } else {
                        println!("{}", format!("Words: {}", word_count(&text)));
                        println!("{}", format!("Lines: {}", line_count(&text)));
                        println!("{}", format!("Characters: {}", char_count(&text, true)));
...
mod tests {
    ...
    #[test]
    fn test_is_alpha_examples() {
        let _ = is_alpha(Default::default());
    }
    #[test]
    ...
    #[test]
    fn test_is_alnum_examples() {
        let _ = is_alnum(Default::default());
    }
    #[test]
    fn test_is_space_examples() {
        let _ = is_space(Default::default());
    }
    #[test]
    fn test_is_upper_examples() {
        let _ = is_upper(Default::default());
    }
    #[test]
    fn test_is_lower_examples() {
        let _ = is_lower(Default::default());
    }
    #[test]
    fn test_is_title_examples() {
        let _ = is_title(Default::default());
    }
    #[test]
    ...
    #[test]
    fn test_is_decimal_examples() {
        let _ = is_decimal(Default::default());
    }
    #[test]
    fn test_is_identifier_examples() {
        let _ = is_identifier(Default::default());
    }
    #[test]
    fn test_is_printable_examples() {
        let _ = is_printable(Default::default());
    }
    #[test]
    fn test_length_examples() {
        assert_eq!(length(""), 0);
        assert_eq!(length("a"), 1);
        assert_eq!(length("abc"), 3);
    }
    #[test]
    fn quickcheck_expandtabs() {
        fn prop(text: String, tabsize: i32) -> TestResult {
            let result = expandtabs((&*text).into(), tabsize.clone());
            if result < 0 {
