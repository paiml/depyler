...
#[doc = "Check if value is None."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn is_none(value: &Option<i32>) -> bool {
    value.is_none()
}
#[doc = "Check if value is not None."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn is_some(value: &Option<i32>) -> bool {
    value.is_some()
}
#[doc = "Unwrap optional value, raise if None."]
#[doc = " Depyler: proven to terminate"]
pub fn unwrap(value: &Option<i32>) -> Result<i32, Box<dyn std::error::Error>> {
    if value.is_none() {
        return Err(Box::new(ValueError::new("Cannot unwrap None".to_string())));
    }
    Ok(value)
}
#[doc = "Unwrap optional value or return default."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
...
#[doc = "Unwrap optional or call function for default."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn unwrap_or_else(value: &Option<i32>, default_fn: impl Fn()) -> i32 {
    if value.is_some() {
        value
    } else {
        default_fn()
...
#[doc = "Map function over optional value."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn map_optional(value: &Option<i32>, r#fn: impl Fn()) -> Option<i32> {
    if value.is_some() {
        Some(r#fn(value))
    } else {
        None
...
#[doc = "Flat map function over optional value."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn flat_map_optional(value: &Option<i32>, r#fn: impl Fn()) -> Option<i32> {
    if value.is_none() {
        return None;
    }
    Some(r#fn(value))
}
#[doc = "Filter optional value by predicate."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn filter_optional(value: &Option<i32>, predicate: impl Fn()) -> Option<i32> {
    if value.is_none() {
        return None;
    }
    if predicate(value) {
...
#[doc = "Chain optional operations."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn and_then(value: &Option<i32>, r#fn: impl Fn()) -> Option<i32> {
    if value.is_none() {
        return None;
    }
    Some(r#fn(value))
}
#[doc = "Provide alternative if None."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn or_else(value: Option<i32>, r#fn: impl Fn()) -> Option<i32> {
    if value.is_some() {
        return value;
    }
    Some(r#fn())
}
#[doc = "Zip two optionals into optional tuple."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn zip_optional<'a, 'b>(a: &'a Option<i32>, b: &'b Option<i32>) -> Option<(i32, i32)> {
    let _cse_temp_0 = (a.is_none()) || (b.is_none());
    if _cse_temp_0 {
        return None;
    }
    Some((a, b))
}
#[doc = "Return first non-None value."]
#[doc = " Depyler: verified panic-free"]
pub fn first_some(values: &[String]) -> Option<i32> {
...
#[doc = "Return list if all values are Some, else None."]
#[doc = " Depyler: verified panic-free"]
pub fn all_some(values: &[String]) -> Option<Vec<i32>> {
    let mut result = vec![];
    for v in values.iter().cloned() {
        if v.is_none() {
            return None;
        }
        result.push(DepylerValue::Str(v.to_string()));
    }
    Some(result)
}
#[doc = "Check if any value is Some."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn any_some(values: &[String]) -> bool {
    values.iter().cloned().map(|v| !v.is_null()).any(|x| x)
}
#[doc = "Check if all values are None."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn none_of(values: &[String]) -> bool {
    values.iter().cloned().map(|v| v.is_null()).all(|x| x)
}
#[doc = "Count non-None values."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn count_some(values: &[String]) -> i32 {
    values
        .iter()
        .cloned()
        .filter(|&v| v.is_some())
...
#[doc = "Filter out None values from list."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn filter_none(values: &Vec<Option<i32>>) -> Vec<i32> {
    values
        .iter()
        .cloned()
        .filter(|v| {
...
#[doc = "Replace None values with default."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn replace_none(values: &Vec<Option<i32>>, default: i32) -> Vec<i32> {
    values
        .iter()
        .cloned()
        .map(|v| if !v.is_null() { v } else { default })
        .collect::<Vec<_>>()
}
#[doc = "Add two optional values."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn optional_add<'b, 'a>(a: &'a Option<i32>, b: &'b Option<i32>) -> Option<i32> {
    let _cse_temp_0 = (a.is_none()) || (b.is_none());
    if _cse_temp_0 {
        return None;
    }
...
#[doc = "Multiply two optional values."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn optional_multiply<'a, 'b>(a: &'a Option<i32>, b: &'b Option<i32>) -> Option<i32> {
    let _cse_temp_0 = (a.is_none()) || (b.is_none());
    if _cse_temp_0 {
        return None;
    }
...
#[doc = "Divide, return None if divisor is zero."]
#[doc = " Depyler: proven to terminate"]
pub fn safe_divide(a: i32, b: i32) -> Result<Option<i32>, Box<dyn std::error::Error>> {
    let _cse_temp_0 = b == 0;
    if _cse_temp_0 {
        return Ok(None);
    }
...
#[doc = "Square root, return None if negative."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn safe_sqrt(n: i32) -> Option<f64> {
    let _cse_temp_0 = n < 0;
    if _cse_temp_0 {
        return None;
    }
    Some(({ n } as f64).powf({ 0.5 } as f64))
}
#[doc = "Get list item, return None if out of bounds."]
#[doc = " Depyler: proven to terminate"]
pub fn safe_index(lst: &Vec<i32>, index: i32) -> Result<Option<i32>, Box<dyn std::error::Error>> {
...
#[doc = "Get first item, return None if empty."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn safe_head(lst: &Vec<i32>) -> Result<Option<i32>, Box<dyn std::error::Error>> {
    Ok(if !lst.is_empty() {
        Some(
            lst.get(0usize)
                .cloned()
...
#[doc = "Get tail, return None if empty."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn safe_tail(lst: &Vec<i32>) -> Option<Vec<i32>> {
    if !lst.is_empty() {
        Some({
            let base = &lst;
...
#[doc = "Parse int, return None if invalid."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn safe_parse_int(s: &str) -> Option<i32> {
    return Some(s.parse::<i32>().unwrap_or(Default::default()));
}
#[doc = "Parse float, return None if invalid."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn safe_parse_float(s: &str) -> Option<f64> {
    {
        return Some(s.parse::<f64>().unwrap());
        return None;
    }
}
#[doc = "Get dict value, return None if missing."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn safe_get_key<'a, 'b>(
    d: &'a std::collections::HashMap<String, i32>,
    key: &'b str,
) -> Option<i32> {
    d.get(key).cloned()
}
#[doc = "Convert optional to result(value, error) tuple."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn option_to_result<'b, 'a>(
    value: &'a Option<i32>,
    error: &'b str,
...
#[doc = "Convert result to optional(discard error)."]
#[doc = " Depyler: proven to terminate"]
...
#[doc = "Unwrap with custom error message."]
#[doc = " Depyler: proven to terminate"]
pub fn expect<'b, 'a>(
    value: &'a Option<i32>,
    _message: &'b str,
    ...
    if value.is_none() {
        return Err(Box::new(ValueError::new(message)));
    }
    Ok(value)
}
#[doc = "Convert optional to result with error."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn ok_or<'a, 'b>(value: &'a Option<i32>, error: &'b str) -> (Option<i32>, Option<String>) {
    if value.is_some() {
        return (value, None);
    }
    (None, error)
}
#[doc = "Transpose list of optionals to optional list."]
#[doc = " Depyler: verified panic-free"]
pub fn transpose_list(values: &Vec<Option<i32>>) -> Option<Vec<i32>> {
    let mut result = vec![];
    for v in values.iter().cloned() {
        if v.is_none() {
            return None;
...
pub fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let parse_optional = move |s: &str| -> Option<i32> {
        if s.to_lowercase() == "none".to_string() {
            return None;
        }
        return Some(s.parse::<i32>().unwrap_or(Default::default()));
    };
    let _cse_temp_0 = matches!(args.command, Some(Commands::Unwrap { .. }));
    match &args.command {
        Some(Commands::Unwrap {
            ref default,
            ref value,
            ..
        }) => {
            let default = default.clone();
            let value = if value { parse_optional(&value) } else { None };
            let mut result;
            if default.is_some() {
                result = unwrap_or(&Some(value), default);
                println!("{}", format!("Result: {:?}", result));
            } else {
                match (|| -> Result<(), Box<dyn std::error::Error>> {
                    result = unwrap(&Some(value))?;
                    println!("{}", format!("Result: {:?}", result));
                    Ok(())
                })() {
                    Ok(()) => {}
        ...
        Some(Commands::SafeDiv { ref a, ref b, .. }) => {
            let a = *a;
            let b = *b;
        ...
        Some(Commands::Parse { ref value, .. }) => {
            let result = safe_parse_int(&value);
            if result.is_some() {
        ...
        Some(Commands::Filter { .. }) => {
            let values = values
                .into_iter()
                .map(|v| parse_optional(v))
                .collect::<Vec<_>>();
            let filtered = filter_none(&values);
...
mod tests {
    ...
    #[test]
    fn test_is_none_examples() {
        let _ = is_none(Default::default());
    }
    #[test]
    fn test_is_some_examples() {
        let _ = is_some(Default::default());
    }
    #[test]
    fn test_any_some_examples() {
        let _ = any_some(Default::default());
    }
    #[test]
    fn test_none_of_examples() {
        let _ = none_of(Default::default());
    }
    #[test]
    fn test_count_some_examples() {
        assert_eq!(count_some(&vec![]), 0);
        assert_eq!(count_some(&vec![1]), 1);
        assert_eq!(count_some(&vec![1, 2, 3]), 3);
    }
    #[test]
    fn test_filter_none_examples() {
        assert_eq!(filter_none(vec![]), vec![]);
        assert_eq!(filter_none(vec![1]), vec![1]);
    }
}
