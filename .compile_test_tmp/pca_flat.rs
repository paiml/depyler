...
pub fn main() -> Result<(), Box<dyn std::error::Error>> {
    let mut pc1_y: f64 = Default::default();
    let mut sqrt_disc: f64 = Default::default();
    let mut pc1_x: f64 = Default::default();
    ...
    let x3 = args.x3;
    let y3 = args.y3;
    let _cse_temp_0 = x0 + x1 + x2;
    let _cse_temp_1 = ((_cse_temp_0 + x3) as f64) / ((4.0) as f64);
    let mean_x = _cse_temp_1;
    let _cse_temp_2 = y0 + y1 + y2;
    let _cse_temp_3 = ((_cse_temp_2 + y3) as f64) / ((4.0) as f64);
    let mean_y = _cse_temp_3;
    let cx0 = x0 - mean_x;
    let cy0 = y0 - mean_y;
    let cx1 = x1 - mean_x;
    let cy1 = y1 - mean_y;
    ...
    let cx3 = x3 - mean_x;
    let cy3 = y3 - mean_y;
    let _cse_temp_4 = cx0 * cx0;
    let _cse_temp_5 = cx1 * cx1;
    let _cse_temp_6 = cx2 * cx2;
    let _cse_temp_7 = _cse_temp_4 + _cse_temp_5 + _cse_temp_6;
    let _cse_temp_8 = cx3 * cx3;
    let _cse_temp_9 = ((_cse_temp_7 + _cse_temp_8) as f64) / ((4.0) as f64);
    let cov_xx = _cse_temp_9;
    let _cse_temp_10 = cx0 * cy0;
    let _cse_temp_11 = cx1 * cy1;
    let _cse_temp_12 = cx2 * cy2;
    let _cse_temp_13 = _cse_temp_10 + _cse_temp_11 + _cse_temp_12;
    let _cse_temp_14 = cx3 * cy3;
    let _cse_temp_15 = ((_cse_temp_13 + _cse_temp_14) as f64) / ((4.0) as f64);
    let cov_xy = _cse_temp_15;
    let _cse_temp_16 = cy0 * cy0;
    let _cse_temp_17 = cy1 * cy1;
    let _cse_temp_18 = cy2 * cy2;
    let _cse_temp_19 = _cse_temp_16 + _cse_temp_17 + _cse_temp_18;
    let _cse_temp_20 = cy3 * cy3;
    let _cse_temp_21 = ((_cse_temp_19 + _cse_temp_20) as f64) / ((4.0) as f64);
    let cov_yy = _cse_temp_21;
    let trace = cov_xx + cov_yy;
    let _cse_temp_22 = cov_xx * cov_yy;
    let _cse_temp_23 = cov_xy * cov_xy;
    let det = _cse_temp_22 - _cse_temp_23;
    let _cse_temp_24 = trace * trace;
    let _cse_temp_25 = 4.0 * det;
    let disc = _cse_temp_24 - _cse_temp_25;
    sqrt_disc = disc;
    let _cse_temp_26 = disc > 0.0;
    if _cse_temp_26 {
        let _cse_temp_27 = ((disc) as f64) / ((2.0) as f64);
        sqrt_disc = _cse_temp_27;
        let mut i = 0.0;
        while i < 10.0 {
            sqrt_disc =
                ((sqrt_disc + ((disc) as f64) / ((sqrt_disc) as f64)) as f64) / ((2.0) as f64);
            i = i + 1.0;
        }
    }
    let _cse_temp_28 = ((trace + sqrt_disc) as f64) / ((2.0) as f64);
    let lambda1 = _cse_temp_28;
    let _cse_temp_29 = ((trace - sqrt_disc) as f64) / ((2.0) as f64);
    let lambda2 = _cse_temp_29;
    let total_var = lambda1 + lambda2;
    let _cse_temp_30 = args.mode == "transform";
    if _cse_temp_30 {
        let _cse_temp_31 = cov_xy > 0.0001;
        if _cse_temp_31 {
            pc1_x = cov_xy;
        ...
        let _cse_temp_32 = pc1_x * pc1_x;
        let _cse_temp_33 = pc1_y * pc1_y;
        let mag = _cse_temp_32 + _cse_temp_33;
        let _cse_temp_34 = ((mag) as f64) / ((2.0) as f64);
        let mut mag_sqrt = _cse_temp_34.clone();
        let mut j = 0.0;
        while j < 10.0 {
            mag_sqrt = ((mag_sqrt + ((mag) as f64) / ((mag_sqrt) as f64)) as f64) / ((2.0) as f64);
            j = j + 1.0;
        }
        let _cse_temp_35 = mag_sqrt > 0.0;
        if _cse_temp_35 {
            let _cse_temp_36 = ((pc1_x) as f64) / ((mag_sqrt) as f64);
            pc1_x = _cse_temp_36;
            let _cse_temp_37 = ((pc1_y) as f64) / ((mag_sqrt) as f64);
            pc1_y = _cse_temp_37;
        }
        let _cse_temp_38 = cx0 * pc1_x;
        let _cse_temp_39 = cy0 * pc1_y;
        let proj0 = _cse_temp_38 + _cse_temp_39;
        let _cse_temp_40 = cx1 * pc1_x;
        let _cse_temp_41 = cy1 * pc1_y;
        let proj1 = _cse_temp_40 + _cse_temp_41;
        let _cse_temp_42 = cx2 * pc1_x;
        let _cse_temp_43 = cy2 * pc1_y;
        let proj2 = _cse_temp_42 + _cse_temp_43;
        let _cse_temp_44 = cx3 * pc1_x;
        let _cse_temp_45 = cy3 * pc1_y;
        let proj3 = _cse_temp_44 + _cse_temp_45;
        println!(
            "{}",
            format!(
        ...
        let _cse_temp_46 = args.mode == "variance";
        if _cse_temp_46 {
            let _cse_temp_47 = total_var > 0.0;
            let mut var_ratio1: f64;
            let mut var_ratio2: f64;
            if _cse_temp_47 {
                let _cse_temp_48 = ((lambda1) as f64) / ((total_var) as f64);
                var_ratio1 = _cse_temp_48;
                let _cse_temp_49 = ((lambda2) as f64) / ((total_var) as f64);
                var_ratio2 = _cse_temp_49;
            } else {
                var_ratio1 = 0.0;
                var_ratio2 = 0.0;
            }
            println!(
                "{}",
                format!("var_ratio1={} var_ratio2={}", var_ratio1, var_ratio2)
            );
        }
    }
    Ok(())
