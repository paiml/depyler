...
struct Args {
    ...
    #[doc = "Output file(default: stdout, flag only: output.txt)"]
    output: Option<String>,
    
    #[doc = "Tags to apply(zero or more)"]
    tags: Vec<String>,
    
    #[doc = "Additional files(one or more when specified)"]
    files: Vec<String>,
...
pub fn main() {
    ...
    println!("{}", format!("Input: {}", args.input));
    println!("{}", format!("Output: {}", args.output));
    println!("{}", format!("Tags: {:?}", args.tags));
