...
#[doc = "Logical AND of two integers as booleans.\n\n   >>>bool_and(1, 1)\n    True\n   >>>bool_and(1, 0)\n    False\n   >>>bool_and(0, 0)\n    False\n    "]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn bool_and(x: i32, y: i32) -> bool {
    (x != 0) && (y != 0)
}
#[doc = "Logical OR of two integers as booleans.\n\n   >>>bool_or(1, 0)\n    True\n   >>>bool_or(0, 1)\n    True\n   >>>bool_or(0, 0)\n    False\n    "]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn bool_or(x: i32, y: i32) -> bool {
    (x != 0) || (y != 0)
}
#[doc = "Logical NOT of integer as boolean.\n\n   >>>bool_not(0)\n    True\n   >>>bool_not(1)\n    False\n   >>>bool_not(5)\n    False\n    "]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn bool_not(x: i32) -> bool {
    x == 0
}
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn main() {
    ...
    let _cse_temp_0 = matches!(args.command, Some(Commands::And { .. }));
    match &args.command {
        Some(Commands::And { ref x, ref y, .. }) => {
            let x = *x;
            let y = *y;
            println!(
                "{}",
...
mod tests {
    ...
    #[test]
    fn test_bool_not_examples() {
        let _ = bool_not(Default::default());
    }
}
