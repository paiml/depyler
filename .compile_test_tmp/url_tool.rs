...
#[doc = "Parse URL. Depyler: proven to terminate"]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn cmd_parse(url: &str) {
    let u = String::from(url);
    println!("{}", format!("Scheme: {}", u.scheme));
    println!("{}", format!("Host: {}", u.hostname));
    println!("{}", format!("Port: {}", u.port));
    println!("{}", format!("Path: {}", u.path));
    println!("{}", format!("Query: {}", u.query));
    println!("{}", format!("Fragment: {}", u.fragment));
}
#[doc = "URL encode string. Depyler: proven to terminate"]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn cmd_encode(text: &str) {
    println!("{}", url::percent_encoding::percent_encode(text));
}
#[doc = "URL decode string. Depyler: proven to terminate"]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn cmd_decode(text: &str) {
    println!("{}", url::percent_encoding::percent_decode(text));
}
#[doc = "Join URL parts. Depyler: proven to terminate"]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn cmd_join(base: &str, path: &str) {
    println!("{}", format!("{}{}", base, path));
}
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn main() {
    ...
    ({
        ...
        map.insert("parse".to_string().to_string(), cmd_parse);
        map.insert("encode".to_string().to_string(), cmd_encode);
        map.insert("decode".to_string().to_string(), cmd_decode);
        map.insert("join".to_string().to_string(), cmd_join);
        map
    }
