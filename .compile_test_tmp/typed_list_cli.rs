...
#[doc = "Create empty typed list."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn create_empty_list() -> Vec<i32> {
    vec![]
}
#[doc = "Create list from items."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn create_list(items: &Vec<i32>) -> Vec<i32> {
    items.into_iter().collect::<Vec<_>>()
}
#[doc = "Append item to list(returns new list)."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn append(lst: &Vec<i32>, item: i32) -> Vec<i32> {
    lst.iter()
        .chain(vec![item].iter())
        .cloned()
        .collect::<Vec<_>>()
...
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn prepend(lst: &Vec<i32>, item: i32) -> Vec<i32> {
    vec![item]
        .iter()
        .chain(lst.iter())
        .cloned()
...
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn insert_at(lst: &Vec<i32>, index: i32, item: i32) -> Vec<i32> {
    let mut result = lst.clone();
    result.insert(index as usize, item);
    result
}
#[doc = "Remove first occurrence of item."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn remove_item(lst: &Vec<i32>, item: i32) -> Vec<i32> {
    let mut result = lst.clone();
    let _cse_temp_0 = result.contains(&item);
    if _cse_temp_0 {
...
#[doc = "Remove item at index."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn remove_at(lst: &Vec<i32>, index: i32) -> Vec<i32> {
    ...
    if _cse_temp_3 {
        ...
        .chain(
            {
                let base = &lst;
                let start_idx = (index + 1) as isize;
...
#[doc = "Pop last item, return(item, new_list)."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn pop_last(lst: &Vec<i32>) -> (Option<i32>, Vec<i32>) {
    if lst.is_empty() {
        return (None, vec![]);
    }
    (
...
#[doc = "Pop first item, return(item, new_list)."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn pop_first(lst: &Vec<i32>) -> (Option<i32>, Vec<i32>) {
    if lst.is_empty() {
        return (None, vec![]);
    }
    (
...
#[doc = "Get item at index, None if out of bounds."]
#[doc = " Depyler: proven to terminate"]
pub fn get_item(lst: &Vec<i32>, index: i32) -> Result<Option<i32>, Box<dyn std::error::Error>> {
    let _cse_temp_0 = 0 <= index;
    let _cse_temp_1 = lst.len() as i32;
    let _cse_temp_2 = index < _cse_temp_1;
    let _cse_temp_3 = (_cse_temp_0) && (_cse_temp_2);
...
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn get_first(lst: &Vec<i32>) -> Result<Option<i32>, Box<dyn std::error::Error>> {
    Ok(if !lst.is_empty() {
        Some(
            lst.get(0usize)
                .cloned()
...
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn get_last(lst: &Vec<i32>) -> Result<Option<i32>, Box<dyn std::error::Error>> {
    Ok(if !lst.is_empty() {
        Some({
            let base = &lst;
            base.get(base.len().saturating_sub(1usize))
...
#[doc = "Set item at index."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn set_item(lst: &Vec<i32>, index: i32, value: i32) -> Vec<i32> {
    let mut result = lst.clone();
    let _cse_temp_0 = 0 <= index;
    let _cse_temp_1 = result.len() as i32;
    let _cse_temp_2 = index < _cse_temp_1;
    let _cse_temp_3 = (_cse_temp_0) && (_cse_temp_2);
    if _cse_temp_3 {
...
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn list_size(lst: &Vec<i32>) -> i32 {
    lst.len() as i32 as i32
}
#[doc = "Check if list is empty."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn is_empty(lst: &Vec<i32>) -> bool {
    lst.len() as i32 == 0
}
#[doc = "Check if list contains item."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn contains(lst: &Vec<i32>, item: i32) -> bool {
    lst.contains(&item)
}
#[doc = "Get index of item, -1 if not found."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn index_of(lst: &Vec<i32>, item: i32) -> i32 {
    {
        return lst
            .iter()
            .position(|x| x == &item)
...
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn count_item(lst: &Vec<i32>, item: i32) -> i32 {
    lst.iter().filter(|x| **x == item).count() as i32 as i32
}
#[doc = "Slice list from start to end."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn slice_list(lst: &Vec<i32>, start: i32, end: i32) -> Vec<i32> {
    {
        let base = &lst;
...
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn take(lst: &Vec<i32>, n: i32) -> Vec<i32> {
    {
        let base = &lst;
...
#[doc = "Drop first n items."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn drop(lst: &Vec<i32>, n: i32) -> Vec<i32> {
    {
        let base = &lst;
        let start_idx = (n) as isize;
        let start = if start_idx < 0 {
            (base.len() as isize + start_idx).max(0) as usize
        } else {
            start_idx as usize
...
#[doc = "Take last n items."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn take_last(lst: &Vec<i32>, n: i32) -> Vec<i32> {
    if n > 0 {
        {
            let base = &lst;
            let start_idx = (-n) as isize;
...
#[doc = "Drop last n items."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn drop_last(lst: &Vec<i32>, n: i32) -> Vec<i32> {
    if n > 0 {
        {
            let base = &lst;
            let stop_idx = (-n) as isize;
...
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn reverse_list(lst: &Vec<i32>) -> Vec<i32> {
    {
        let base = lst;
        let step: i32 = -1;
        if step == 1 {
...
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn sort_asc(lst: &Vec<i32>) -> Vec<i32> {
    {
        let mut sorted_vec = lst.iter().cloned().collect::<Vec<_>>();
...
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn sort_desc(lst: &Vec<i32>) -> Vec<i32> {
    {
        let mut __sorted_result = lst.clone();
...
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn concat<'a, 'b>(lst1: &'a Vec<i32>, lst2: &'b Vec<i32>) -> Vec<i32> {
    lst1.add(&lst2).unwrap()
}
#[doc = "Extend list with items."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn extend<'b, 'a>(lst: &'a Vec<i32>, items: &'b Vec<i32>) -> Vec<i32> {
    lst.add(&items).unwrap()
}
#[doc = "Repeat list n times."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn repeat(lst: &Vec<i32>, n: i32) -> Vec<i32> {
    lst * n
}
#[doc = "Flatten nested list."]
#[doc = " Depyler: verified panic-free"]
...
#[doc = "Filter items greater than threshold."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn filter_gt(lst: &Vec<i32>, threshold: i32) -> Vec<i32> {
    lst.as_slice()
        .iter()
        .cloned()
        .filter(|x| {
...
#[doc = "Filter items less than threshold."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn filter_lt(lst: &Vec<i32>, threshold: i32) -> Vec<i32> {
    lst.as_slice()
        .iter()
        .cloned()
        .filter(|x| {
...
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn filter_even(lst: &Vec<i32>) -> Vec<i32> {
    lst.as_slice()
        .iter()
        .cloned()
        .filter(|x| {
...
#[doc = "Filter odd numbers."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn filter_odd(lst: &Vec<i32>) -> Vec<i32> {
    lst.as_slice()
        .iter()
        .cloned()
        .filter(|x| {
...
#[doc = "Double all values."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn map_double(lst: &Vec<i32>) -> Vec<i32> {
    lst.as_slice()
        .iter()
        .cloned()
        .map(|x| x * 2)
...
#[doc = "Square all values."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn map_square(lst: &Vec<i32>) -> Vec<i32> {
    lst.as_slice()
        .iter()
        .cloned()
        .map(|x| x * x)
...
#[doc = "Add n to all values."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn map_add(lst: &Vec<i32>, n: i32) -> Vec<i32> {
    lst.as_slice()
        .iter()
        .cloned()
        .map(|x| x + n)
...
#[doc = "Multiply all values by n."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn map_multiply(lst: &Vec<i32>, n: i32) -> Vec<i32> {
    lst.as_slice()
        .iter()
        .cloned()
        .map(|x| x * n)
...
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn sum_list(lst: &Vec<i32>) -> i32 {
    lst.iter().sum::<i32>()
}
#[doc = "Product of all values."]
#[doc = " Depyler: verified panic-free"]
pub fn product_list(lst: &Vec<i32>) -> i32 {
...
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn max_list(lst: &Vec<i32>) -> Option<i32> {
    if !lst.is_empty() {
...
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn min_list(lst: &Vec<i32>) -> Option<i32> {
    if !lst.is_empty() {
...
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn mean_list(lst: &Vec<i32>) -> Result<Option<f64>, Box<dyn std::error::Error>> {
    Ok(if !lst.is_empty() {
        Some(((lst.iter().sum::<i32>()) as f64) / ((lst.len() as i32) as f64))
    } else {
        None
    })
}
#[doc = "Get unique values(preserves order)."]
#[doc = " Depyler: verified panic-free"]
...
pub fn deduplicate(lst: &Vec<i32>) -> Result<Vec<i32>, Box<dyn std::error::Error>> {
    if lst.is_empty() {
        return Ok(vec![]);
    }
    let mut result = vec![lst
        .get(0usize)
        .cloned()
        .expect("IndexError: list index out of range")];
    for x in {
...
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn zip_lists<'a, 'b>(lst1: &'a Vec<i32>, lst2: &'b Vec<i32>) -> Vec<(i32, i32)> {
    lst1.into_iter().zip(lst2.into_iter()).collect::<Vec<_>>()
}
#[doc = "Enumerate list."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn enumerate_list(lst: &Vec<i32>) -> Vec<(i32, i32)> {
    lst.iter()
        .cloned()
        .enumerate()
        .map(|(i, x)| (i as i32, x))
...
#[doc = "Create list from range."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn range_list(start: i32, end: i32, step: i32) -> Vec<i32> {
    {
...
pub fn main() {
    ...
    let parse_list = move |s: &str| -> Vec<i32> {
        return s
            .split(",")
            .map(|s| s.to_string())
            .collect::<Vec<String>>()
            ...
            .map(|x| x.trim().to_string().parse::<i32>().unwrap_or_default())
            .collect::<Vec<_>>();
    };
    let _cse_temp_0 = matches!(args.command, Some(Commands::Create { .. }));
    match &args.command {
        Some(Commands::Create { ref items, .. }) => {
            let items = items.clone();
            let lst = create_list(&items);
            println!("{:?}", lst);
        }
        Some(Commands::Append {
            ...
            let item = *item;
            let lst = parse_list(list);
            let result = append(&lst, item);
            println!("{:?}", result);
        }
        Some(Commands::Stats { ref list, .. }) => {
            let lst = parse_list(list);
            println!("{}", format!("Size: {}", list_size(&lst)));
            println!("{}", format!("Sum: {}", sum_list(&lst)));
            println!("{}", format!("Max: {:?}", max_list(&lst)));
            println!("{}", format!("Min: {:?}", min_list(&lst)));
            println!("{}", format!("Mean: {:?}", mean_list(&lst)));
        }
        Some(Commands::Sort {
            ref desc, ref list, ..
        }) => {
...
mod tests {
    ...
    #[test]
    fn test_create_list_examples() {
        assert_eq!(create_list(vec![]), vec![]);
        assert_eq!(create_list(vec![1]), vec![1]);
    }
    #[test]
    fn test_list_size_examples() {
        assert_eq!(list_size(&vec![]), 0);
        assert_eq!(list_size(&vec![1]), 1);
        assert_eq!(list_size(&vec![1, 2, 3]), 3);
    }
    #[test]
    fn test_is_empty_examples() {
        let _ = is_empty(Default::default());
    }
    #[test]
    ...
    #[test]
    fn quickcheck_sort_asc() {
        fn prop(lst: Vec<i32>) -> TestResult {
            let input_len = lst.len();
            let result = sort_asc(&lst);
            ...
            let mut input_sorted = lst.clone();
            input_sorted.sort();
            let mut result = sort_asc(&lst);
            result.sort();
    ...
    #[test]
    fn test_sort_asc_examples() {
        assert_eq!(sort_asc(vec![]), vec![]);
        assert_eq!(sort_asc(vec![1]), vec![1]);
    }
    #[test]
    fn quickcheck_sort_desc() {
        fn prop(lst: Vec<i32>) -> TestResult {
            let input_len = lst.len();
            let result = sort_desc(&lst);
            if result.len() != input_len {
                return TestResult::failed();
            }
            let result = sort_desc(&lst);
    ...
    #[test]
    fn test_sort_desc_examples() {
        assert_eq!(sort_desc(vec![]), vec![]);
        assert_eq!(sort_desc(vec![1]), vec![1]);
    }
    #[test]
    fn quickcheck_concat() {
        fn prop(lst1: Vec<i32>, lst2: Vec<i32>) -> TestResult {
            let result1 = concat(&lst1, &lst2);
            let result2 = concat(&lst2, &lst1);
            if result1 != result2 {
                return TestResult::failed();
            }
            TestResult::passed()
    ...
    #[test]
    fn quickcheck_extend() {
        fn prop(lst: Vec<i32>, items: Vec<i32>) -> TestResult {
            let result1 = extend(&lst, &items);
            let result2 = extend(&items, &lst);
            if result1 != result2 {
                return TestResult::failed();
            }
            TestResult::passed()
    ...
    #[test]
    fn quickcheck_repeat() {
        fn prop(lst: Vec<i32>, n: i32) -> TestResult {
            let result1 = repeat(&lst, n.clone());
            let result2 = repeat(n.clone(), &lst);
            if result1 != result2 {
                return TestResult::failed();
            }
            TestResult::passed()
    ...
    #[test]
    fn test_flatten_examples() {
        assert_eq!(flatten(vec![]), vec![]);
        assert_eq!(flatten(vec![1]), vec![1]);
    }
    #[test]
    fn test_filter_even_examples() {
        assert_eq!(filter_even(vec![]), vec![]);
        assert_eq!(filter_even(vec![1]), vec![1]);
    }
    #[test]
    fn test_filter_odd_examples() {
        assert_eq!(filter_odd(vec![]), vec![]);
        assert_eq!(filter_odd(vec![1]), vec![1]);
    }
    #[test]
    fn quickcheck_map_double() {
        fn prop(lst: Vec<i32>) -> TestResult {
            let input_len = lst.len();
            let result = map_double(&lst);
            if result.len() != input_len {
                return TestResult::failed();
            }
            TestResult::passed()
    ...
    #[test]
    fn test_map_double_examples() {
        assert_eq!(map_double(vec![]), vec![]);
        assert_eq!(map_double(vec![1]), vec![1]);
    }
    #[test]
    fn quickcheck_map_square() {
        fn prop(lst: Vec<i32>) -> TestResult {
            let input_len = lst.len();
            let result = map_square(&lst);
            if result.len() != input_len {
                return TestResult::failed();
            }
            TestResult::passed()
    ...
    #[test]
    fn test_map_square_examples() {
        assert_eq!(map_square(vec![]), vec![]);
        assert_eq!(map_square(vec![1]), vec![1]);
    }
    #[test]
    ...
    #[test]
    fn test_product_list_examples() {
        assert_eq!(product_list(&vec![]), 0);
        assert_eq!(product_list(&vec![1]), 1);
        assert_eq!(product_list(&vec![1, 2, 3]), 3);
    }
    #[test]
    fn test_unique_examples() {
        assert_eq!(unique(vec![]), vec![]);
        assert_eq!(unique(vec![1]), vec![1]);
    }
    #[test]
    fn test_deduplicate_examples() {
        assert_eq!(deduplicate(vec![]), vec![]);
        assert_eq!(deduplicate(vec![1]), vec![1]);
    }
    #[test]
