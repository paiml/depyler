...
#[doc = "Check if any value is truthy.\n\n   >>>check_any(0, 0, 0, 0)\n    False\n   >>>check_any(1, 0, 0, 0)\n    True\n   >>>check_any(0, 0, 0, 1)\n    True\n    "]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn check_any(a: i32, b: i32, c: i32, d: i32) -> bool {
    (((a != 0) || (b != 0)) || (c != 0)) || (d != 0)
}
#[doc = "Check if all values are truthy.\n\n   >>>check_all(1, 1, 1, 1)\n    True\n   >>>check_all(1, 1, 1, 0)\n    False\n   >>>check_all(0, 0, 0, 0)\n    False\n    "]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn check_all(a: i32, b: i32, c: i32, d: i32) -> bool {
    (((a != 0) && (b != 0)) && (c != 0)) && (d != 0)
}
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn main() {
    ...
    let _cse_temp_0 = matches!(args.command, Some(Commands::Any { .. }));
    match &args.command {
        Some(Commands::Any {
            ref a,
            ref b,
