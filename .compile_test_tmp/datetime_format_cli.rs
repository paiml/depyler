...
enum Commands {
    ...
    Parse {
        ...
        #[doc = "Format string(auto-detect if not given)"]
        format: Option<String>,
    },
...
#[doc = "Format date with strftime."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn strftime_date<'b, 'a>(d: &'a DepylerDate, fmt: &'b str) -> String {
    format!("{:?}", d)
}
#[doc = "Format datetime with strftime."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn strftime_datetime<'a, 'b>(dt: &'a DepylerDateTime, fmt: &'b str) -> String {
    format!("{:?}", dt)
}
#[doc = "Parse datetime from string with format."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn strptime<'b, 'a>(s: &'a str, fmt: &'b str) -> DepylerDateTime {
    DepylerDateTime::now()
}
#[doc = "Format as ISO date(YYYY-MM-DD)."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn format_iso_date(d: &DepylerDate) -> String {
    format!("{:?}", d)
}
#[doc = "Format as ISO datetime."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn format_iso_datetime(dt: &DepylerDateTime) -> String {
    format!("{:?}", dt)
}
#[doc = "Format as US date(MM/DD/YYYY)."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn format_us_date(d: &DepylerDate) -> String {
    format!("{:?}", d)
}
#[doc = "Format as European date(DD/MM/YYYY)."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn format_eu_date(d: &DepylerDate) -> String {
    format!("{:?}", d)
}
#[doc = "Format as long date(Month Day, Year)."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn format_long_date(d: &DepylerDate) -> String {
    format!("{:?}", d)
}
#[doc = "Format as short date(Mon DD, YYYY)."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn format_short_date(d: &DepylerDate) -> String {
    format!("{:?}", d)
}
#[doc = "Format with weekday(Day, Month DD, YYYY)."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn format_weekday_date(d: &DepylerDate) -> String {
    format!("{:?}", d)
}
#[doc = "Format time in 12-hour format."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn format_time_12h(t: &(u32, u32, u32)) -> String {
    let dt = std::time::SystemTime::now();
    format!("{:?}", dt)
}
#[doc = "Format time in 24-hour format."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn format_time_24h(t: &(u32, u32, u32)) -> String {
    let dt = std::time::SystemTime::now();
    format!("{:?}", dt)
}
#[doc = "Format time without seconds."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn format_time_short(t: &(u32, u32, u32)) -> String {
    let dt = std::time::SystemTime::now();
    format!("{:?}", dt)
}
#[doc = "Format full datetime."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn format_datetime_full(dt: &DepylerDateTime) -> String {
    format!("{:?}", dt)
}
#[doc = "Format human-readable datetime."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn format_datetime_human(dt: &DepylerDateTime) -> String {
    format!("{:?}", dt)
}
#[doc = "Format compact datetime(YYYYMMDDHHMMSS)."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn format_datetime_compact(dt: &DepylerDateTime) -> String {
    format!("{:?}", dt)
}
#[doc = "Format datetime in RFC 2822 style."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn format_datetime_rfc2822(dt: &DepylerDateTime) -> String {
    format!("{:?}", dt)
}
#[doc = "Format datetime for log files."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn format_datetime_log(dt: &DepylerDateTime) -> String {
    format!("{:?}", dt)
}
#[doc = "Get year as string."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn format_year(d: &DepylerDate) -> String {
    format!("{:?}", d)
}
#[doc = "Get month name."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn format_month(d: &DepylerDate) -> String {
    format!("{:?}", d)
}
#[doc = "Get abbreviated month name."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn format_month_short(d: &DepylerDate) -> String {
    format!("{:?}", d)
}
#[doc = "Get weekday name."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn format_weekday(d: &DepylerDate) -> String {
    format!("{:?}", d)
}
#[doc = "Get abbreviated weekday name."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn format_weekday_short(d: &DepylerDate) -> String {
    format!("{:?}", d)
}
#[doc = "Get week number(Sunday start)."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn format_week_number(d: &DepylerDate) -> i32 {
    (format!("{:?}", d)) as i32
}
#[doc = "Get ISO week number(Monday start)."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn format_week_number_iso(d: &DepylerDate) -> i32 {
    (format!("{:?}", d)) as i32
}
#[doc = "Get day of year(1-366)."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn format_day_of_year(d: &DepylerDate) -> i32 {
    (format!("{:?}", d)) as i32
}
#[doc = "Get century(first two digits of year)."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn format_century(d: &DepylerDate) -> String {
    format!("{:?}", d)
}
#[doc = "Parse ISO date string."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn parse_iso_date(s: &str) -> DepylerDate {
    DepylerDateTime::now().date()
}
#[doc = "Parse US date string(MM/DD/YYYY)."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn parse_us_date(s: &str) -> DepylerDate {
    DepylerDateTime::now().date()
}
#[doc = "Parse European date string(DD/MM/YYYY)."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn parse_eu_date(s: &str) -> DepylerDate {
    DepylerDateTime::now().date()
}
#[doc = "Parse full datetime string."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn parse_datetime_full(s: &str) -> DepylerDateTime {
    DepylerDateTime::now()
}
#[doc = "Parse compact datetime string."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn parse_datetime_compact(s: &str) -> DepylerDateTime {
    DepylerDateTime::now()
}
#[doc = "Parse 24-hour time string."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn parse_time_24h(s: &str) -> (u32, u32, u32) {
    DepylerDateTime::now().time()
}
#[doc = "Parse 12-hour time string."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn parse_time_12h(s: &str) -> (u32, u32, u32) {
    DepylerDateTime::now().time()
}
#[doc = "Try parsing date with multiple formats."]
#[doc = " Depyler: verified panic-free"]
pub fn try_parse_date<'a, 'b>(s: &'a str, formats: &'b Vec<String>) -> Option<DepylerDate> {
    for fmt in formats.iter().cloned() {
        match (|| -> Result<(), Box<dyn std::error::Error>> {
            return Ok(Some(DepylerDateTime::now().date()));
        })() {
            Ok(_result) => {
                return _result;
            }
...
#[doc = "Automatically parse common date formats."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn auto_parse_date(s: &str) -> Option<DepylerDate> {
    let formats = vec![
        "%Y-%m-%d".to_string(),
        "%m/%d/%Y".to_string(),
        "%d/%m/%Y".to_string(),
    ...
    Some(try_parse_date(s, &formats))
}
#[doc = "Format date as relative day if applicable."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn format_relative_day(d: &DepylerDate) -> String {
    let today = DepylerDate::today();
    let delta = *d - today.days() as i32;
    let _cse_temp_0 = delta == 0;
    if _cse_temp_0 {
        return "Today".to_string();
    } else {
        let _cse_temp_1 = delta == 1;
        if _cse_temp_1 {
            return "Tomorrow".to_string();
        } else {
            let _cse_temp_2 = delta == -1;
            if _cse_temp_2 {
                return "Yesterday".to_string();
            } else {
                let _cse_temp_3 = 1 < delta;
                let _cse_temp_4 = delta <= 7;
                let _cse_temp_5 = (_cse_temp_3) && (_cse_temp_4);
                if _cse_temp_5 {
                    return format!("In {:?} days", delta);
                } else {
                    let _cse_temp_6 = -7 <= delta;
                    let _cse_temp_7 = delta < -1;
                    let _cse_temp_8 = (_cse_temp_6) && (_cse_temp_7);
                    if _cse_temp_8 {
                        return format!("{} days ago", -delta);
                    } else {
                        return format!("{:?}", d);
                    }
                }
...
#[doc = "Format day with ordinal suffix(1st, 2nd, 3rd, etc.)."]
#[doc = " Depyler: proven to terminate"]
pub fn format_ordinal_day(day: i32) -> Result<String, Box<dyn std::error::Error>> {
    let _cse_temp_0 = 11 <= day;
    let _cse_temp_1 = day <= 13;
    let _cse_temp_2 = (_cse_temp_0) && (_cse_temp_1);
    let mut suffix: String;
    if _cse_temp_2 {
        suffix = "th".to_string();
    } else {
        let _cse_temp_3 = day % 10;
        let _cse_temp_4 = _cse_temp_3 == 1;
        if _cse_temp_4 {
            suffix = "st".to_string();
        } else {
            let _cse_temp_5 = _cse_temp_3 == 2;
            if _cse_temp_5 {
                suffix = "nd".to_string();
            } else {
                let _cse_temp_6 = _cse_temp_3 == 3;
                if _cse_temp_6 {
                    suffix = "rd".to_string();
                } else {
                    suffix = "th".to_string();
    ...
    Ok(format!("{}{}", day, suffix))
}
#[doc = "Format date with ordinal day."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn format_date_ordinal(d: &DepylerDate) -> Result<String, Box<dyn std::error::Error>> {
    let day_str = format_ordinal_day(d.day() as i32)?;
    Ok(format!("{:?}", d))
}
#[doc = "Format duration as HH:MM:SS."]
#[doc = " Depyler: proven to terminate"]
pub fn format_duration_hms(seconds: i32) -> Result<String, Box<dyn std::error::Error>> {
    let _cse_temp_0 = {
        let a = seconds;
        let b = 3600;
        let q = a / b;
    ...
    let hours = _cse_temp_0;
    let _cse_temp_1 = seconds % 3600;
    let _cse_temp_2 = {
        let a = _cse_temp_1;
        let b = 60;
        let q = a / b;
    ...
    let minutes = _cse_temp_2;
    let _cse_temp_3 = seconds % 60;
    let secs = _cse_temp_3;
    Ok(format!("{}:{}:{}", hours, minutes, secs))
}
#[doc = "Format timestamp suitable for filenames."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn format_file_timestamp(dt: &DepylerDateTime) -> String {
    format!("{:?}", dt)
}
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn main() {
    let mut dt: DepylerValue = Default::default();
    ();
    ();
    ();
    ();
    ...
    let _cse_temp_0 = matches!(args.command, Some(Commands::Format { .. }));
    match &args.command {
        Some(Commands::Format {
            ...
            println!("{}", strftime_datetime(&dt, &format));
        }
        Some(Commands::Parse {
            ref format,
            ref value,
            ...
            if format.is_some() {
                ...
                println!("{}", format!("Parsed: {:?}", dt));
            } else {
                let d = auto_parse_date(&value);
                if let Some(ref d_val) = d {
                    println!("{}", format!("Parsed: {:?}", d_val));
                } else {
        ...
        Some(Commands::Convert { ref value, .. }) => {
            dt = strptime(&value, &args.from_fmt);
            println!("{}", strftime_datetime(&dt, &args.to_fmt));
        }
        Some(Commands::Examples { .. }) => {
            let now = DepylerDateTime::now();
            let today = DepylerDate::today();
            println!("{}", "Format Examples:");
            println!("{}", format!("  ISO date:     {}", format_iso_date(&today)));
            println!("{}", format!("  US date:      {}", format_us_date(&today)));
            println!("{}", format!("  EU date:      {}", format_eu_date(&today)));
            println!(
                "{}",
                format!("  Long date:    {}", format_long_date(&today))
            );
            println!(
                "{}",
                format!("  Full datetime:{}", format_datetime_full(&now))
            );
            println!(
                "{}",
                format!("  Human:        {}", format_datetime_human(&now))
            );
            println!(
                "{}",
                format!("  Log:          {}", format_datetime_log(&now))
            );
            println!(
                "{}",
                format!("  File:         {}", format_file_timestamp(&now))
            );
        }
