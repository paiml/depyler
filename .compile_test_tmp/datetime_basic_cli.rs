...
pub fn today() -> DepylerDate {
    DepylerDate::today()
}
#[doc = "Get current datetime."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn now() -> DepylerDateTime {
    DepylerDateTime::now()
}
...
#[doc = "Create date from components."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn create_date(year: i32, month: i32, day: i32) -> DepylerDate {
    DepylerDate::new(year as u32, month as u32, day as u32)
}
#[doc = "Create time from components."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn create_time(hour: i32, minute: i32, second: i32, microsecond: i32) -> (u32, u32, u32) {
    (hour as u32, minute as u32, second as u32)
}
#[doc = "Create datetime from components."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
...
#[doc = "Get year from date."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn get_year(d: &DepylerDate) -> i32 {
    if let Some(Commands::Date { year }) = &d.command {
        d.year() as i32
    }
}
#[doc = "Get month from date."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn get_month(d: &DepylerDate) -> i32 {
    if let Some(Commands::Date { month }) = &d.command {
        d.month() as i32
    }
}
#[doc = "Get day from date."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn get_day(d: &DepylerDate) -> i32 {
    if let Some(Commands::Date { day }) = &d.command {
        d.day() as i32
    }
}
#[doc = "Get hour from time."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn get_hour(t: &(u32, u32, u32)) -> i32 {
    t.hour() as i32
}
#[doc = "Get minute from time."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn get_minute(t: &(u32, u32, u32)) -> i32 {
    t.minute() as i32
}
#[doc = "Get second from time."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn get_second(t: &(u32, u32, u32)) -> i32 {
    t.second() as i32
}
#[doc = "Get microsecond from time."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn get_microsecond(t: &(u32, u32, u32)) -> i32 {
    t.microsecond() as i32
}
#[doc = "Get weekday(Monday=0, Sunday=6)."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn weekday(d: &DepylerDate) -> i32 {
    d.weekday() as i32
}
#[doc = "Get ISO weekday(Monday=1, Sunday=7)."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn isoweekday(d: &DepylerDate) -> i32 {
    d.isoweekday() as i32
}
#[doc = "Get ISO calendar(year, week, weekday)."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn isocalendar(d: &DepylerDate) -> (i32, i32, i32) {
    let iso = (2024i32, 1i32, 1i32);
    (iso.year() as i32, iso.week, iso.weekday)
}
#[doc = "Get ISO format string for date."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn isoformat_date(d: &DepylerDate) -> String {
    format!("{:?}", d)
}
#[doc = "Get ISO format string for time."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn isoformat_time(t: &(u32, u32, u32)) -> String {
    format!("{:?}", t)
}
#[doc = "Get ISO format string for datetime."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn isoformat_datetime(dt: &DepylerDateTime) -> String {
    format!("{:?}", dt)
}
#[doc = "Parse date from ISO format."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn from_isoformat_date(s: &str) -> DepylerDate {
    DepylerDateTime::now()
}
#[doc = "Parse time from ISO format."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn from_isoformat_time(s: &str) -> (u32, u32, u32) {
    DepylerDateTime::now()
}
#[doc = "Parse datetime from ISO format."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn from_isoformat_datetime(s: &str) -> DepylerDateTime {
    DepylerDateTime::now()
}
#[doc = "Create datetime from Unix timestamp."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn from_timestamp(ts: f64) -> DepylerDateTime {
    DepylerDateTime::fromtimestamp(ts as f64)
}
#[doc = "Create datetime from UTC Unix timestamp."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn from_utc_timestamp(ts: f64) -> DepylerDateTime {
    DepylerDateTime::fromtimestamp(ts as f64)
}
#[doc = "Get Unix timestamp from datetime."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn to_timestamp(dt: &DepylerDateTime) -> f64 {
    dt.duration_since(std::time::UNIX_EPOCH)
        .map(|d| d.as_secs_f64())
        .unwrap_or(0.0)
}
#[doc = "Create date from ordinal(days since year 1)."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn from_ordinal(n: i32) -> DepylerDate {
    DepylerDate::from_ordinal(n as i64)
}
#[doc = "Get ordinal(days since year 1) from date."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn to_ordinal(d: &DepylerDate) -> i32 {
    d.toordinal()
}
#[doc = "Replace date components."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn replace_date(
    d: &DepylerDate,
...
#[doc = "Convert date to datetime at midnight."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn date_to_datetime(d: &DepylerDate) -> DepylerDateTime {
    std::time::SystemTime::now()
}
#[doc = "Extract date from datetime."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn datetime_date(dt: &DepylerDateTime) -> DepylerDate {
    dt
}
#[doc = "Extract time from datetime."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn datetime_time(dt: &DepylerDateTime) -> (u32, u32, u32) {
    dt
}
#[doc = "Combine date and time into datetime."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn combine<'a, 'b>(d: &'a DepylerDate, t: &'b (u32, u32, u32)) -> DepylerDateTime {
    std::time::SystemTime::now()
}
#[doc = "Get minimum representable date."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn min_date() -> DepylerDate {
    DepylerDate::new(1, 1, 1)
}
#[doc = "Get maximum representable date."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn max_date() -> DepylerDate {
    DepylerDate::new(9999, 12, 31)
}
#[doc = "Get minimum representable time."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn min_time() -> (u32, u32, u32) {
    (0u32, 0u32, 0u32, 0u32)
}
#[doc = "Get maximum representable time."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn max_time() -> (u32, u32, u32) {
    (23u32, 59u32, 59u32, 999999u32)
}
#[doc = "Get minimum representable datetime."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn min_datetime() -> DepylerDateTime {
    DepylerDateTime::new(1, 1, 1, 0, 0, 0, 0)
}
#[doc = "Get maximum representable datetime."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn max_datetime() -> DepylerDateTime {
    DepylerDateTime::new(9999, 12, 31, 23, 59, 59, 999999)
}
#[doc = "Get ctime format string."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn ctime(dt: &DepylerDateTime) -> String {
    dt.ctime()
}
#[doc = "Get time tuple."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn timetuple(dt: &DepylerDateTime) -> () {
    (0i32, 0u32, 0u32, 0u32, 0u32, 0u32)
}
...
#[doc = "Get number of days in a month."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn days_in_month(year: i32, month: i32) -> i32 {
    let _cse_temp_0 = month == 2;
    if _cse_temp_0 {
        return if is_leap_year(year) { 29 } else { 28 };
    } else {
        let _cse_temp_1 = [4, 6, 9, 11].contains(&month);
        if _cse_temp_1 {
            return 30;
        } else {
            return 31;
...
#[doc = "Get number of days in a year."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
...
#[doc = "Compare two dates(-1, 0, 1)."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn compare_dates<'b, 'a>(d1: &'a DepylerDate, d2: &'b DepylerDate) -> i32 {
    let _cse_temp_0 = d1 < d2;
    if _cse_temp_0 {
        return -1;
    } else {
        let _cse_temp_1 = d1 > d2;
        if _cse_temp_1 {
            return 1;
        }
    }
...
#[doc = " Depyler: proven to terminate"]
pub fn weekday_name(d: &DepylerDate) -> Result<String, Box<dyn std::error::Error>> {
    let names = vec![
        "Monday".to_string(),
        "Tuesday".to_string(),
        "Wednesday".to_string(),
...
#[doc = "Get month name."]
#[doc = " Depyler: proven to terminate"]
pub fn month_name(month: i32) -> Result<String, Box<dyn std::error::Error>> {
    let names = vec![
        "".to_string(),
        "January".to_string(),
        "February".to_string(),
...
pub fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    match &args.command {
        Some(Commands::Now { .. }) => {
            println!("{}", format!("Local: {}", now()));
            println!("{}", format!("UTC: {}", utc_now()));
            println!(
                "{}",
                format!(
                    "Timestamp: {}",
        ...
        Some(Commands::Today { .. }) => {
            ...
            println!("{}", format!("Weekday: {:?}", weekday_name(&d)));
            println!(
                "{}",
                format!(
                    "Day of year: {}",
                    (0i32, 0u32, 0u32, 0u32, 0u32, 0u32).tm_yday
                )
            );
        }
        Some(Commands::Date {
            ...
            let month = *month;
            let year = *year;
            let mut d = create_date(year, month, day);
            println!("{}", format!("Date: {:?}", d));
            println!("{}", format!("ISO: {}", format!("{:?}", d)));
            println!("{}", format!("Weekday: {:?}", weekday_name(&d)));
        }
        Some(Commands::Parse { ref value, .. }) => {
            let _cse_temp_4 = value.contains("T");
            let _cse_temp_5 = value.contains(" ");
            let _cse_temp_6 = (_cse_temp_4) || (_cse_temp_5);
            if _cse_temp_6 {
                let mut dt = from_isoformat_datetime(&value);
                println!("{}", format!("Datetime: {:?}", dt));
                println!("{}", format!("Date: {}", dt));
                println!("{}", format!("Time: {}", dt));
            } else {
                let mut d = from_isoformat_date(&value);
                println!("{}", format!("Date: {:?}", d));
                println!("{}", format!("Weekday: {:?}", weekday_name(&d)));
            }
        }
        Some(Commands::Timestamp { ref value, .. }) => {
            let value = *value;
            let mut dt = from_timestamp(value);
            println!("{}", format!("Local: {:?}", dt));
            println!("{}", format!("UTC: {}", from_utc_timestamp(value)));
        }
        Some(Commands::Weekday { ref date, .. }) => {
            let mut d = from_isoformat_date(&date);
            println!(
                "{}",
                format!("Weekday: {}({:?})", weekday(&d), weekday_name(&d))
            );
            println!("{}", format!("ISO weekday: {}", isoweekday(&d)));
        }
        Some(Commands::Leap { ref year, .. }) => {
            let year = *year;
            if is_leap_year(year).unwrap_or(false) {
                println!("{}", format!("{} is a leap year", year));
            } else {
                println!("{}", format!("{} is not a leap year", year));
            }
        }
        Some(Commands::Days {
            ref month,
            ...
            if month {
                ...
                println!(
                    "{}",
                    format!("Days in {:?} {}: {:?}", month_name(month), year, d)
                );
            } else {
                d = days_in_year(year);
                println!("{}", format!("Days in {}: {:?}", year, d));
            }
        }
...
mod tests {
    ...
    #[test]
    fn test_days_in_year_examples() {
        assert_eq!(days_in_year(0), 0);
        assert_eq!(days_in_year(1), 1);
        assert_eq!(days_in_year(-1), -1);
    }
}
