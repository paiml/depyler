...
pub enum DictOrListUnion {
    Dict(std::collections::HashMap<DepylerValue, DepylerValue>),
    List(Vec<DepylerValue>),
}
impl From<std::collections::HashMap<DepylerValue, DepylerValue>> for DictOrListUnion {
    fn from(value: std::collections::HashMap<DepylerValue, DepylerValue>) -> Self {
        DictOrListUnion::Dict(value)
    }
}
impl From<Vec<DepylerValue>> for DictOrListUnion {
    fn from(value: Vec<DepylerValue>) -> Self {
        DictOrListUnion::List(value)
    }
}
impl DictOrListUnion {
    pub fn is_dict(&self) -> bool {
        matches!(self, DictOrListUnion::Dict(_))
    }
    pub fn is_list(&self) -> bool {
        matches!(self, DictOrListUnion::List(_))
    }
    pub fn as_dict(&self) -> Option<&std::collections::HashMap<DepylerValue, DepylerValue>> {
        match self {
            DictOrListUnion::Dict(value) => Some(value),
            _ => None,
        }
    }
    pub fn as_list(&self) -> Option<&Vec<DepylerValue>> {
        match self {
            DictOrListUnion::List(value) => Some(value),
            _ => None,
        }
    }
}
...
pub fn to_json(data: &DictOrListUnion) -> String {
    format!("{:?}", data)
}
#[doc = "Convert data to pretty JSON string."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn to_json_pretty(data: &DictOrListUnion, indent: i32) -> String {
    format!("{:?}", data)
}
#[doc = "Parse JSON string to data."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn from_json(s: &str) -> DictOrListUnion {
    std::collections::HashMap::<String, DepylerValue>::new()
}
#[doc = "Convert to JSON with sorted keys."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn to_json_sorted(data: &std::collections::HashMap<DepylerValue, DepylerValue>) -> String {
    format!("{:?}", data)
}
#[doc = "Convert to compact JSON(no spaces)."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn to_json_compact(data: &DictOrListUnion) -> String {
    format!("{:?}", data)
}
#[doc = "Read JSON from file."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn read_json_file(path: &str) -> Result<DictOrListUnion, std::io::Error> {
...
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn write_json_file<'a, 'b>(
    path: &'a str,
    data: &'b DictOrListUnion,
    indent: Option<i32>,
) -> Result<(), std::io::Error> {
...
#[doc = "Get value from JSON object by key."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
...
#[doc = "Get nested value using path of keys."]
#[doc = " Depyler: verified panic-free"]
pub fn get_nested<'b, 'a>(
    data: &'a std::collections::HashMap<DepylerValue, DepylerValue>,
    keys: &[String],
) -> Result<DepylerValue, Box<dyn std::error::Error>> {
    let mut result: std::collections::HashMap<DepylerValue, DepylerValue> = Default::default();
    result = data;
    for key in keys.iter().cloned() {
        if true {
            result = result.get(&key).cloned();
        } else {
            if (true) && (key.chars().all(|c| c.is_numeric())) {
                let idx = key.parse::<i32>().unwrap_or_default();
                result = if (0 <= idx) && (idx < result.len() as i32) {
                    result
                        .get(idx as usize)
                        .cloned()
...
#[doc = "Set value in JSON object(returns new dict)."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn set_value<'a, 'b>(
    data: &'a std::collections::HashMap<DepylerValue, DepylerValue>,
    key: String,
...
#[doc = "Merge two JSON objects."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn merge_json(
    _d1: std::collections::HashMap<DepylerValue, DepylerValue>,
    _d2: std::collections::HashMap<DepylerValue, DepylerValue>,
) -> HashMap<String, DepylerValue> {
    unimplemented!()
}
#[doc = "Deep merge two JSON objects."]
pub fn deep_merge<'b, 'a>(
    d1: &'a std::collections::HashMap<DepylerValue, DepylerValue>,
    d2: &'b std::collections::HashMap<DepylerValue, DepylerValue>,
        ...
        if ((result.get(&key).is_some()) && (true)) && (true) {
            result.insert(
                ...
                DepylerValue::Str(format!(
                    "{:?}",
                    deep_merge(result.get(&key).cloned().unwrap_or_default(), &value)?
                )),
            );
        } else {
            result.insert(
...
#[doc = "Get all keys from JSON object."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn json_keys(data: &std::collections::HashMap<DepylerValue, DepylerValue>) -> Vec<String> {
    data.keys().cloned().collect::<Vec<_>>()
}
#[doc = "Get all values from JSON object."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn json_values(
    data: &std::collections::HashMap<DepylerValue, DepylerValue>,
) -> Vec<DepylerValue> {
    data.values().cloned().collect::<Vec<_>>()
}
#[doc = "Flatten nested JSON to flat dict with dot notation keys."]
#[doc = " Depyler: verified panic-free"]
pub fn flatten_json<'b, 'a>(
    data: &'a std::collections::HashMap<DepylerValue, DepylerValue>,
    prefix: &'b str,
) -> HashMap<String, DepylerValue> {
        ...
        .collect::<Vec<_>>()
    {
        ...
        if true {
            for (k, v) in (flatten_json(&value, &new_key)).iter() {
            ...
            if true {
                    ...
                    .map(|(i, x)| (i as i32, x))
                {
                    let i = i as i32;
                    if true {
                        for (k, v) in (flatten_json(&item, format!("{}.{:?}", new_key, i))).iter() {
                            result.insert(k.clone(), v.clone());
                        }
                    } else {
                        result.insert(format!("{}.{:?}", new_key, i).to_string(), item);
                    }
                }
            } else {
                result.insert(new_key.to_string().clone(), value);
            }
        }
    }
    result
}
#[doc = "Unflatten dot-notation dict to nested JSON."]
pub fn unflatten_json(
    data: &std::collections::HashMap<String, DepylerValue>,
) -> Result<HashMap<String, DepylerValue>, Box<dyn std::error::Error>> {
    let result: std::collections::HashMap<DepylerValue, DepylerValue> = {
        ...
        .collect::<Vec<_>>()
    {
        ...
        .map(|(i, x)| (i as i32, x))
        {
            ...
            if current.get(&part).is_none() {
                ...
                if next_part.chars().all(|c| c.is_numeric()) {
                    current.insert(
        ...
        if true {
            let idx = final_part.parse::<i32>().unwrap_or_default();
...
#[doc = "Filter JSON object to only include specified keys."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn filter_keys<'a, 'b>(
    data: &'a std::collections::HashMap<DepylerValue, DepylerValue>,
    keys: &'b Vec<String>,
) -> HashMap<String, DepylerValue> {
    data.iter()
...
#[doc = "Exclude specified keys from JSON object."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn exclude_keys<'b, 'a>(
    data: &'a std::collections::HashMap<DepylerValue, DepylerValue>,
    keys: &'b Vec<String>,
) -> HashMap<String, DepylerValue> {
    data.iter()
...
#[doc = "Check if string is valid JSON."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
...
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn json_type(data: &DepylerValue) -> String {
    if data.is_none() {
...
#[doc = "Count total keys in nested JSON."]
#[doc = " Depyler: verified panic-free"]
pub fn count_keys(data: &std::collections::HashMap<DepylerValue, DepylerValue>) -> i32 {
    let mut count: DepylerValue = Default::default();
    let _cse_temp_0 = data.len() as i32;
    count = _cse_temp_0;
    for value in data.values().cloned().collect::<Vec<_>>() {
        if true {
            count = count + count_keys(&value);
        }
    }
    count
}
#[doc = "Find all values for a key in nested JSON."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn find_values<'a, 'b>(data: &'a DictOrListUnion, key: &'b str) -> Vec<DepylerValue> {
    let mut results: Vec<DepylerValue> = vec![];
    if true {
        let _cse_temp_0 = data.contains(&*key);
        if _cse_temp_0 {
        ...
        for value in data.values().cloned().collect::<Vec<_>>() {
            if true {
                results.extend(find_values(&value, key).iter().cloned());
            }
        }
    } else {
        if true {
            for item in data.iter().cloned() {
                if true {
                    results.extend(find_values(&item, key).iter().cloned());
                }
            }
        }
    }
...
#[doc = "Transform all leaf values in JSON."]
#[doc = " Depyler: verified panic-free"]
pub fn transform_values<'b, 'a>(
    data: &'a std::collections::HashMap<DepylerValue, DepylerValue>,
    r#fn: impl Fn(),
) -> HashMap<String, DepylerValue> {
    let mut result = {
        ...
        .collect::<Vec<_>>()
    {
        if true {
            result.insert(
                key.to_string().clone(),
                DepylerValue::Str(format!("{:?}", transform_values(&value, &r#fn))),
            );
        } else {
            if true {
                result.insert(
                    ...
                    DepylerValue::Str(format!(
                        ...
                        value
                            .iter()
                            .cloned()
                            .map(|item| if !true { r#fn(item) } else { item })
                            .collect::<Vec<_>>()
                    )),
                );
            } else {
                result.insert(
                    key.to_string().clone(),
                    DepylerValue::Str(format!("{:?}", r#fn(&value))),
                );
            }
        }
    }
...
pub fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    match &args.command {
        Some(Commands::Parse { ref json, .. }) => {
            let mut data: Option<String> = None;
            match (|| -> Result<(), Box<dyn std::error::Error>> {
                data = Some(from_json(&json));
                println!("{}", to_json_pretty(data, 2i32));
                Ok(())
            })() {
                Ok(()) => {}
                Err(e) => {
        ...
        Some(Commands::Format {
            ...
            match (|| -> Result<(), Box<dyn std::error::Error>> {
                data = Some(from_json(&json));
                println!("{}", to_json_pretty(data, indent));
                Ok(())
            })() {
                Ok(()) => {}
                Err(e) => {
        ...
        Some(Commands::Get {
            ...
            match (|| -> Result<(), Box<dyn std::error::Error>> {
                ...
                parts = path
                    ...
                    .map(|s| s.to_string())
                    .collect::<Vec<String>>();
                value = Some(get_nested(&[data, &parts])?);
                println!("{}", if true { to_json(value) } else { value });
                Ok(())
            })() {
                Ok(()) => {}
                Err(e) => {
        ...
        Some(Commands::Validate { ref json, .. }) => {
        ...
        Some(Commands::Flatten { ref json, .. }) => {
            let mut data: Option<String> = None;
            ...
            match (|| -> Result<i32, Box<dyn std::error::Error>> {
                ...
                if true {
                    ...
                    println!("{}", to_json_pretty(&flat, 2i32));
                } else {
                    println!("{}", "Can only flatten objects".to_string());
                    std::process::exit(1i32)
                }
                Ok(Default::default())
            })() {
...
mod tests {
    ...
    #[test]
    fn quickcheck_to_json_sorted() {
        fn prop(data: ()) -> TestResult {
            let result = to_json_sorted(&data);
            ...
            input_sorted.sort();
            let mut result = to_json_sorted(&data);
            result.sort();
    ...
    #[test]
    fn test_is_valid_json_examples() {
        let _ = is_valid_json(Default::default());
    }
}
