...
pub fn round_nearest(x: f64) -> i32 {
    x.round() as i32
}
#[doc = "Round down to nearest integer.\n\n   >>>round_floor(2.0)\n    2\n   >>>round_floor(2.9)\n    2\n   >>>round_floor(-2.1)\n    -3\n    "]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn round_floor(x: f64) -> i32 {
    (x as f64).floor()
}
#[doc = "Round up to nearest integer.\n\n   >>>round_ceil(2.0)\n    2\n   >>>round_ceil(2.1)\n    3\n   >>>round_ceil(-2.9)\n    -2\n    "]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn round_ceil(x: f64) -> i32 {
    (x as f64).ceil()
}
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn main() {
    ...
    let _cse_temp_0 = matches!(args.command, Some(Commands::Nearest { .. }));
    match &args.command {
        Some(Commands::Nearest { ref x, .. }) => {
            let x = *x;
            println!("{}", round_nearest(x));
        }
        Some(Commands::Floor { ref x, .. }) => {
            let x = *x;
            println!("{}", round_floor(x));
        }
        Some(Commands::Ceil { ref x, .. }) => {
            let x = *x;
            println!("{}", round_ceil(x));
        }
