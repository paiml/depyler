...
#![allow(dead_code)]
#[doc = "// NOTE: Map Python module 'zlib'(tracked in DEPYLER-0424)"]
...
#[doc = "Compress stdin. Depyler: proven to terminate"]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn cmd_compress(level: i32) {
    let data = {
...
#[doc = "Decompress stdin. Depyler: proven to terminate"]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
...
#[doc = "Calculate CRC32. Depyler: proven to terminate"]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn cmd_crc32() {
    let data = {
...
pub fn main() {
    ...
    ({
        ...
        map.insert("compress".to_string().to_string(), cmd_compress);
        map.insert("decompress".to_string().to_string(), cmd_decompress);
        map.insert("crc32".to_string().to_string(), cmd_crc32);
        map
    }
