...
pub fn main() {
    ...
    let _cse_temp_0 = matches!(args.command, Some(Commands::Log3 { .. }));
    match &args.command {
        Some(Commands::Log3 {
            ref a,
            ref b,
        ...
        Some(Commands::Log2 { ref a, ref b, .. }) => {
            let a = *a;
            let b = *b;
