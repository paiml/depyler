...
#[doc = "Create dict of number to its square."]
...
#[doc = "Create dict of number to its cube."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn cubes_dict(n: i32) -> HashMap<i32, i32> {
    (0..(n))
        .into_iter()
        .map(|i| {
            let _v = i * i * i;
...
#[doc = "Dict of even numbers to their squares."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn even_squares(n: i32) -> HashMap<i32, i32> {
    (0..(n))
        .into_iter()
        .filter(|i| {
            let i = i.clone();
...
#[doc = "Dict of odd numbers to their cubes."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn odd_cubes(n: i32) -> HashMap<i32, i32> {
    (0..(n))
        .into_iter()
        .filter(|i| {
            let i = i.clone();
...
#[doc = "Map characters to their ordinal values."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn char_to_ord(text: &str) -> HashMap<String, i32> {
    text.iter()
        .cloned()
        .map(|c| {
            let _v = c.chars().next().unwrap() as i32;
            (c, _v)
        })
        .collect::<std::collections::HashMap<_, _>>()
}
#[doc = "Map unique characters to ordinal values."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn char_to_ord_unique(text: &str) -> HashMap<String, i32> {
    text.into_iter()
...
#[doc = "Map words to their lengths."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn word_to_length(words: &Vec<String>) -> HashMap<String, i32> {
    words
        .iter()
        .cloned()
        .map(|w| {
...
#[doc = "Map words with minimum length."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn word_to_length_filtered(words: &Vec<String>, min_len: i32) -> HashMap<String, i32> {
    words
        .iter()
        .cloned()
        .filter(|w| {
            let w = w.clone();
            w.len() as i32 >= min_len
        })
        .map(|w| {
            let _v = w.len() as i32;
            (w, _v)
...
#[doc = "Map first character to word(last one wins)."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn first_char_to_word(words: &Vec<String>) -> HashMap<String, String> {
    words
        .iter()
        .cloned()
        .filter(|w| {
...
#[doc = "Map index to value."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn index_to_value(items: &Vec<String>) -> HashMap<i32, String> {
    items
        .iter()
        .cloned()
        .enumerate()
...
#[doc = "Map value to index(last occurrence)."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn value_to_index(items: &Vec<String>) -> HashMap<String, i32> {
    items
        .iter()
        .cloned()
        .enumerate()
...
#[doc = "Filter dict by minimum value."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
...
#[doc = "Filter dict by key prefix."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn filter_by_key<'b, 'a>(
...
#[doc = "Transform keys to uppercase."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn transform_keys(d: &std::collections::HashMap<String, i32>) -> HashMap<String, i32> {
    d.iter()
        .map(|(k, v)| (k.clone(), v.clone()))
        .collect::<Vec<_>>()
        .into_iter()
...
#[doc = "Transform values by multiplier."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
...
#[doc = "Transform both keys and values."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn transform_both(d: &std::collections::HashMap<String, i32>) -> HashMap<String, i32> {
    d.iter()
        .map(|(k, v)| (k.clone(), v.clone()))
        .collect::<Vec<_>>()
        .into_iter()
...
#[doc = "Invert dict, grouping keys with same value."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn invert_dict_list(d: &std::collections::HashMap<String, i32>) -> HashMap<i32, Vec<String>> {
    let values = d
        .values()
        .cloned()
        .collect::<Vec<_>>()
...
#[doc = "Merge dicts, summing overlapping keys."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn merge_with_transform<'a, 'b>(
    ...
    all_keys
        ...
        .cloned()
        .map(|k| {
            let _v = d1.get(&k).cloned().unwrap_or(0) + d2.get(&k).cloned().unwrap_or(0);
            (k, _v)
        })
        .collect::<std::collections::HashMap<_, _>>()
}
#[doc = "Create dict from parallel lists."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
...
#[doc = "Create dict from enumeration."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn enumerate_to_dict(items: &Vec<String>) -> HashMap<String, i32> {
    items
        .iter()
        .cloned()
        .enumerate()
...
#[doc = "Dict with conditional values."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn conditional_value(items: &Vec<i32>) -> HashMap<i32, String> {
    items
        .iter()
        .cloned()
        .map(|i| {
...
#[doc = "Extract inner key from nested dict."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn nested_key_extraction<'b, 'a>(
    ...
    d.iter()
        ...
        .filter(|(k, v)| {
            let (k, v) = (k, v).clone();
            v.get(inner_key).is_some()
        })
        .map(|(k, v)| {
            let _v = v.get(inner_key).cloned().unwrap_or_default();
            (k, _v)
        })
        .collect::<std::collections::HashMap<_, _>>()
}
#[doc = "Flatten nested dict with composite keys."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
...
#[doc = "Group words by first character."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
...
#[doc = "Count occurrences of each item."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn count_occurrences(items: &Vec<String>) -> HashMap<String, i32> {
    let unique = items.into_iter().collect::<std::collections::HashSet<_>>();
    unique
        .iter()
        .cloned()
        .map(|item| {
            let _v = items.iter().filter(|x| **x == item).count() as i32;
            (item, _v)
        })
        .collect::<std::collections::HashMap<_, _>>()
}
#[doc = "Create dict from list of pairs."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn dict_from_pairs(pairs: &Vec<(String, i32)>) -> HashMap<String, i32> {
    pairs
        .into_iter()
        .collect::<std::collections::HashMap<_, _>>()
}
#[doc = "Remove None values from dict."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn filter_none_values(
    d: &std::collections::HashMap<String, Option<i32>>,
) -> HashMap<String, i32> {
    d.iter()
        .map(|(k, v)| (k.clone(), v.clone()))
        .collect::<Vec<_>>()
...
#[doc = "Create dict with default values."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn default_dict_like(keys: &Vec<String>, default: i32) -> HashMap<String, i32> {
    keys.iter().map(|k| (k.clone(), default)).collect()
}
#[doc = "Create dict from range with squares."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn range_dict(start: i32, end: i32, step: i32) -> HashMap<i32, i32> {
    {
...
pub fn main() {
    ...
    match &args.command {
        Some(Commands::Squares { ref n, .. }) => {
            let n = *n;
            let mut result = squares_dict(n);
            println!("{:?}", result);
        }
        Some(Commands::CharOrd { ref text, .. }) => {
            let mut result = char_to_ord_unique(&text);
            println!("{:?}", result);
        }
        Some(Commands::WordLen {
            ref min_len,
            ref words,
            ..
        }) => {
            let min_len = min_len.unwrap_or_default();
            let words = words.to_string();
            let mut result = word_to_length_filtered(&words, min_len);
            println!("{:?}", result);
        }
        Some(Commands::Group { ref words, .. }) => {
            let words = words.to_string();
            let mut result = group_by_length(&words);
            println!("{:?}", result);
        }
