...
impl From<bool> for UnionType1 {
    fn from(value: bool) -> Self {
        UnionType1::Boolean(value)
    }
}
...
impl From<Vec<DepylerValue>> for UnionType1 {
    fn from(value: Vec<DepylerValue>) -> Self {
        UnionType1::List(value)
    }
}
...
impl UnionType1 {
    pub fn is_boolean(&self) -> bool {
        matches!(self, UnionType1::Boolean(_))
    }
    ...
    pub fn is_list(&self) -> bool {
        matches!(self, UnionType1::List(_))
    }
    ...
    pub fn as_boolean(&self) -> Option<&bool> {
        match self {
            UnionType1::Boolean(value) => Some(value),
            _ => None,
        }
    }
    ...
    pub fn as_list(&self) -> Option<&Vec<DepylerValue>> {
        match self {
            UnionType1::List(value) => Some(value),
            _ => None,
        }
    }
...
impl From<bool> for UnionType2 {
    fn from(value: bool) -> Self {
        UnionType2::Boolean(value)
    }
}
impl From<std::collections::HashMap<DepylerValue, DepylerValue>> for UnionType2 {
    fn from(value: std::collections::HashMap<DepylerValue, DepylerValue>) -> Self {
        UnionType2::Dict(value)
    }
}
impl From<f64> for UnionType2 {
    fn from(value: f64) -> Self {
        UnionType2::Float(value)
    }
}
impl From<i32> for UnionType2 {
    fn from(value: i32) -> Self {
        UnionType2::Integer(value)
    }
}
impl From<Vec<DepylerValue>> for UnionType2 {
    fn from(value: Vec<DepylerValue>) -> Self {
        UnionType2::List(value)
    }
}
impl From<String> for UnionType2 {
    fn from(value: String) -> Self {
        UnionType2::Text(value)
    }
}
impl UnionType2 {
    pub fn is_boolean(&self) -> bool {
        matches!(self, UnionType2::Boolean(_))
    }
    pub fn is_dict(&self) -> bool {
        matches!(self, UnionType2::Dict(_))
    }
    pub fn is_float(&self) -> bool {
        matches!(self, UnionType2::Float(_))
    }
    pub fn is_integer(&self) -> bool {
        matches!(self, UnionType2::Integer(_))
    }
    pub fn is_list(&self) -> bool {
        matches!(self, UnionType2::List(_))
    }
    pub fn is_none(&self) -> bool {
        matches!(self, UnionType2::None)
    }
    pub fn is_text(&self) -> bool {
        matches!(self, UnionType2::Text(_))
    }
    pub fn as_boolean(&self) -> Option<&bool> {
        match self {
            UnionType2::Boolean(value) => Some(value),
            _ => None,
        }
    }
    pub fn as_dict(&self) -> Option<&std::collections::HashMap<DepylerValue, DepylerValue>> {
        match self {
            UnionType2::Dict(value) => Some(value),
            _ => None,
        }
    }
    pub fn as_float(&self) -> Option<&f64> {
        match self {
            UnionType2::Float(value) => Some(value),
            _ => None,
        }
    }
    pub fn as_integer(&self) -> Option<&i32> {
        match self {
            UnionType2::Integer(value) => Some(value),
            _ => None,
        }
    }
    pub fn as_list(&self) -> Option<&Vec<DepylerValue>> {
        match self {
            UnionType2::List(value) => Some(value),
            _ => None,
        }
    }
    pub fn as_text(&self) -> Option<&String> {
        match self {
            UnionType2::Text(value) => Some(value),
            _ => None,
        }
    }
}
...
struct Args {
    #[doc = "Input TOML file(- for stdin)"]
    input: Option<String>,
    
    
    #[doc = "Get value at path(e.g., database.host)"]
    get: Option<String>,
    
    
    
    #[doc = "List keys at path(empty for root)"]
    keys: Option<String>,
    
    
    #[doc = "Output all key=value pairs"]
    flatten: bool,
    
    
    #[doc = "List top-level sections"]
    sections: bool,
}
#[doc = "Parse a TOML value string into Python type."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn parse_value(mut value: String) -> UnionType1 {
    value = value.trim().to_string();
    let _cse_temp_0 = value == "true";
    if _cse_temp_0 {
        return true;
    }
    let _cse_temp_1 = value == "false";
    if _cse_temp_1 {
        return false;
    }
    let _cse_temp_2 = (value.starts_with("-"))
        && ({
            let base = value;
            let start_idx: i32 = 1;
        ...
        .chars()
        .all(|c| c.is_numeric()));
    let _cse_temp_3 = (value.chars().all(|c| c.is_numeric())) || (_cse_temp_2);
    if _cse_temp_3 {
        return value.parse::<i32>().unwrap_or_default();
    }
    let _cse_temp_4 = value.contains(".");
    if _cse_temp_4 {
    ...
    if _cse_temp_2 {
            ...
            .collect::<Vec<String>>()
        {
            items.push(DepylerValue::Str(format!(
                "{:?}",
                parse_value(item.trim().to_string())
            )));
        }
        return items;
    }
        ...
        .collect::<Vec<String>>()
    {
        ...
        if (line.starts_with("[")) && (line.ends_with("]")) {
            ...
            current_section = header
                ...
                .collect::<Vec<String>>();
            target = result;
            for part in current_section.iter().cloned() {
                ...
                target = target.get(&part).cloned().unwrap_or_default();
            }
            continue;
        }
        if line.contains("=") {
            ...
            target.insert(
                key.to_string().clone(),
                DepylerValue::Str(format!("{:?}", parse_value(&value))),
            );
        }
    }
    Ok(result)
}
#[doc = "Get a nested value using dot notation."]
pub fn get_nested<'a, 'b>(
    data: &'a std::collections::HashMap<DepylerValue, DepylerValue>,
    path: &'b str,
) -> Result<UnionType2, Box<dyn std::error::Error>> {
...
#[doc = "List all keys at a given path."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn list_keys<'a, 'b>(
    data: &'a std::collections::HashMap<DepylerValue, DepylerValue>,
    path: &'b str,
) -> Result<Vec<String>, Box<dyn std::error::Error>> {
    let mut target: std::collections::HashMap<DepylerValue, DepylerValue> = Default::default();
    if !path.is_empty() {
    ...
    Ok(target.keys().cloned().collect::<Vec<_>>())
}
#[doc = "Flatten TOML data into list of(key, value) pairs."]
#[doc = " Depyler: verified panic-free"]
pub fn flatten_toml<'b, 'a>(
    data: &'a std::collections::HashMap<DepylerValue, DepylerValue>,
    prefix: &'b str,
) -> Vec<(String, String)> {
    let mut result = vec![];
        ...
        .collect::<Vec<_>>()
    {
        ...
        if true {
            result.extend(flatten_toml(&value, &full_key).iter().cloned());
        } else {
...
#[doc = "Format a Python value as TOML."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn format_value(value: &UnionType1) -> String {
    if true {
    ...
    if true {
        let items = value
            ...
            .collect::<Vec<_>>();
        return format!("{}{}", format!("{}{}", "[", items.join(", ")), "]");
    }
    (value).to_string()
}
#[doc = " Depyler: proven to terminate"]
pub fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let has_get = args.get.is_some();
    let has_keys = args.keys.is_some();
    ...
    if has_get {
        let value = get_nested(&data, &args.get)?;
        if value.is_null() {
        ...
        if true {
            for (k, v) in value
                ...
                .collect::<Vec<_>>()
            {
                println!("{}", format!("{:?} = {}", k, format_value(&v)));
            }
        } else {
            println!("{:?}", value);
        }
