...
#[doc = "Create empty typed dictionary."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn create_empty_dict() -> HashMap<String, i32> {
    {
        let map: HashMap<String, i32> = HashMap::new();
        map
    }
}
#[doc = "Create dictionary from key-value pairs."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn create_dict(items: &Vec<(String, i32)>) -> HashMap<String, i32> {
    items
        .into_iter()
        .collect::<std::collections::HashMap<_, _>>()
}
#[doc = "Get value by key, return None if not found."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
...
#[doc = "Set value in dictionary(returns new dict)."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn set_value(
...
#[doc = "Remove key from dictionary(returns new dict)."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn remove_key<'a, 'b>(
    d: &'a std::collections::HashMap<String, i32>,
    key: &'b str,
) -> HashMap<String, i32> {
    let mut result = d.clone();
    result.remove(key).unwrap_or(None);
    result
}
#[doc = "Check if key exists in dictionary."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
...
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn get_keys(d: &std::collections::HashMap<String, i32>) -> Vec<String> {
    d.keys().cloned().collect::<Vec<_>>()
}
#[doc = "Get all values."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn get_values(d: &std::collections::HashMap<String, i32>) -> Vec<i32> {
    d.values().cloned().collect::<Vec<_>>()
}
#[doc = "Get all key-value pairs."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn get_items(d: &std::collections::HashMap<String, i32>) -> Vec<(String, i32)> {
    d.iter()
        .map(|(k, v)| (k.clone(), v.clone()))
        .collect::<Vec<_>>()
}
#[doc = "Get dictionary size."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn dict_size(d: &std::collections::HashMap<String, i32>) -> i32 {
    d.len() as i32 as i32
}
#[doc = "Check if dictionary is empty."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn is_empty(d: &std::collections::HashMap<String, i32>) -> bool {
    d.len() as i32 == 0
}
#[doc = "Merge two dictionaries(d2 overrides d1)."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn merge_dicts(
    _d1: std::collections::HashMap<String, i32>,
    _d2: std::collections::HashMap<String, i32>,
) -> HashMap<String, i32> {
    unimplemented!()
}
#[doc = "Update dictionary with new values."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn update_dict<'a, 'b>(
    d: &'a std::collections::HashMap<String, i32>,
    updates: &'b std::collections::HashMap<String, i32>,
) -> HashMap<String, i32> {
    let mut result = d.clone();
...
#[doc = "Pop value from dictionary, return(value, new_dict)."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn pop_value<'a, 'b>(
    d: &'a std::collections::HashMap<String, i32>,
    key: &'b str,
) -> (Option<i32>, std::collections::HashMap<String, i32>) {
    let mut result = d.clone();
    let value = result.remove(key).unwrap_or(None);
    (value, result)
}
#[doc = "Set default value if key doesn't exist."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn setdefault<'b, 'a>(
    d: &'a std::collections::HashMap<String, i32>,
    key: &'b str,
    default: i32,
) -> (i32, std::collections::HashMap<String, i32>) {
    let mut result = d.clone();
    let value = result.entry(key).or_insert(default).clone();
    (value, result)
}
#[doc = "Return empty dictionary."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn clear_dict(_d: std::collections::HashMap<String, i32>) -> HashMap<String, i32> {
    {
        let map: HashMap<String, i32> = HashMap::new();
        map
    }
}
#[doc = "Create shallow copy of dictionary."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn copy_dict(d: &std::collections::HashMap<String, i32>) -> HashMap<String, i32> {
    d.clone()
}
#[doc = "Filter dictionary by minimum value."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
...
#[doc = "Filter dictionary to only include specified keys."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn filter_by_keys<'a, 'b>(
    d: &'a std::collections::HashMap<String, i32>,
    keys: &'b Vec<String>,
) -> HashMap<String, i32> {
    d.iter()
...
#[doc = "Multiply all values by factor."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn map_values(d: &std::collections::HashMap<String, i32>, factor: i32) -> HashMap<String, i32> {
    d.iter()
        .map(|(k, v)| (k.clone(), v.clone()))
        .collect::<Vec<_>>()
        .into_iter()
...
#[doc = "Sum all values in dictionary."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn sum_values(d: &std::collections::HashMap<String, i32>) -> i32 {
    d.values().cloned().sum::<i32>()
}
#[doc = "Get maximum value."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn max_value(d: &std::collections::HashMap<String, i32>) -> Option<i32> {
    if d.is_empty() {
        return None;
    }
    Some(
...
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn min_value(d: &std::collections::HashMap<String, i32>) -> Option<i32> {
    if d.is_empty() {
        return None;
    }
    Some(
...
#[doc = "Get key with maximum value."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn key_with_max_value(d: &std::collections::HashMap<String, i32>) -> Option<String> {
    if d.is_empty() {
        return None;
    }
    Some(*d.iter().max().unwrap())
}
#[doc = "Get key with minimum value."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn key_with_min_value(d: &std::collections::HashMap<String, i32>) -> Option<String> {
    if d.is_empty() {
        return None;
    }
    Some(*d.iter().min().unwrap())
}
#[doc = "Invert dictionary(swap keys and values)."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn invert_dict(d: &std::collections::HashMap<String, i32>) -> HashMap<i32, String> {
    d.iter()
        .map(|(k, v)| (k.clone(), v.clone()))
        .collect::<Vec<_>>()
        .into_iter()
...
#[doc = "Sort dictionary by keys."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn sort_by_key(d: &std::collections::HashMap<String, i32>) -> HashMap<String, i32> {
    {
        let mut sorted_vec = d
            .iter()
            .map(|(k, v)| (k.clone(), v.clone()))
            .collect::<Vec<_>>()
            .iter()
...
#[doc = "Sort dictionary by values."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn sort_by_value(d: &std::collections::HashMap<String, i32>) -> HashMap<String, i32> {
    {
        let mut __sorted_result = d
            .iter()
            .map(|(k, v)| (k.clone(), v.clone()))
            .collect::<Vec<_>>()
            .clone();
        __sorted_result.sort_by_key(|x| {
            x.get(1usize)
                .cloned()
...
#[doc = " Depyler: verified panic-free"]
pub fn count_by_value(d: &std::collections::HashMap<String, i32>) -> HashMap<i32, i32> {
    let mut counts: std::collections::HashMap<i32, i32> = {
        let map: HashMap<i32, i32> = HashMap::new();
        map
    };
    for v in d.values().cloned().collect::<Vec<_>>() {
        counts.insert(v.clone(), counts.get(&v).cloned().unwrap_or(0) + 1);
    }
    counts
}
#[doc = "Group keys by their values."]
#[doc = " Depyler: verified panic-free"]
pub fn group_by_value(d: &std::collections::HashMap<String, i32>) -> HashMap<i32, Vec<String>> {
    ...
    for (k, v) in d
        ...
        .collect::<Vec<_>>()
    {
        if groups.get(&v).is_none() {
            groups.insert(v.clone(), vec![]);
        }
        groups
            .get(&DepylerValue::Int(v as i64))
            .cloned()
            .unwrap_or_default()
            .push(k);
    }
...
#[doc = "Create dictionary from keys with default value."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn from_keys(keys: &Vec<String>, default: i32) -> HashMap<String, i32> {
    keys.iter().map(|k| (k.clone(), default)).collect()
}
#[doc = "Create dictionary from two lists."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn zip_to_dict<'a, 'b>(keys: &'a Vec<String>, values: &'b Vec<i32>) -> HashMap<String, i32> {
    keys.into_iter()
        .zip(values.into_iter())
        .into_iter()
        .collect::<std::collections::HashMap<_, _>>()
}
#[doc = "Get keys in d1 but not in d2."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn difference<'a, 'b>(
    d1: &'a std::collections::HashMap<String, i32>,
    d2: &'b std::collections::HashMap<String, i32>,
) -> HashMap<String, i32> {
    d1.iter()
        .map(|(k, v)| (k.clone(), v.clone()))
        .collect::<Vec<_>>()
...
#[doc = "Get keys in both d1 and d2(values from d1)."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
...
pub fn main() {
    ...
    let parse_dict = move |s: &str| -> std::collections::HashMap<String, i32> {
        let mut result: std::collections::HashMap<String, i32> = {
            let map: HashMap<String, i32> = HashMap::new();
            map
        };
        for item in s.split(",").map(|s| s.to_string()).collect::<Vec<String>>() {
            if item.contains("=") {
                let _split_parts = item
                    .splitn((1 + 1) as usize, "=")
                    .map(|s| s.to_string())
                    .collect::<Vec<String>>();
                ...
                result.insert(
                    k.trim().to_string(),
                    v.trim().to_string().parse::<i32>().unwrap_or_default(),
                );
            }
        }
        return result;
        ...
        Some(Commands::Create { ref items, .. }) => {
            ...
            for item in items {
                if item.contains("=") {
                    ...
                    let k = _split_parts.get(0).cloned().unwrap_or_default();
                    let v = _split_parts.get(1).cloned().unwrap_or_default();
                    items.push(DepylerValue::Str(format!("{:?}", (k, (v) as i32))));
                }
            }
            let d = create_dict(&items);
            println!("{:?}", d);
        }
        Some(Commands::Get {
            ref data, ref key, ..
            ...
            let value = get_value(&d, &key);
            println!("{}", format!("Value: {:?}", value));
        }
        Some(Commands::Stats { ref data, .. }) => {
            let data = data.as_deref().unwrap_or_default();
            let d = parse_dict(data);
            println!("{}", format!("Size: {}", dict_size(&d)));
            println!("{}", format!("Sum: {}", sum_values(&d)));
            println!("{}", format!("Max: {:?}", max_value(&d)));
            println!("{}", format!("Min: {:?}", min_value(&d)));
        }
...
mod tests {
    ...
    #[test]
    fn quickcheck_sort_by_key() {
        fn prop(d: ()) -> TestResult {
            let result = sort_by_key(&d);
            for i in 1..result.len() {
                if result[i - 1] > result[i] {
                    return TestResult::failed();
                }
            }
            let mut input_sorted = d.clone();
            input_sorted.sort();
            let mut result = sort_by_key(&d);
            result.sort();
    ...
    #[test]
    fn quickcheck_sort_by_value() {
        fn prop(d: ()) -> TestResult {
            let result = sort_by_value(&d);
            for i in 1..result.len() {
                if result[i - 1] > result[i] {
                    return TestResult::failed();
                }
            ...
            let mut input_sorted = d.clone();
            input_sorted.sort();
            let mut result = sort_by_value(&d);
            result.sort();
            if input_sorted != result {
                return TestResult::failed();
            }
