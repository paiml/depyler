...
enum Commands {
    ...
    Union {
        #[doc = "First set(comma-separated)"]
        set1: String,
        #[doc = "Second set(comma-separated)"]
        set2: String,
    },
...
#[doc = "Create empty typed set."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn create_empty_set() -> std::collections::HashSet<i32> {
    std::collections::HashSet::<i32>::new()
}
#[doc = "Create set from items."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn create_set(items: &Vec<i32>) -> std::collections::HashSet<i32> {
    items.into_iter().collect::<std::collections::HashSet<_>>()
}
#[doc = "Add item to set(returns new set)."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn add_item(s: &std::collections::HashSet<i32>, item: i32) -> std::collections::HashSet<i32> {
    let mut result = s.clone();
    result.insert(item);
    result
}
#[doc = "Remove item from set(returns new set)."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn remove_item(
...
#[doc = "Pop arbitrary item, return(item, new_set)."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn pop_item(
    s: &std::collections::HashSet<i32>,
) -> (Option<i32>, std::collections::HashSet<i32>) {
    if s.is_empty() {
        return (None, std::collections::HashSet::<i32>::new());
    }
    let mut result = s.clone();
    let item = result
        .iter()
...
#[doc = "Check if set contains item."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn contains(s: &std::collections::HashSet<i32>, item: i32) -> bool {
    s.contains(&item)
}
#[doc = "Get set size."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn set_size(s: &std::collections::HashSet<i32>) -> i32 {
    s.len() as i32 as i32
}
#[doc = "Check if set is empty."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn is_empty(s: &std::collections::HashSet<i32>) -> bool {
    s.len() as i32 == 0
}
#[doc = "Return empty set."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn clear_set(_s: std::collections::HashSet<i32>) -> std::collections::HashSet<i32> {
    std::collections::HashSet::<i32>::new()
}
#[doc = "Copy set."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn copy_set(s: &std::collections::HashSet<i32>) -> std::collections::HashSet<i32> {
    s.clone()
}
...
#[doc = " Depyler: proven to terminate"]
pub fn union<'a, 'b>(
    s1: &'a std::collections::HashSet<i32>,
    s2: &'b std::collections::HashSet<i32>,
) -> std::collections::HashSet<i32> {
    s1.union(&s2)
        .cloned()
...
#[doc = "Difference of two sets(s1 - s2)."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
...
#[doc = "Symmetric difference of two sets."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn symmetric_difference<'b, 'a>(
    s1: &'a std::collections::HashSet<i32>,
    s2: &'b std::collections::HashSet<i32>,
) -> std::collections::HashSet<i32> {
...
#[doc = "Check if s1 is superset of s2."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn is_superset<'b, 'a>(
    s1: &'a std::collections::HashSet<i32>,
    s2: &'b std::collections::HashSet<i32>,
) -> bool {
    s1 >= s2
...
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn is_proper_subset<'a, 'b>(
    s1: &'a std::collections::HashSet<i32>,
    s2: &'b std::collections::HashSet<i32>,
) -> bool {
    s1 < s2
}
#[doc = "Check if s1 is proper superset of s2."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn is_proper_superset<'a, 'b>(
    s1: &'a std::collections::HashSet<i32>,
    s2: &'b std::collections::HashSet<i32>,
) -> bool {
    s1 > s2
}
#[doc = "Check if sets have no common elements."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn is_disjoint<'a, 'b>(
    s1: &'a std::collections::HashSet<i32>,
    s2: &'b std::collections::HashSet<i32>,
) -> bool {
    s1.is_disjoint(&s2)
...
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn to_list(s: &std::collections::HashSet<i32>) -> Vec<i32> {
    {
        let mut sorted_vec = s.iter().cloned().collect::<Vec<_>>();
        sorted_vec.sort_by(|a, b| a.partial_cmp(b).unwrap_or(std::cmp::Ordering::Equal));
        sorted_vec
    }
}
#[doc = "Convert to frozenset."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn to_frozenset(s: &std::collections::HashSet<i32>) -> frozenset<i32> {
    std::sync::Arc::new(s.into_iter().collect::<std::collections::HashSet<_>>())
}
#[doc = "Create set from range."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn from_range(start: i32, end: i32) -> std::collections::HashSet<i32> {
    (start)..(end).into_iter().collect::<std::collections::HashSet<_>>()
}
...
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn filter_even(s: &std::collections::HashSet<i32>) -> std::collections::HashSet<i32> {
    s.iter()
        .cloned()
        .filter(|x| {
            let x = x.clone();
...
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn filter_odd(s: &std::collections::HashSet<i32>) -> std::collections::HashSet<i32> {
    s.iter()
        .cloned()
        .filter(|x| {
            let x = x.clone();
...
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn map_double(s: &std::collections::HashSet<i32>) -> std::collections::HashSet<i32> {
    s.iter()
        .cloned()
        .map(|x| x * 2)
        .collect::<std::collections::HashSet<_>>()
...
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn map_square(s: &std::collections::HashSet<i32>) -> std::collections::HashSet<i32> {
    s.iter()
        .cloned()
        .map(|x| x * x)
        .collect::<std::collections::HashSet<_>>()
...
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn sum_set(s: &std::collections::HashSet<i32>) -> i32 {
    s.iter().sum::<i32>()
}
#[doc = "Maximum value."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn max_set(s: &std::collections::HashSet<i32>) -> Option<i32> {
    if !s.is_empty() {
        Some(*s.iter().max().unwrap())
    } else {
        None
    }
}
...
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn min_set(s: &std::collections::HashSet<i32>) -> Option<i32> {
    if !s.is_empty() {
...
#[doc = "Generate power set(all subsets)."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn power_set(s: &std::collections::HashSet<i32>) -> Vec<std::collections::HashSet<i32>> {
    let items = s.into_iter().collect::<Vec<_>>();
    let _cse_temp_0 = items.len() as i32;
    let n = _cse_temp_0;
    let mut result: Vec<std::collections::HashSet<i32>> = vec![];
    for i in 0..({
        if n >= 0 && (n as i64) <= (u32::MAX as i64) {
            ({ 2 } as i32)
                .checked_pow({ n } as u32)
                .expect("Power operation overflowed")
        } else {
            ({ 2 } as f64).powf({ n } as f64) as i32
        }
    }) {
        let mut subset: std::collections::HashSet<i32> = std::collections::HashSet::<i32>::new();
        for j in 0..(n) {
            if i & 1 << j {
                subset.insert(
                    items
...
#[doc = "Partition set into(<pivot,>= pivot)."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn partition(
    s: &std::collections::HashSet<i32>,
...
#[doc = "Check if sets have any common elements."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
...
#[doc = "Calculate Jaccard similarity coefficient."]
#[doc = " Depyler: proven to terminate"]
pub fn jaccard_similarity<'b, 'a>(
    s1: &'a std::collections::HashSet<i32>,
    s2: &'b std::collections::HashSet<i32>,
) -> Result<f64, Box<dyn std::error::Error>> {
    let _cse_temp_0 = (s1.is_empty()) && (s2.is_empty());
    if _cse_temp_0 {
        return Ok(1.0);
    }
    let _cse_temp_1 = s1
        ...
        .cloned()
        .collect::<std::collections::HashSet<_>>();
    let _cse_temp_2 = _cse_temp_1.len() as i32;
    let intersection_size = _cse_temp_2;
    let _cse_temp_3 = s1
        .union(&s2)
        .cloned()
        .collect::<std::collections::HashSet<_>>();
    let _cse_temp_4 = _cse_temp_3.len() as i32;
    let union_size = _cse_temp_4;
...
pub fn main() {
    ...
    match &args.command {
        ...
        Some(Commands::Union {
            ...
            let s1 = parse_set(set1);
            let s2 = parse_set(set2);
...
mod tests {
    ...
    #[test]
    fn quickcheck_union() {
        fn prop(s1: (), s2: ()) -> TestResult {
            let result1 = union(s1.clone(), s2.clone());
            let result2 = union(s2.clone(), s1.clone());
            if result1 != result2 {
    ...
    #[test]
    fn quickcheck_intersection() {
        fn prop(s1: (), s2: ()) -> TestResult {
            let result1 = intersection(s1.clone(), s2.clone());
            let result2 = intersection(s2.clone(), s1.clone());
            if result1 != result2 {
                return TestResult::failed();
            }
            TestResult::passed()
    ...
    #[test]
    fn quickcheck_symmetric_difference() {
        fn prop(s1: (), s2: ()) -> TestResult {
            let result1 = symmetric_difference(s1.clone(), s2.clone());
            let result2 = symmetric_difference(s2.clone(), s1.clone());
            if result1 != result2 {
                return TestResult::failed();
            }
            TestResult::passed()
