...
#[doc = "Format string with positional arguments."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn format_basic<'a, 'b>(template: &'a str, args: &[String]) -> String {
    template.replacen("{}", &format!("{}", args), 1)
}
#[doc = "Format string with named arguments."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn format_named(template: &str) -> String {
    template
}
#[doc = "Format string with dictionary."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn format_dict(template: &str, _data: std::collections::HashMap<String, String>) -> String {
    template
}
#[doc = "Demonstrate f-string style formatting."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn f_string_style(name: String, value: i32) -> String {
    format!("Name: {}, Value: {}", name, value)
}
#[doc = "Old-style % formatting."]
#[doc = " Depyler: proven to terminate"]
pub fn percent_format<'b, 'a>(
    template: &'a str,
    args: &[String],
) -> Result<String, Box<dyn std::error::Error>> {
    Ok(template % args)
}
#[doc = "Format number with decimal places."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn format_number(n: f64, _decimals: i32) -> String {
    format!("{}", n)
}
#[doc = "Format number as currency."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn format_currency(amount: f64, symbol: String) -> String {
    format!("{}{}", symbol, amount)
}
#[doc = "Format number as percentage."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn format_percent(value: f64) -> String {
    format!("{}", value)
}
#[doc = "Format number in scientific notation."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn format_scientific(n: f64) -> String {
    format!("{}", n)
}
#[doc = "Format integer as binary."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn format_binary(n: i32) -> String {
    format!("{}", n)
}
#[doc = "Format integer as hexadecimal."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn format_hex(n: i32) -> String {
    format!("{}", n)
}
#[doc = "Format integer as octal."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn format_octal(n: i32) -> String {
    format!("{}", n)
}
#[doc = "Pad string on left to width."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn pad_left<'b, 'a>(s: &'a str, width: i32, char: &'b str) -> String {
    {
        let s = s;
...
#[doc = "Pad string on right to width."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn pad_right<'b, 'a>(s: &'a str, width: i32, char: &'b str) -> String {
    {
        let s = s;
        let width = width as usize;
        let fillchar = char;
...
#[doc = "Center string to width."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn pad_center<'b, 'a>(s: &'a str, width: i32, char: &'b str) -> String {
    {
        let s = s;
        let width = width as usize;
        let fillchar = char;
...
#[doc = "Pad string with zeros on left."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn zfill(s: &str, width: i32) -> String {
    {
        let s = s;
        let width = width as usize;
        if s.len() >= width {
...
#[doc = "Truncate string to max length with suffix."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn truncate(s: String, max_len: i32, suffix: &str) -> String {
    let _cse_temp_0 = s.len() as i32;
    let _cse_temp_1 = _cse_temp_0 <= max_len;
    if _cse_temp_1 {
        return s.to_string();
    }
    format!(
        ...
        {
            let base = s;
            let stop_idx: i32 = max_len - suffix.len() as i32;
...
#[doc = " Depyler: verified panic-free"]
pub fn wrap_text(s: &str, width: i32) -> String {
    let mut current_line: Vec<String> = Default::default();
    let words = s
        .split_whitespace()
        .map(|s| s.to_string())
        .collect::<Vec<String>>();
    ...
    for word in words.iter().cloned() {
        if current_len + word.len() as i32 + current_line.len() as i32 <= width {
            current_line.push(word);
            current_len = current_len + word.len() as i32;
        } else {
            if !current_line.is_empty() {
                lines.push(current_line.join(" "));
            }
            current_line = vec![word];
            current_len = word.len() as i32;
        }
    }
    if !current_line.is_empty() {
        lines.push(current_line.join(" "));
...
#[doc = "Format list with separators."]
#[doc = " Depyler: proven to terminate"]
pub fn format_list<'a, 'b, 'c>(
    items: &'a Vec<String>,
    separator: &'b str,
    last_separator: &'c str,
) -> Result<String, Box<dyn std::error::Error>> {
    if items.is_empty() {
        return Ok("".to_string());
    }
...
#[doc = "Format data as ASCII table."]
#[doc = " Depyler: verified panic-free"]
pub fn format_table<'a, 'b>(
    rows: &'a Vec<Vec<String>>,
    headers: &'b Option<Vec<String>>,
) -> String {
    if rows.is_empty() {
        return "".to_string();
    }
    let format_row = move |row: &Vec<String>| -> String {
        return format!(
            "{}{}",
            format!(
                "{}{}",
    ...
    let lines = vec![separator()];
    if let Some(ref headers_val) = headers {
        lines.push(format_row(headers_val));
...
#[doc = "Format dictionary as key-value pairs."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn format_key_value(
    ...
    let max_key_len = if !data.is_empty() {
        data.keys()
            .cloned()
            .collect::<Vec<_>>()
            .into_iter()
    ...
    let lines = data
        ...
        .map(|(k, v)| {
            format!(
                ...
                {
                    let s = k;
                    let width = max_key_len as usize;
                    let fillchar = " ";
                    if s.len() >= width {
                        s.to_string()
                    } else {
...
#[doc = "Format byte count as human-readable."]
#[doc = " Depyler: proven to terminate"]
pub fn format_bytes(mut n: i32) -> Result<String, Box<dyn std::error::Error>> {
    for unit in vec![
        "B".to_string(),
        "KB".to_string(),
        "MB".to_string(),
...
#[doc = "Format seconds as duration string."]
#[doc = " Depyler: proven to terminate"]
pub fn format_duration(seconds: i32) -> Result<String, Box<dyn std::error::Error>> {
    let _cse_temp_0 = seconds < 60;
    if _cse_temp_0 {
...
#[doc = "Format number with ordinal suffix."]
#[doc = " Depyler: proven to terminate"]
pub fn format_ordinal(n: i32) -> Result<String, Box<dyn std::error::Error>> {
    let _cse_temp_0 = n % 100;
    let _cse_temp_1 = 11 <= _cse_temp_0;
    let _cse_temp_2 = _cse_temp_0 <= 13;
    let _cse_temp_3 = (_cse_temp_1) && (_cse_temp_2);
    let mut suffix: String;
    if _cse_temp_3 {
        suffix = "th".to_string();
    } else {
        let _cse_temp_4 = n % 10;
        let _cse_temp_5 = _cse_temp_4 == 1;
        if _cse_temp_5 {
            suffix = "st".to_string();
        } else {
            let _cse_temp_6 = _cse_temp_4 == 2;
            if _cse_temp_6 {
                suffix = "nd".to_string();
            } else {
                let _cse_temp_7 = _cse_temp_4 == 3;
                if _cse_temp_7 {
                    suffix = "rd".to_string();
                } else {
                    suffix = "th".to_string();
...
#[doc = "Format count with appropriate plural form."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn format_plural<'b, 'a>(n: i32, singular: &'a str, plural: &'b mut Option<String>) -> String {
    if plural.is_none() {
        plural = format!("{}{}", singular, "s".to_string());
    }
    format!("{} {}", n, if n == 1 { singular } else { plural })
}
#[doc = "Replace template placeholders."]
#[doc = " Depyler: verified panic-free"]
pub fn template_replace<'b, 'a>(
    template: &'a str,
    replacements: &'b std::collections::HashMap<String, String>,
    prefix: String,
    suffix: String,
) -> String {
    ...
    for (key, value) in replacements
        ...
        .collect::<Vec<_>>()
    {
        result = result.replace(&format!("{}{:?}{}", prefix, key, suffix), &value);
    }
    result.to_string()
}
#[doc = "Quote string."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn quote(s: String, char: String) -> String {
    format!("{}{}{}", char, s, char)
}
#[doc = "Remove surrounding quotes."]
#[doc = " Depyler: proven to terminate"]
pub fn unquote(s: String) -> Result<String, Box<dyn std::error::Error>> {
    let _cse_temp_0 = s.len() as i32;
...
pub fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    match &args.command {
        Some(Commands::Format {
            ...
            let result = format_basic(&[&template, &args]);
            println!("{}", result);
        }
        Some(Commands::Number {
            ref currency,
            ref decimals,
            ref percent,
            ref value,
            ...
            let decimals = decimals.clone();
            let percent = *percent;
            let value = *value;
            if currency {
                println!("{}", format_currency(value, "$".to_string()));
            } else {
                if percent {
                    println!("{}", format_percent(value));
                } else {
                    println!("{}", format_number(value, decimals));
                }
            }
        }
        Some(Commands::Pad {
            ...
            let char = char.as_deref().unwrap_or_default();
            let side = side.as_deref().unwrap_or_default();
            let width = *width;
            let _cse_temp_3 = side == "left";
            if _cse_temp_3 {
                println!("{}", pad_left(&text, width, &char));
            } else {
                let _cse_temp_4 = side == "right";
                if _cse_temp_4 {
                    println!("{}", pad_right(&text, width, &char));
                } else {
                    println!("{}", pad_center(&text, width, &char));
                }
            }
        }
        Some(Commands::Bytes { ref value, .. }) => {
            let value = *value;
            println!("{:?}", format_bytes(value));
        }
        Some(Commands::Duration { ref seconds, .. }) => {
            let seconds = *seconds;
