...
#[doc = "Find minimum of five integers.\n\n   >>>find_min (1, 2, 3, 4, 5)\n    1\n   >>>find_min (5, 4, 3, 2, 1)\n    1\n   >>>find_min (3, 1, 4, 1, 5)\n    1\n    "]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn find_min(a: i32, b: i32, c: i32, d: i32, e: i32) -> i32 {
    let mut result: i32 = Default::default();
    result = a;
    let _cse_temp_0 = b < result;
    if _cse_temp_0 {
        result = b;
    }
    let _cse_temp_1 = c < result;
    if _cse_temp_1 {
        result = c;
    }
    let _cse_temp_2 = d < result;
    if _cse_temp_2 {
        result = d;
    }
    let _cse_temp_3 = e < result;
    if _cse_temp_3 {
        result = e;
    }
    result
}
#[doc = "Find maximum of five integers.\n\n   >>>find_max(1, 2, 3, 4, 5)\n    5\n   >>>find_max(5, 4, 3, 2, 1)\n    5\n   >>>find_max(3, 1, 4, 1, 5)\n    5\n    "]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn find_max(a: i32, b: i32, c: i32, d: i32, e: i32) -> i32 {
    let mut result: i32 = Default::default();
    result = a;
    let _cse_temp_0 = b > result;
    if _cse_temp_0 {
...
#[doc = "Clamp value to range [lo, hi].\n\n   >>>clamp(5, 0, 10)\n    5\n   >>>clamp(-5, 0, 10)\n    0\n   >>>clamp(15, 0, 10)\n    10\n    "]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn clamp(val: i32, lo: i32, hi: i32) -> i32 {
    let mut result: i32 = Default::default();
    result = val;
    let _cse_temp_0 = result < lo;
    if _cse_temp_0 {
        result = lo;
    }
    let _cse_temp_1 = result > hi;
    if _cse_temp_1 {
        result = hi;
    }
    result
...
pub fn main() {
    ...
    let _cse_temp_0 = matches!(args.command, Some(Commands::Min { .. }));
    match &args.command {
        Some(Commands::Min {
            ref a,
            ref b,
