...
#[doc = "Create empty tuple."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn create_empty_tuple() -> () {
    ()
}
#[doc = "Create pair tuple."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn create_pair(a: i32, b: i32) -> (i32, i32) {
    (a, b)
}
#[doc = "Create triple tuple."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn create_triple(a: i32, b: i32, c: i32) -> (i32, i32, i32) {
    (a, b, c)
}
#[doc = "Create tuple from items."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn create_tuple(items: &[String]) -> () {
    items.into_iter().collect::<Vec<_>>()
}
#[doc = "Create tuple from list."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn from_list(items: &Vec<i32>) -> () {
    items.into_iter().collect::<Vec<_>>()
}
#[doc = "Convert tuple to list."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn to_list(t: &(i32, DepylerValue)) -> Vec<i32> {
    t.into_iter().collect::<Vec<_>>()
}
#[doc = "Get first element."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn get_first(t: &(i32, DepylerValue)) -> Result<Option<i32>, Box<dyn std::error::Error>> {
    Ok(if t { Some(t.0) } else { None })
}
#[doc = "Get second element."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn get_second(t: &(i32, i32, DepylerValue)) -> Result<Option<i32>, Box<dyn std::error::Error>> {
    Ok(if t.len() as i32 > 1 { Some(t.1) } else { None })
}
#[doc = "Get last element."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn get_last(t: &(i32, DepylerValue)) -> Result<Option<i32>, Box<dyn std::error::Error>> {
    Ok(if t {
        Some([t.0, t.1][-1 as usize])
    } else {
        None
    })
}
...
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn tuple_size(t: &(i32, DepylerValue)) -> i32 {
    t.len() as i32 as i32
}
#[doc = "Check if tuple is empty."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn is_empty(t: &(i32, DepylerValue)) -> bool {
    t.len() as i32 == 0
}
#[doc = "Check if tuple contains item."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn contains(t: &(i32, DepylerValue), item: i32) -> bool {
    t.get(&item).is_some()
}
#[doc = "Get index of item, -1 if not found."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn index_of(t: &(i32, DepylerValue), item: i32) -> i32 {
    {
        return t
            .iter()
            .position(|x| x == &item)
...
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn count_item(t: &(i32, DepylerValue), item: i32) -> i32 {
    t.iter().filter(|x| **x == item).count() as i32 as i32
}
#[doc = "Slice tuple from start to end."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn slice_tuple(t: &(i32, DepylerValue), start: i32, end: i32) -> (i32, DepylerValue) {
    {
        let base = &t;
...
#[doc = " Depyler: proven to terminate"]
pub fn concat<'b, 'a>(
    t1: &'a (i32, DepylerValue),
    t2: &'b (i32, DepylerValue),
) -> (i32, DepylerValue) {
    t1 + t2
}
...
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn repeat(t: &(i32, DepylerValue), n: i32) -> (i32, DepylerValue) {
    t * n
}
#[doc = "Reverse tuple."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn reverse_tuple(t: &(i32, DepylerValue)) -> (i32, DepylerValue) {
    {
        let base = t;
        let step: i32 = -1;
        if step == 1 {
...
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn sort_tuple(t: &(i32, DepylerValue)) -> () {
    {
        let mut sorted_vec = t.iter().cloned().collect::<Vec<_>>();
...
#[doc = "Sort tuple descending."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn sort_desc(t: &(i32, DepylerValue)) -> () {
    {
        let mut __sorted_result = t.clone();
...
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn min_tuple(t: &(i32, DepylerValue)) -> Option<i32> {
    if t {
        Some(*t.iter().min().unwrap())
    } else {
        None
    }
}
...
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn max_tuple(t: &(i32, DepylerValue)) -> Option<i32> {
    if t {
        Some(*t.iter().max().unwrap())
    } else {
        None
    }
}
...
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn sum_tuple(t: &(i32, DepylerValue)) -> i32 {
    t.iter().sum::<i32>()
}
#[doc = "Product of all values."]
#[doc = " Depyler: verified panic-free"]
pub fn product_tuple(t: &(i32, DepylerValue)) -> i32 {
    let mut result: i32 = Default::default();
    result = 1;
    for x in t.iter().cloned() {
        result = result * x;
    }
    result
}
...
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn mean_tuple(t: &(i32, DepylerValue)) -> Result<Option<f64>, Box<dyn std::error::Error>> {
    Ok(if t {
        Some(((t.iter().sum::<i32>()) as f64) / ((t.len() as i32) as f64))
    } else {
        None
    })
}
...
#[doc = " Depyler: verified panic-free"]
pub fn unique_tuple(t: &(i32, DepylerValue)) -> () {
...
#[doc = "Filter values greater than threshold."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn filter_gt(t: &(i32, DepylerValue), threshold: i32) -> () {
    t.iter()
        .cloned()
...
#[doc = "Filter even values."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn filter_even(t: &(i32, DepylerValue)) -> () {
    t.iter()
        .cloned()
        .filter(|&x| x % 2 == 0)
        .map(|x| x)
...
#[doc = "Filter odd values."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn filter_odd(t: &(i32, DepylerValue)) -> () {
    t.iter()
        .cloned()
        .filter(|&x| x % 2 != 0)
        .map(|x| x)
...
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn map_double(t: &(i32, DepylerValue)) -> () {
    t.iter()
        .cloned()
        .map(|x| x * 2)
        .into_iter()
...
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn map_square(t: &(i32, DepylerValue)) -> () {
    t.iter()
        .cloned()
        .map(|x| x * x)
        .into_iter()
...
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn zip_tuples<'a, 'b>(t1: &'a (i32, DepylerValue), t2: &'b (i32, DepylerValue)) -> () {
    t1.iter().zip(t2.iter()).into_iter().collect::<Vec<_>>()
}
#[doc = "Enumerate tuple."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn enumerate_tuple(t: &(i32, DepylerValue)) -> () {
    t.iter()
        .cloned()
        .enumerate()
        .map(|(i, x)| (i as i32, x))
...
#[doc = "Unpack pair tuple."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn unpack_pair(t: (i32, i32)) -> (i32, i32) {
    (t.0, t.1)
}
#[doc = "Swap pair elements."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn swap_pair(t: (i32, i32)) -> (i32, i32) {
    (t.1, t.0)
}
#[doc = "Compare tuples lexicographically(-1, 0, 1)."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn compare_tuples<'b, 'a>(t1: &'a (i32, DepylerValue), t2: &'b (i32, DepylerValue)) -> i32 {
    let _cse_temp_0 = t1 < t2;
    if _cse_temp_0 {
        return -1;
    } else {
        let _cse_temp_1 = t1 > t2;
        if _cse_temp_1 {
            return 1;
        }
    }
...
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn take(t: &(i32, DepylerValue), n: i32) -> (i32, DepylerValue) {
    {
        let base = &t;
...
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn drop(t: &(i32, DepylerValue), n: i32) -> (i32, DepylerValue) {
    {
        let base = &t;
...
#[doc = "Take while elements are positive."]
#[doc = " Depyler: verified panic-free"]
pub fn take_while_positive(t: &(i32, DepylerValue)) -> () {
    let mut result: Vec<i32> = vec![];
    for x in t.iter().cloned() {
        if x <= 0 {
            break;
...
#[doc = "Split tuple at index."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn split_at(t: &(i32, DepylerValue), index: i32) -> ((i32, DepylerValue), (i32, DepylerValue)) {
    (
        {
            let base = &t;
...
#[doc = "Partition into(<pivot,>= pivot)."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn partition(
    t: &(i32, DepylerValue),
    pivot: i32,
) -> ((i32, DepylerValue), (i32, DepylerValue)) {
    let less = t
        .iter()
        .cloned()
        .filter(|&x| x < pivot)
...
pub fn main() {
    ...
    let parse_tuple = move |s: &str| -> (i32, ()) {
        return s
            .split(",")
            .map(|s| s.to_string())
            .collect::<Vec<String>>()
            .into_iter()
            .filter(|&x| x.trim().to_string())
    ...
    match &args.command {
        Some(Commands::Create { ref items, .. }) => {
            ...
            let t = create_tuple(&&items);
            println!("{}", t);
        }
        Some(Commands::Pair { ref a, ref b, .. }) => {
            let a = *a;
            let b = *b;
            let t = create_pair(a, b);
            println!("{}", t);
        }
        Some(Commands::Stats { ref tuple, .. }) => {
            let t = parse_tuple(tuple);
            println!("{}", format!("Size: {}", tuple_size(t)));
            println!("{}", format!("Sum: {}", sum_tuple(t)));
            println!("{}", format!("Max: {:?}", max_tuple(t)));
            println!("{}", format!("Min: {:?}", min_tuple(t)));
            println!("{}", format!("Mean: {:?}", mean_tuple(t)));
        }
...
mod tests {
    ...
    fn quickcheck_concat() {
        fn prop(t1: (), t2: ()) -> TestResult {
            let result1 = concat(t1.clone(), t2.clone());
            let result2 = concat(t2.clone(), t1.clone());
            if result1 != result2 {
    ...
    fn quickcheck_repeat() {
        fn prop(t: (), n: i32) -> TestResult {
            let result1 = repeat(t.clone(), n.clone());
            let result2 = repeat(n.clone(), t.clone());
            if result1 != result2 {
                return TestResult::failed();
            }
            TestResult::passed()
    ...
    #[test]
    fn quickcheck_sort_tuple() {
        fn prop(t: ()) -> TestResult {
            let result = sort_tuple(t.clone());
            for i in 1..result.len() {
                if result[i - 1] > result[i] {
                    return TestResult::failed();
                }
            }
            let mut input_sorted = t.clone();
            input_sorted.sort();
            let mut result = sort_tuple(t.clone());
            result.sort();
    ...
    fn quickcheck_sort_desc() {
        fn prop(t: ()) -> TestResult {
            ...
            let mut input_sorted = t.clone();
            input_sorted.sort();
            let mut result = sort_desc(t.clone());
            result.sort();
            if input_sorted != result {
                return TestResult::failed();
            }
