...
struct Args {
    ...
    #[doc = "Command to execute(start, stop, or restart)"]
    command: String,
    #[doc = "Targets to apply command to(default: all)"]
    targets: Vec<String>,
...
pub fn main() {
    ...
    println!("{}", format!("Command: {}", args.command));
    println!("{}", format!("Targets: {:?}", args.targets));
}
