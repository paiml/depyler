...
enum Commands {
    #[default]
    __DepylerNone,
    Group { action: String, name: String },
    User { action: String, name: String },
}
#[derive(Default)]
...
pub fn main() {
    ...
    let _cse_temp_0 = matches!(args.command, Some(Commands::User { .. }));
    match &args.command {
        Some(Commands::User {
            ref action,
            ref name,
            ...
            let _cse_temp_1 = action == "add";
            if _cse_temp_1 {
                println!("{}", format!("Added user: {}", name));
            } else {
                let _cse_temp_2 = action == "remove";
                if _cse_temp_2 {
                    println!("{}", format!("Removed user: {}", name));
                }
            }
        }
        Some(Commands::Group {
            ...
            let name = name.to_string();
            let _cse_temp_4 = action == "create";
            if _cse_temp_4 {
                println!("{}", format!("Created group: {}", name));
            } else {
                let _cse_temp_5 = action == "delete";
                if _cse_temp_5 {
                    println!("{}", format!("Deleted group: {}", name));
                }
            }
        }
