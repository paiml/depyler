...
pub fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let _cse_temp_0 = matches!(args.command, Some(Commands::Gcd { .. }));
    match &args.command {
        ...
        Some(Commands::Simplify {
            ...
            let num = *num;
            let mut g = {
                let mut a = (num as i64).abs();
                let mut b = (den as i64).abs();
                while b != 0 {
                    let temp = b;
                    b = a % b;
                    a = temp;
