...
enum Commands {
    ...
    Count { n: i32 },
    Choice { a: String, b: String, c: String },
}
#[derive(Default)]
...
pub fn main() {
    ...
    let _cse_temp_0 = matches!(args.command, Some(Commands::Randint { .. }));
    match &args.command {
        Some(Commands::Randint {
            ref high, ref low, ..
        }) => {
            let high = *high;
            let low = *low;
