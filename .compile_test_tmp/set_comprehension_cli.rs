...
#[doc = "Get unique squares of items."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn unique_squares(items: &Vec<i32>) -> std::collections::HashSet<i32> {
    items
        .as_slice()
        .iter()
        .cloned()
...
#[doc = "Get unique lengths of words."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn unique_lengths(words: &Vec<String>) -> std::collections::HashSet<i32> {
    words
        .iter()
        .cloned()
        .map(|w| w.len() as i32)
...
#[doc = "Get unique first characters."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn unique_first_chars(words: &Vec<String>) -> std::collections::HashSet<String> {
    words
        .iter()
        .cloned()
        .filter(|w| {
...
#[doc = "Get unique last characters."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn unique_last_chars(words: &Vec<String>) -> std::collections::HashSet<String> {
    words
        .iter()
        .cloned()
        .filter(|w| {
...
#[doc = "Get unique even numbers."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn even_numbers(items: &Vec<i32>) -> std::collections::HashSet<i32> {
    items
        .as_slice()
        .iter()
        .cloned()
...
#[doc = "Get unique odd numbers."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn odd_numbers(items: &Vec<i32>) -> std::collections::HashSet<i32> {
    items
        .as_slice()
        .iter()
        .cloned()
...
#[doc = "Get unique positive numbers."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn positive_numbers(items: &Vec<i32>) -> std::collections::HashSet<i32> {
    items
        .as_slice()
        .iter()
        .cloned()
...
#[doc = "Get unique negative numbers."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn negative_numbers(items: &Vec<i32>) -> std::collections::HashSet<i32> {
    items
        .as_slice()
        .iter()
        .cloned()
...
#[doc = "Get numbers divisible by divisor."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn divisible_by(items: &Vec<i32>, divisor: i32) -> std::collections::HashSet<i32> {
    items
        .as_slice()
        .iter()
        .cloned()
...
#[doc = "Get numbers in range."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn in_range(items: &Vec<i32>, min_val: i32, max_val: i32) -> std::collections::HashSet<i32> {
    items
        .as_slice()
        .iter()
        .cloned()
...
#[doc = "Get unique vowels in text."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn vowels_in_text(text: &str) -> std::collections::HashSet<String> {
    text.to_lowercase()
        .into_iter()
        .filter(|c| {
            let c = c.clone();
            "aeiou".to_string().contains(&*c)
        })
        .map(|c| c)
        .collect::<std::collections::HashSet<_>>()
}
#[doc = "Get unique consonants in text."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn consonants_in_text(text: &str) -> std::collections::HashSet<String> {
    text.to_lowercase()
        .into_iter()
        .filter(|c| {
            let c = c.clone();
            (c.chars().all(|c| c.is_alphabetic())) && (!"aeiou".to_string().contains(&*c))
        })
        .map(|c| c)
        .collect::<std::collections::HashSet<_>>()
}
#[doc = "Get unique digits in text."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn digits_in_text(text: &str) -> std::collections::HashSet<String> {
    text.iter()
        .cloned()
        .filter(|c| {
            let c = c.clone();
...
#[doc = "Get unique uppercase characters."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn uppercase_chars(text: &str) -> std::collections::HashSet<String> {
    text.iter()
        .cloned()
        .filter(|c| {
            let c = c.clone();
            c.chars().all(|c| !c.is_alphabetic() || c.is_uppercase())
        })
        .map(|c| c)
        .collect::<std::collections::HashSet<_>>()
}
#[doc = "Get unique lowercase characters."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn lowercase_chars(text: &str) -> std::collections::HashSet<String> {
    text.iter()
        .cloned()
        .filter(|c| {
            let c = c.clone();
            c.chars().all(|c| !c.is_alphabetic() || c.is_lowercase())
        })
        .map(|c| c)
        .collect::<std::collections::HashSet<_>>()
}
#[doc = "Get words with specific length."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn words_with_length(words: &Vec<String>, length: i32) -> std::collections::HashSet<String> {
    words
        .iter()
        .cloned()
        .filter(|w| {
...
#[doc = "Get words starting with prefix."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn words_starting_with<'b, 'a>(
    words: &'a Vec<String>,
    prefix: &'b str,
...
#[doc = "Get words ending with suffix."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn words_ending_with<'b, 'a>(
    words: &'a Vec<String>,
    suffix: &'b str,
) -> std::collections::HashSet<String> {
    words
...
#[doc = "Get words containing substring."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn words_containing<'b, 'a>(
    words: &'a Vec<String>,
    substring: &'b str,
) -> std::collections::HashSet<String> {
    words
...
#[doc = "Flatten list of lists to set."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn flatten_to_set(lists: &Vec<Vec<i32>>) -> std::collections::HashSet<i32> {
    lists
        .into_iter()
        .flat_map(|lst| lst.into_iter().cloned())
        .collect::<std::collections::HashSet<_>>()
}
#[doc = "Cartesian product as set of tuples."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn cross_product_set<'a, 'b>(
    list1: &'a Vec<i32>,
    list2: &'b Vec<i32>,
...
#[doc = "Get all possible pair sums."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn pair_sums(items: &Vec<i32>) -> std::collections::HashSet<i32> {
    items
        .into_iter()
        .flat_map(|x| items.into_iter().map(move |y| x + y))
        .collect::<std::collections::HashSet<_>>()
}
#[doc = "Get all possible pair products."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn pair_products(items: &Vec<i32>) -> std::collections::HashSet<i32> {
    items
        .into_iter()
        .flat_map(|x| items.into_iter().map(move |y| x * y))
        .collect::<std::collections::HashSet<_>>()
}
#[doc = "Symmetric difference using comprehension."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn symmetric_difference_comprehension<'a, 'b>(
    set1: &'a std::collections::HashSet<i32>,
    set2: &'b std::collections::HashSet<i32>,
...
#[doc = "Intersection using comprehension."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn intersection_comprehension<'b, 'a>(
    set1: &'a std::collections::HashSet<i32>,
    set2: &'b std::collections::HashSet<i32>,
) -> std::collections::HashSet<i32> {
    set1.iter()
...
#[doc = "Difference using comprehension."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn difference_comprehension<'a, 'b>(
    set1: &'a std::collections::HashSet<i32>,
    set2: &'b std::collections::HashSet<i32>,
) -> std::collections::HashSet<i32> {
    set1.iter()
...
#[doc = "Get elements common to all lists."]
pub fn common_elements(
    lists: &Vec<Vec<i32>>,
) -> Result<std::collections::HashSet<i32>, Box<dyn std::error::Error>> {
    let mut result: std::collections::HashSet<String> = Default::default();
    if lists.is_empty() {
        return Ok(std::collections::HashSet::<i32>::new());
    }
    result = lists
        .get(0usize)
        .cloned()
...
#[doc = "Get unique values from dict of lists."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn unique_from_dict_values(
    d: &std::collections::HashMap<String, Vec<i32>>,
) -> std::collections::HashSet<i32> {
    d.values()
        .cloned()
        .collect::<Vec<_>>()
...
#[doc = "Get unique keys(already unique but with transform)."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn unique_from_dict_keys(
...
#[doc = "Get prime factors of n."]
pub fn prime_factors(
    mut n: i32,
) -> Result<std::collections::HashSet<i32>, Box<dyn std::error::Error>> {
    let mut factors: std::collections::HashSet<i32> = std::collections::HashSet::<i32>::new();
    let mut d = 2;
    while d * d <= n {
        while n % d == 0 {
            factors.insert(d);
...
#[doc = "Get perfect squares in range."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn perfect_squares_in_range(start: i32, end: i32) -> std::collections::HashSet<i32> {
    ((1)..(end))
        .into_iter()
        .filter(|i| {
            let i = i.clone();
...
#[doc = "Get first count multiples of base."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn multiples_set(base: i32, count: i32) -> std::collections::HashSet<i32> {
    ((1)..(count + 1))
        .into_iter()
        .map(|i| base * i)
        .collect::<std::collections::HashSet<_>>()
}
#[doc = "Get various transforms of text."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn string_transforms(text: &str) -> std::collections::HashSet<String> {
    {
        let mut set = std::collections::HashSet::new();
        set.insert(text.to_lowercase());
        set.insert(text.to_uppercase());
        set.insert(
...
#[doc = "Get distribution of word lengths."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn word_lengths_distribution(words: &Vec<String>) -> std::collections::HashSet<i32> {
    words
        .iter()
        .cloned()
        .map(|w| w.len() as i32)
...
pub fn main() {
    ...
    match &args.command {
        Some(Commands::Squares { ref items, .. }) => {
            let items = items.clone();
            result = unique_squares(&items);
            println!("{}", {
        ...
        Some(Commands::Vowels { ref text, .. }) => {
            result = vowels_in_text(&text);
            println!("{}", {
                let mut sorted_vec = result.iter().cloned().collect::<Vec<_>>();
                sorted_vec.sort_by(|a, b| a.partial_cmp(b).unwrap_or(std::cmp::Ordering::Equal));
                sorted_vec
        ...
        Some(Commands::Filter {
            ...
            let odd = *odd;
            if even {
                result = even_numbers(&items);
            } else {
                if odd {
                    result = odd_numbers(&items);
                } else {
                    result = items.into_iter().collect::<std::collections::HashSet<_>>();
                }
            }
            println!("{}", {
                let mut sorted_vec = result.iter().cloned().collect::<Vec<_>>();
        ...
        Some(Commands::Words {
            ...
            words = words.into_iter().collect::<std::collections::HashSet<_>>();
            if prefix.is_some() {
                words = words_starting_with(words.into_iter().collect::<Vec<_>>(), &prefix);
            }
            if suffix.is_some() {
                words = words_ending_with(words.into_iter().collect::<Vec<_>>(), &suffix);
            }
            println!("{}", {
                let mut sorted_vec = words.iter().cloned().collect::<Vec<_>>();
                sorted_vec.sort_by(|a, b| a.partial_cmp(b).unwrap_or(std::cmp::Ordering::Equal));
                sorted_vec
            });
        }
