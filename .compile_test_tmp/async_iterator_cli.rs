...
#![allow(dead_code)]
#[doc = "// NOTE: Map Python module 'collections.abc'(tracked in DEPYLER-0424)"] #[doc = r" Sum type for heterogeneous dictionary values(Python fidelity)"] #[doc = r" DEPYLER-1040b: Now implements Hash + Eq to support non-string dict keys"] #[derive(Debug, Clone, Default)] pub enum DepylerValue {
...
#[doc = r" Simple string split(NASA mode alternative to regex split)"] pub fn split(pattern: & str, text: & str) -> Vec<String>{
    ...
    pub _start: i32, pub _end: i32, pub _step: i32, pub _current: i32
}
impl AsyncRange {
    pub fn new(_start: i32, _end: i32, _step: i32) -> Self {
    Self {
    _start: 0, _end: 0, _step: 0, _current: 0
}
} pub async fn __anext__(&mut self) -> i32 {
    if self._step.clone()>0 &&self._current.clone()>= self._end.clone() || self._step.clone()<0 &&self._current.clone() <= self._end.clone() {
    panic!("Exception: {}", StopAsyncIteration);
    };
    let value = self._current.clone();
    self._current = self._current.clone() + self._step.clone();
    return value;
   
}
} #[derive(Debug, Clone)] pub struct AsyncCounter {
    pub _limit: i32, pub _count: i32
}
impl AsyncCounter {
    pub fn new(_limit: i32) -> Self {
    Self {
    _limit: 0, _count: 0
}
} pub async fn __anext__(&mut self) -> i32 {
    if self._count.clone()>= self._limit.clone() {
    panic!("Exception: {}", StopAsyncIteration);
    };
    let value = self._count.clone();
    self._count = self._count.clone() + 1;
    return value;
   
}
} #[derive(Debug, Clone)] pub struct AsyncFilter {
    pub _iterable: AsyncIterator<i32>, pub _min_value: i32
}
impl AsyncFilter {
    pub fn new(_iterable: AsyncIterator<i32>, _min_value: i32) -> Self {
    Self {
    _iterable: Default::default(), _min_value: 0
}
} pub async fn __anext__(&self) -> i32 {
    for item in self._iterable.clone() {
    if item>= self._min_value.clone() {
    return item;
    };
    };
    panic!("Exception: {}", StopAsyncIteration);
...
} #[derive(Debug, Clone)] pub struct AsyncMap {
    pub _iterable: AsyncIterator<i32>, pub _addend: i32
}
impl AsyncMap {
    pub fn new(_iterable: AsyncIterator<i32>, _addend: i32) -> Self {
    Self {
    _iterable: Default::default(), _addend: 0
}
} pub async fn __anext__(&self) -> i32 {
    for item in self._iterable.clone() {
    return item + self._addend.clone();
    };
    panic!("Exception: {}", StopAsyncIteration);
   
}
} #[derive(Debug, Clone)] pub struct AsyncTake {
    pub _iterable: AsyncIterator<i32>, pub _remaining: i32
}
impl AsyncTake {
    pub fn new(_iterable: AsyncIterator<i32>, _n: i32) -> Self {
    Self {
    _iterable: Default::default(), _remaining: 0
}
} pub async fn __anext__(&mut self) -> i32 {
    if self._remaining.clone() <= 0 {
    panic!("Exception: {}", StopAsyncIteration);
    };
    self._remaining = self._remaining.clone() - 1;
    return self._iterable.clone().__anext__().await;
   
}
} #[derive(Debug, Clone)] pub struct AsyncSkip {
    pub _iterable: AsyncIterator<i32>, pub _to_skip: i32, pub _skipped: bool
}
impl AsyncSkip {
    pub fn new(_iterable: AsyncIterator<i32>, _n: i32) -> Self {
    Self {
    _iterable: Default::default(), _to_skip: 0, _skipped: false
}
} pub async fn __anext__(&mut self) -> i32 {
    if! self._skipped.clone() {
    for _ in 0..self._to_skip.clone() {
    { let _result  = (| | -> Result <(), Box<dyn std::error::Error>>{
    { self._iterable.clone().__anext__().await;
...
#[doc = r" AsyncIterator type alias for Python async iteration"] #[doc = r" DEPYLER-0680: Generated to allow standalone compilation"] #[allow(dead_code)] pub type AsyncIterator<T>= std::iter::Once<T>;
    #[doc = r" StopAsyncIteration exception for Python async iteration"] #[doc = r" DEPYLER-0680: Generated to allow standalone compilation"] #[allow(dead_code)] pub struct StopAsyncIteration;
    #[doc = "Async generator for range."] #[doc = " Depyler: verified panic-free"] #[doc = " Depyler: proven to terminate"] #[doc = " Generator state struct"] #[derive(Debug)] struct AsyncGeneratorRangeState {
    state: usize, start: i32, end: i32
}
#[doc = " Generator function - returns Iterator"] pub fn async_generator_range(start: i32, end: i32) -> impl Iterator<Item = AsyncIterator<i32>>{
    AsyncGeneratorRangeState {
    state: 0, start: start, end: end
}
} impl Iterator for AsyncGeneratorRangeState {
    type Item = AsyncIterator<i32>;
...
#[doc = "Async generator for squares."] #[doc = " Depyler: verified panic-free"] #[doc = " Depyler: proven to terminate"] #[doc = " Generator state struct"] #[derive(Debug)] struct AsyncGeneratorSquaresState {
    state: usize, limit: i32
}
#[doc = " Generator function - returns Iterator"] pub fn async_generator_squares(limit: i32) -> impl Iterator<Item = AsyncIterator<i32>>{
    AsyncGeneratorSquaresState {
    state: 0, limit: limit
}
} impl Iterator for AsyncGeneratorSquaresState {
    type Item = AsyncIterator<i32>;
    fn next(&mut self) -> Option<Self::Item>{
    match self.state {
    0 =>{
...
#[doc = "Async generator for Fibonacci sequence."] #[doc = " Depyler: verified panic-free"] #[doc = " Depyler: proven to terminate"] #[doc = " Generator state struct"] #[derive(Debug)] struct AsyncGeneratorFibonacciState {
    state: usize, a: i32, b: i32, limit: i32
}
#[doc = " Generator function - returns Iterator"] pub fn async_generator_fibonacci(limit: i32) -> impl Iterator<Item = AsyncIterator<i32>>{
    AsyncGeneratorFibonacciState {
    state: 0, a: 0, b: 0, limit: limit
}
} impl Iterator for AsyncGeneratorFibonacciState {
    type Item = AsyncIterator<i32>;
    fn next(&mut self) -> Option<Self::Item>{
    match self.state {
    0 =>{
    ...
    for __sanitized in 0..(self.limit) {
    return Some(self.a);
...
#[doc = "Async generator that filters values."] #[doc = " Depyler: verified panic-free"] #[doc = " Generator state struct"] #[derive(Debug)] struct AsyncGeneratorFilterState {
    state: usize, source: AsyncIterator<i32>, threshold: i32
}
#[doc = " Generator function - returns Iterator"] pub fn async_generator_filter(source: & AsyncIterator<i32>, threshold: i32) -> impl Iterator<Item = AsyncIterator<i32>>{
    AsyncGeneratorFilterState {
    state: 0, source: source, threshold: threshold
}
} impl Iterator for AsyncGeneratorFilterState {
    type Item = AsyncIterator<i32>;
    fn next(&mut self) -> Option<Self::Item>{
    match self.state {
    0 =>{
    self.state = 1;
    for item in self.source.iter().cloned() {
...
#[doc = "Async generator that transforms values."] #[doc = " Depyler: verified panic-free"] #[doc = " Generator state struct"] #[derive(Debug)] struct AsyncGeneratorMapState {
    state: usize, source: AsyncIterator<i32>, addend: i32
}
#[doc = " Generator function - returns Iterator"] pub fn async_generator_map(source: & AsyncIterator<i32>, addend: i32) -> impl Iterator<Item = AsyncIterator<i32>>{
    AsyncGeneratorMapState {
    state: 0, source: source, addend: addend
}
} impl Iterator for AsyncGeneratorMapState {
    type Item = AsyncIterator<i32>;
    fn next(&mut self) -> Option<Self::Item>{
    match self.state {
    0 =>{
...
#[doc = "Async generator that takes first n items."] #[doc = " Depyler: verified panic-free"] #[doc = " Generator state struct"] #[derive(Debug)] struct AsyncGeneratorTakeState {
    state: usize, count: i32, source: AsyncIterator<i32>, n: i32
}
#[doc = " Generator function - returns Iterator"] pub fn async_generator_take(source: & AsyncIterator<i32>, n: i32) -> impl Iterator<Item = AsyncIterator<i32>>{
    AsyncGeneratorTakeState {
    state: 0, count: 0, source: source, n: n
}
} impl Iterator for AsyncGeneratorTakeState {
    type Item = AsyncIterator<i32>;
    fn next(&mut self) -> Option<Self::Item>{
    match self.state {
    0 =>{
...
#[doc = "Async generator that skips first n items."] #[doc = " Depyler: verified panic-free"] #[doc = " Generator state struct"] #[derive(Debug)] struct AsyncGeneratorSkipState {
    state: usize, count: i32, source: AsyncIterator<i32>, n: i32
}
#[doc = " Generator function - returns Iterator"] pub fn async_generator_skip(source: & AsyncIterator<i32>, n: i32) -> impl Iterator<Item = AsyncIterator<i32>>{
    AsyncGeneratorSkipState {
    state: 0, count: 0, source: source, n: n
}
} impl Iterator for AsyncGeneratorSkipState {
    type Item = AsyncIterator<i32>;
    fn next(&mut self) -> Option<Self::Item>{
    match self.state {
    0 =>{
...
#[doc = "Chain two async iterators."] #[doc = " Depyler: verified panic-free"] #[doc = " Generator state struct"] #[derive(Debug)] struct AsyncGeneratorChainState {
    state: usize, first: AsyncIterator<i32>, second: AsyncIterator<i32>
}
#[doc = " Generator function - returns Iterator"] pub fn async_generator_chain<'a, 'b>(first: & 'a AsyncIterator<i32>, second: & 'b AsyncIterator<i32>) -> impl Iterator<Item = AsyncIterator<i32>>{
    AsyncGeneratorChainState {
    state: 0, first: first, second: second
}
} impl Iterator for AsyncGeneratorChainState {
    type Item = AsyncIterator<i32>;
    fn next(&mut self) -> Option<Self::Item>{
    match self.state {
    0 =>{
    self.state = 1;
    for item in self.first.iter().cloned() {
    return Some(item);
   
}
for item in self.second.iter().cloned() {
    return Some(item);
...
#[doc = "Async enumerate."] #[doc = " Depyler: verified panic-free"] #[doc = " Generator state struct"] #[derive(Debug)] struct AsyncGeneratorEnumerateState {
    state: usize, index: i32, source: AsyncIterator<i32>
}
#[doc = " Generator function - returns Iterator"] pub fn async_generator_enumerate(source: & AsyncIterator<i32>) -> impl Iterator<Item = AsyncIterator <(i32, i32)>>{
    AsyncGeneratorEnumerateState {
    state: 0, index: 0, source: source
}
} impl Iterator for AsyncGeneratorEnumerateState {
    type Item = AsyncIterator <(i32, i32)>;
    fn next(&mut self) -> Option<Self::Item>{
    match self.state {
    0 =>{
    self.state = 1;
...
#[doc = "Async zip of two iterators."] #[doc = " Depyler: verified panic-free"] #[doc = " Generator state struct"] #[derive(Debug)] struct AsyncGeneratorZipState {
    state: usize, a: DepylerValue, b: DepylerValue
}
#[doc = " Generator function - returns Iterator"] pub fn async_generator_zip<'b, 'a>(first: & 'a AsyncIterator<i32>, second: & 'b AsyncIterator<i32>) -> impl Iterator<Item = AsyncIterator <(i32, i32)>>{
    AsyncGeneratorZipState {
    state: 0, a: Default::default(), b: Default::default()
}
} impl Iterator for AsyncGeneratorZipState {
    type Item = AsyncIterator <(i32, i32)>;
    fn next(&mut self) -> Option<Self::Item>{
    match self.state {
    0 =>{
...
1 =>{
    ...
    self.a = first.__anext__();
    self.b = second.__anext__();
    return Ok(Some((self.a, self.b)));
    Ok(()) })() {
    Ok(()) =>{
...
#[doc = "Collect async iterator into list."] #[doc = " Depyler: verified panic-free"] pub fn collect_async(iterator: & AsyncIterator<i32>) -> Vec<i32>{
    let mut result: Vec<i32>= vec! [];
    for item in iterator.iter().cloned() {
    result.push(item);
   
}
result
}
#[doc = "Sum values from async iterator."] #[doc = " Depyler: verified panic-free"] pub fn sum_async(iterator: & AsyncIterator<i32>) -> i32 {
...
#[doc = "Count items in async iterator."] #[doc = " Depyler: verified panic-free"] pub fn count_async(iterator: & AsyncIterator<i32>) -> i32 {
    let mut count: i32 = Default::default();
    count = 0;
    for __sanitized in iterator.iter().cloned() {
    count = count + 1;
   
}
count
}
#[doc = "Check if any item equals value."] #[doc = " Depyler: verified panic-free"] pub fn any_async(iterator: & AsyncIterator<i32>, value: i32) -> bool {
    for item in iterator.iter().cloned() {
    if item == value {
    return true;
...
#[doc = "Check if all items are positive."] #[doc = " Depyler: verified panic-free"] pub fn all_positive_async(iterator: & AsyncIterator<i32>) -> bool {
    for item in iterator.iter().cloned() {
    if item <= 0 {
    return false;
...
#[doc = "Get first item or -1 if empty."] #[doc = " Depyler: verified panic-free"] pub fn first_async(iterator: & AsyncIterator<i32>) -> i32 {
    for item in iterator.iter().cloned() {
    return item;
...
#[doc = "Get last item or -1 if empty."] #[doc = " Depyler: verified panic-free"] pub fn last_async(iterator: & AsyncIterator<i32>) -> i32 {
...
#[doc = "Run async function synchronously."] #[doc = " Depyler: verified panic-free"] #[doc = " Depyler: proven to terminate"] pub fn run_async(coro: & DepylerValue) -> DepylerValue {
    coro
}
#[doc = " Depyler: verified panic-free"] #[doc = " Depyler: proven to terminate"] pub fn main () {
   ...
   ();
    ...
    let _cse_temp_0 = matches!(args.command, Some(Commands::Range {
  ..}));
    match & args.command {
    Some(Commands::Range {
    ref end, ref start,..}) =>{
    let end = * end;
    let start = * start;
    let mut result = run_async(collect_async(async_generator_range(start, end)));
    println!("{}", format!("Range: {:?}", result));
   
}
Some(Commands::Squares {
    ref limit,..}) =>{
    let limit = * limit;
    let mut result = run_async(collect_async(async_generator_squares(limit)));
    println!("{}", format!("Squares: {:?}", result));
   
}
Some(Commands::Fibonacci {
    ref limit,..}) =>{
    let limit = * limit;
    let mut result = run_async(collect_async(async_generator_fibonacci(limit)));
    println!("{}", format!("Fibonacci: {:?}", result));
...
#[cfg(test)] mod tests {
    ...
    #[test] fn test_all_positive_async_examples() {
    let _ = all_positive_async(Default::default());
