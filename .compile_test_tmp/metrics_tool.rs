...
pub fn accuracy_score<'b, 'a>(
    y_true: &'a Vec<i32>,
    y_pred: &'b Vec<i32>,
) -> Result<f64, Box<dyn std::error::Error>> {
    let _cse_temp_0 = y_true.len() as i32;
    let _cse_temp_1 = y_pred.len() as i32;
    let _cse_temp_2 = _cse_temp_0 != _cse_temp_1;
    if _cse_temp_2 {
        return Err(Box::new(ValueError::new("Length mismatch".to_string())));
    }
    let _cse_temp_3 = _cse_temp_0 == 0;
    if _cse_temp_3 {
        return Err(Box::new(ValueError::new("Empty input".to_string())));
    }
    let _cse_temp_4 = (0..(y_true.len() as i32))
        ...
        .map(|i| 1)
        .sum::<f64>();
    let correct = _cse_temp_4;
    Ok(((correct) as f64) / ((y_true.len() as i32) as f64))
}
#[doc = "Calculate precision score(TP /(TP + FP))."]
#[doc = " Depyler: proven to terminate"]
pub fn precision_score<'b, 'a>(
    y_true: &'a Vec<i32>,
    y_pred: &'b Vec<i32>,
) -> Result<f64, Box<dyn std::error::Error>> {
    let _cse_temp_0 = y_true.len() as i32;
    ...
    let _cse_temp_3 = (0..(y_true.len() as i32))
        .into_iter()
        .filter(|&i| {
            (y_true
                .get(i as usize)
    ...
    let tp = _cse_temp_3;
    let fp = _cse_temp_3;
    let _cse_temp_4 = tp + fp == 0;
    if _cse_temp_4 {
        return Ok(0.0);
    }
    Ok(((tp) as f64) / ((tp + fp) as f64))
}
#[doc = "Calculate recall score(TP /(TP + FN))."]
#[doc = " Depyler: proven to terminate"]
pub fn recall_score<'a, 'b>(
    y_true: &'a Vec<i32>,
    y_pred: &'b Vec<i32>,
) -> Result<f64, Box<dyn std::error::Error>> {
    let _cse_temp_0 = y_true.len() as i32;
    ...
    let _cse_temp_3 = (0..(y_true.len() as i32))
        ...
        .sum::<f64>();
    let tp = _cse_temp_3;
    let r#fn = _cse_temp_3;
    let _cse_temp_4 = tp + r#fn == 0;
    if _cse_temp_4 {
        return Ok(0.0);
    }
    Ok(((tp) as f64) / ((tp + r#fn) as f64))
}
#[doc = "Calculate F1 score(harmonic mean of precision and recall)."]
#[doc = " Depyler: proven to terminate"]
pub fn f1_score<'b, 'a>(
    y_true: &'a Vec<i32>,
    y_pred: &'b Vec<i32>,
    ...
    let _cse_temp_0 = p + r == 0f64;
    if _cse_temp_0 {
        return Ok(0.0);
    }
    Ok(((2f64 * p * r) as f64) / ((p + r) as f64))
}
#[doc = "Calculate confusion matrix [[TN, FP], [FN, TP]]."]
#[doc = " Depyler: proven to terminate"]
pub fn confusion_matrix<'a, 'b>(
    y_true: &'a Vec<i32>,
    y_pred: &'b Vec<i32>,
    ...
    let r#fn = _cse_temp_3;
    let tp = _cse_temp_3;
    Ok(vec![vec![tn, fp], vec![r#fn, tp]])
}
#[doc = "Calculate mean squared error."]
#[doc = " Depyler: proven to terminate"]
pub fn mean_squared_error<'b, 'a>(
    y_true: &'a Vec<f64>,
    y_pred: &'b Vec<f64>,
) -> Result<f64, Box<dyn std::error::Error>> {
    let _cse_temp_0 = y_true.len() as i32;
    ...
    Ok((((0..(y_true.len() as i32))
        ...
        .sum::<f64>()) as f64)
        / ((y_true.len() as i32) as f64))
}
#[doc = "Calculate R-squared score."]
#[doc = " Depyler: proven to terminate"]
pub fn r2_score<'a, 'b>(
    y_true: &'a Vec<f64>,
    y_pred: &'b Vec<f64>,
    ...
    let _cse_temp_4 = y_true.iter().sum::<f64>();
    let _cse_temp_5 = ((_cse_temp_4) as f64) / ((_cse_temp_0) as f64);
    let y_mean = _cse_temp_5;
    let _cse_temp_6 = (0..(y_true.len() as i32))
        .into_iter()
        .map(|i| {
            if 2 >= 0 && (2 as i64) <= (u32::MAX as i64) {
                ({
        ...
        .sum::<f64>();
    let ss_res = _cse_temp_6;
    let ss_tot = _cse_temp_6;
    let _cse_temp_7 = ss_tot == 0;
    if _cse_temp_7 {
        return Ok(if ss_res == 0 { 1.0 } else { 0.0 });
    }
    Ok(1.0 - ((ss_res) as f64) / ((ss_tot) as f64))
}
#[doc = "Handle accuracy subcommand."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn cmd_accuracy() -> Result<(), Box<dyn std::error::Error>> {
    ...
    match (|| -> Result<(), Box<dyn std::error::Error>> {
        acc = accuracy_score(
            data.get("y_true").cloned().unwrap_or_default(),
            data.get("y_pred").cloned().unwrap_or_default(),
        )?;
        println!(
            "{}",
            format!("{:?}", {
                let mut map = HashMap::new();
                map.insert("accuracy".to_string().to_string(), acc);
                map
            })
        );
        Ok(())
...
#[doc = "Handle precision subcommand."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn cmd_precision() -> Result<(), Box<dyn std::error::Error>> {
    let data = match serde_json::from_reader::<_, String>(std::io::stdin()) {
        Ok(__json_data) => __json_data,
        Err(e) => {
            eprintln!("{}", format!("Error: Invalid JSON: {:?}", e));
    ...
    match (|| -> Result<(), Box<dyn std::error::Error>> {
        ...
        println!(
            ...
            format!("{:?}", {
                let mut map = HashMap::new();
                map.insert("precision".to_string().to_string(), prec);
                map
            })
        );
        Ok(())
...
#[doc = "Handle recall subcommand."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn cmd_recall() -> Result<(), Box<dyn std::error::Error>> {
    let data = match serde_json::from_reader::<_, String>(std::io::stdin()) {
        Ok(__json_data) => __json_data,
        Err(e) => {
            eprintln!("{}", format!("Error: Invalid JSON: {:?}", e));
    ...
    match (|| -> Result<(), Box<dyn std::error::Error>> {
        ...
        println!(
            ...
            format!("{:?}", {
                let mut map = HashMap::new();
                map.insert("recall".to_string().to_string(), rec);
                map
            })
        );
        Ok(())
...
#[doc = "Handle f1 subcommand."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn cmd_f1() -> Result<(), Box<dyn std::error::Error>> {
    let data = match serde_json::from_reader::<_, String>(std::io::stdin()) {
        Ok(__json_data) => __json_data,
        Err(e) => {
            eprintln!("{}", format!("Error: Invalid JSON: {:?}", e));
    ...
    match (|| -> Result<(), Box<dyn std::error::Error>> {
        ...
        println!(
            ...
            format!("{:?}", {
                let mut map = HashMap::new();
                map.insert("f1".to_string().to_string(), f1);
                map
            })
        );
        Ok(())
...
#[doc = "Handle confusion-matrix subcommand."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn cmd_confusion_matrix() -> Result<(), Box<dyn std::error::Error>> {
    let data = match serde_json::from_reader::<_, String>(std::io::stdin()) {
        Ok(__json_data) => __json_data,
        Err(e) => {
            eprintln!("{}", format!("Error: Invalid JSON: {:?}", e));
    ...
    match (|| -> Result<(), Box<dyn std::error::Error>> {
        ...
        println!(
            ...
            format!("{:?}", {
                let mut map = HashMap::new();
                map.insert("matrix".to_string().to_string(), matrix);
                map
            })
        );
        Ok(())
...
#[doc = "Handle mse subcommand."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn cmd_mse() -> Result<(), Box<dyn std::error::Error>> {
    let data = match serde_json::from_reader::<_, String>(std::io::stdin()) {
        Ok(__json_data) => __json_data,
        Err(e) => {
            eprintln!("{}", format!("Error: Invalid JSON: {:?}", e));
    ...
    let mut mse: Option<String> = None;
    match (|| -> Result<(), Box<dyn std::error::Error>> {
        ...
        println!(
            ...
            format!("{:?}", {
                let mut map = HashMap::new();
                map.insert("mse".to_string().to_string(), mse);
                map
            })
        );
        Ok(())
...
#[doc = "Handle r2 subcommand."]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn cmd_r2() -> Result<(), Box<dyn std::error::Error>> {
    let data = match serde_json::from_reader::<_, String>(std::io::stdin()) {
        Ok(__json_data) => __json_data,
        Err(e) => {
            eprintln!("{}", format!("Error: Invalid JSON: {:?}", e));
    ...
    match (|| -> Result<(), Box<dyn std::error::Error>> {
        ...
        println!(
            ...
            format!("{:?}", {
                let mut map = HashMap::new();
                map.insert("r2".to_string().to_string(), r2);
                map
            })
        );
        Ok(())
