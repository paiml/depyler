...
#![allow(dead_code)]
#[doc = "// NOTE: Map Python module 'html'(tracked in DEPYLER-0424)"]
...
#[doc = "Escape HTML. Depyler: proven to terminate"]
...
pub fn cmd_escape() {
    ...
    println!("{}", html.escape(text));
}
#[doc = "Unescape HTML. Depyler: proven to terminate"]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn cmd_unescape() {
    let text = {
    ...
    println!("{}", html.unescape(text));
}
#[doc = "Strip HTML tags. Depyler: proven to terminate"]
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn cmd_strip() {
    let text = {
    ...
    let clean = DepylerRegexMatch::sub("<[^>]+>", "", text);
    println!("{}", clean);
}
#[doc = " Depyler: verified panic-free"]
#[doc = " Depyler: proven to terminate"]
pub fn main() {
    ...
    ({
        ...
        map.insert("escape".to_string().to_string(), cmd_escape);
        map.insert("unescape".to_string().to_string(), cmd_unescape);
        map.insert("strip".to_string().to_string(), cmd_strip);
        map
    }
