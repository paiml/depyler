...
pub fn main() {
    ...
    let _cse_temp_0 = matches!(args.command, Some(Commands::Color { .. }));
    match &args.command {
        Some(Commands::Color { ref name, .. }) => {
            let name = name.to_string();
            let _cse_temp_1 = name == "RED";
            if _cse_temp_1 {
                println!("{}", 1);
            } else {
                let _cse_temp_2 = name == "GREEN";
                if _cse_temp_2 {
                    println!("{}", 2);
                } else {
                    let _cse_temp_3 = name == "BLUE";
                    if _cse_temp_3 {
                        println!("{}", 3);
                    }
                }
        ...
        Some(Commands::Status { ref name, .. }) => {
            let name = name.to_string();
            let _cse_temp_5 = name == "PENDING";
            if _cse_temp_5 {
                println!("{}", 1);
            } else {
                let _cse_temp_6 = name == "RUNNING";
                if _cse_temp_6 {
                    println!("{}", 2);
                } else {
                    let _cse_temp_7 = name == "COMPLETE";
                    if _cse_temp_7 {
                        println!("{}", 3);
                    } else {
                        let _cse_temp_8 = name == "FAILED";
                        if _cse_temp_8 {
                            println!("{}", 4);
                        }
                    }
