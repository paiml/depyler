...
pub fn main() {
    ...
    let _cse_temp_0 = matches!(args.command, Some(Commands::Argmax3 { .. }));
    match &args.command {
        Some(Commands::Argmax3 {
            ref a,
            ref b,
            ref c,
            ..
            ...
            println!("{}", arr.argmax().unwrap());
        }
        Some(Commands::Argmax4 {
            ref a,
            ref b,
            ref c,
            ref d,
        ...
        Some(Commands::Argmax5 {
            ...
            let d = *d;
            let e = *e;
            let mut arr = Vector::from_slice(&[a as f32, b as f32, c as f32, d as f32, e as f32]);
            println!("{}", arr.argmax().unwrap());
        }
