...
#![allow(dead_code)]
#[doc = "// NOTE: Map Python module 'dataclasses'(tracked in DEPYLER-0424)"] #[doc = "// NOTE: Map Python module 'enum'(tracked in DEPYLER-0424)"] const STR_TYPE: &'static str = "type";
...
#[derive(Debug, Clone, PartialEq)] pub enum SchemaTypeOrListUnion {
    SchemaType(SchemaType), List(Vec<SchemaType>)
}
impl From<SchemaType>for SchemaTypeOrListUnion {
    fn from(value: SchemaType) -> Self {
    SchemaTypeOrListUnion::SchemaType(value)
}
} impl From<Vec<SchemaType>>for SchemaTypeOrListUnion {
    fn from(value: Vec<SchemaType>) -> Self {
    SchemaTypeOrListUnion::List(value)
}
} impl SchemaTypeOrListUnion {
    pub fn is_schematype(&self) -> bool {
    matches!(self, SchemaTypeOrListUnion::SchemaType(_))
}
pub fn is_list(&self) -> bool {
    matches!(self, SchemaTypeOrListUnion::List(_))
}
pub fn as_schematype(&self) -> Option<& SchemaType>{
    match self {
    SchemaTypeOrListUnion::SchemaType(value) =>Some(value), _ =>None ,
}
} pub fn as_list(&self) -> Option<& Vec<SchemaType>>{
    match self {
    SchemaTypeOrListUnion::List(value) =>Some(value), _ =>None ,
}
}
}
#[derive(Debug, Clone, PartialEq)] pub enum ListOrStringUnion {
    List(Vec<String>), Text(String)
}
impl From<Vec<String>>for ListOrStringUnion {
    fn from(value: Vec<String>) -> Self {
    ListOrStringUnion::List(value)
}
} impl From<String>for ListOrStringUnion {
    fn from(value: String) -> Self {
    ListOrStringUnion::Text(value)
}
} impl ListOrStringUnion {
    pub fn is_list(&self) -> bool {
    matches!(self, ListOrStringUnion::List(_))
}
pub fn is_text(&self) -> bool {
    matches!(self, ListOrStringUnion::Text(_))
}
pub fn as_list(&self) -> Option<& Vec<String>>{
    match self {
    ListOrStringUnion::List(value) =>Some(value), _ =>None ,
}
} pub fn as_text(&self) -> Option<& String>{
    match self {
    ListOrStringUnion::Text(value) =>Some(value), _ =>None ,
}
}
}
...
} #[derive(Debug, Clone)] pub struct SchemaType {
   
}
impl SchemaType {
    pub const STRING: i32 = auto();
    pub const INTEGER: i32 = auto();
    pub const NUMBER: i32 = auto();
    pub const BOOLEAN: i32 = auto();
    pub const ARRAY: i32 = auto();
    pub const OBJECT: i32 = auto();
    pub const NULL: i32 = auto();
    pub const ANY: i32 = auto();
    pub fn new() -> Self {
    Self {
...
#[derive(Debug, Clone, PartialEq)] pub struct SchemaError {
    pub path: String, pub message: String
}
impl SchemaError {
...
#[derive(Debug, Clone, PartialEq)] pub struct Schema {
    pub schema_type: DepylerValue, pub properties: std::collections::HashMap<String, Schema>, pub required: Vec<String>, pub items: Option<Schema>, pub minimum: Option<f64>, pub maximum: Option<f64>, pub min_length: Option<i32>, pub max_length: Option<i32>, pub min_items: Option<i32>, pub max_items: Option<i32>, pub pattern: Option<String>, pub enum_: Vec<DepylerValue>, pub const_: DepylerValue, pub additional_properties: bool, pub unique_items: bool
}
impl Schema {
    pub fn new(schema_type: DepylerValue, properties: std::collections::HashMap<String, Schema>, required: Vec<String>, items: Option<Schema>, minimum: Option<f64>, maximum: Option<f64>, min_length: Option<i32>, max_length: Option<i32>, min_items: Option<i32>, max_items: Option<i32>, pattern: Option<String>, enum_: Vec<DepylerValue>, const_: DepylerValue, additional_properties: bool, unique_items: bool) -> Self {
    Self {
    schema_type, properties, required, items, minimum, maximum, min_length, max_length, min_items, max_items, pattern, enum_, const_, additional_properties, unique_items
}
}
}
#[derive(Default)] enum Commands {
    ...
    __DepylerNone,
    Sample {
    #[doc = "Schema file(JSON)"] schema: String
}
, Validate {
    #[doc = "Data file(JSON)"] data: String, #[doc = "Schema file(JSON)"] schema: Option<String>
}
, Infer {
    #[doc = "Data file(JSON)"] data: String, #[doc = "Generate strict schema"] strict: bool
}
...
#[doc = r" Stub for local import from module: #module_name"] #[doc = r" DEPYLER-0615: Generated to allow standalone compilation"] #[allow(dead_code, unused_variables)] pub fn field<T: Default>(_args: impl std::any::Any) -> T {
    Default::default()
}
#[doc = r" Stub for local import from module: #module_name"] #[doc = r" DEPYLER-0615: Generated to allow standalone compilation"] #[allow(dead_code, unused_variables)] pub fn Enum<T: Default>(_args: impl std::any::Any) -> T {
    Default::default()
}
#[doc = r" Stub for local import from module: #module_name"] #[doc = r" DEPYLER-0615: Generated to allow standalone compilation"] #[allow(dead_code, unused_variables)] pub fn auto<T: Default>(_args: impl std::any::Any) -> T {
    Default::default()
}
#[doc = "Get schema type for a value."] #[doc = " Depyler: verified panic-free"] #[doc = " Depyler: proven to terminate"] pub fn get_type(value: & DepylerValue) -> SchemaType {
    if value.is_none() {
...
#[doc = "Get human-readable type name."] #[doc = " Depyler: verified panic-free"] #[doc = " Depyler: proven to terminate"] pub fn type_name(t: & SchemaType) -> String {
    t.name.to_lowercase()
}
#[doc = "Check if value matches expected type(s)."] #[doc = " Depyler: verified panic-free"] #[doc = " Depyler: proven to terminate"] pub fn check_type<'a, 'b>(value: & 'a DepylerValue, expected: & 'b SchemaTypeOrListUnion) -> bool {
    let actual = get_type(& value);
    if true {
    return expected.get(& actual).is_some();
   
}
let _cse_temp_0  = (* expected) == SchemaType::ANY;
    if _cse_temp_0 {
    return true;
   
}
let _cse_temp_1 = actual == SchemaType::INTEGER;
...
#[doc = "Validate data against schema."] #[doc = " Depyler: verified panic-free"] #[doc = " Depyler: proven to terminate"] pub fn validate<'a, 'b, 'c>(data: & 'a DepylerValue, schema: & 'b Schema, path: & 'c str) -> Vec<SchemaError>{
    let mut errors = vec! [];
    if! check_type(& data, schema.schema_type) {
    let mut expected: String;
    if true {
    expected = schema.schema_type.into_iter().map(| t | type_name(& t)).collect::<Vec<_>>().join (" or ");
...
let actual = type_name(get_type(& data));
    errors.push(DepylerValue::Str(format!("{:?}", SchemaError::new(if path.is_empty() {
    "$".to_string().to_string()
}
else {
    path.to_string()
...
let _cse_temp_0  = (* data)!= schema.r#const;
    let _cse_temp_1  = (schema.r#const.is_some()) &&(_cse_temp_0);
    if _cse_temp_1 {
    errors.push(DepylerValue::Str(format!("{:?}", SchemaError::new(if path.is_empty() {
    "$".to_string().to_string()
}
...
, format!("Value must be {}", schema.r#const)))));
   
}
let _cse_temp_2 =! schema.r#enum.contains(& data);
    let _cse_temp_3  = (schema.r#enum) &&(_cse_temp_2);
    if _cse_temp_3 {
    errors.push(DepylerValue::Str(format!("{:?}", SchemaError::new(if path.is_empty() {
    "$".to_string().to_string()
}
...
, format!("Value must be one of: {}", schema.r#enum)))));
   
}
if true {
    let _cse_temp_4 = data.len() as i32;
    let _cse_temp_5 = _cse_temp_4<schema.min_length;
    let _cse_temp_6  = (schema.min_length.is_some()) &&(_cse_temp_5);
    if _cse_temp_6 {
    errors.push(DepylerValue::Str(format!("{:?}", SchemaError::new(if path.is_empty() {
    "$".to_string().to_string()
}
...
, format!("String length {} is less than minimum {}", data.len() as i32, schema.min_length)))));
   
}
let _cse_temp_7 = _cse_temp_4>schema.max_length;
    let _cse_temp_8  = (schema.max_length.is_some()) &&(_cse_temp_7);
    if _cse_temp_8 {
    errors.push(DepylerValue::Str(format!("{:?}", SchemaError::new(if path.is_empty() {
    "$".to_string().to_string()
}
...
, format!("String length {} exceeds maximum {}", data.len() as i32, schema.max_length)))));
   
}
if schema.pattern {
    if DepylerRegexMatch::match_start(schema.pattern, data).is_none() {
    errors.push(DepylerValue::Str(format!("{:?}", SchemaError::new(if path.is_empty() {
    "$".to_string().to_string()
}
else {
...
, format!("String does not match pattern '{}'", schema.pattern)))));
   
}
}
}
let _cse_temp_9  = (true) &&(! true);
    if _cse_temp_9 {
    let _cse_temp_10  = (* data)<schema.minimum;
    let _cse_temp_11  = (schema.minimum.is_some()) &&(_cse_temp_10);
    if _cse_temp_11 {
    errors.push(DepylerValue::Str(format!("{:?}", SchemaError::new(if path.is_empty() {
    "$".to_string().to_string()
}
...
, format!("Value {} is less than minimum {}", data, schema.minimum)))));
   
}
let _cse_temp_12  = (* data)>schema.maximum;
    let _cse_temp_13  = (schema.maximum.is_some()) &&(_cse_temp_12);
    if _cse_temp_13 {
    errors.push(DepylerValue::Str(format!("{:?}", SchemaError::new(if path.is_empty() {
    "$".to_string().to_string()
}
...
, format!("Value {} exceeds maximum {}", data, schema.maximum)))));
   
}
} if true {
    let _cse_temp_14 = data.len() as i32;
    let _cse_temp_15 = _cse_temp_14<schema.min_items;
    let _cse_temp_16  = (schema.min_items.is_some()) &&(_cse_temp_15);
    if _cse_temp_16 {
    errors.push(DepylerValue::Str(format!("{:?}", SchemaError::new(if path.is_empty() {
    "$".to_string().to_string()
}
...
, format!("Array length {} is less than minimum {}", data.len() as i32, schema.min_items)))));
   
}
let _cse_temp_17 = _cse_temp_14>schema.max_items;
    let _cse_temp_18  = (schema.max_items.is_some()) &&(_cse_temp_17);
    if _cse_temp_18 {
    errors.push(DepylerValue::Str(format!("{:?}", SchemaError::new(if path.is_empty() {
    "$".to_string().to_string()
}
...
, format!("Array length {} exceeds maximum {}", data.len() as i32, schema.max_items)))));
...
, "Array contains duplicate items".to_string().to_string()))));
    break;
   
}
seen.push(DepylerValue::Str(item_str.to_string()));
   
}
} if schema.items {
    for(i, item) in data.iter().cloned().enumerate().map(|(i, x) |(i as i32, x)) {
    let i = i as i32;
    ...
    format!("[{:?}]", i) };
    errors.extend(validate(& item, schema.items, & item_path).iter().cloned());
...
if true {
    ...
    if! data.get(& prop).is_some() {
    let mut prop_path = if! path.is_empty() {
    format!("{}.{:?}", path, prop)
}
else {
    prop };
    errors.push(DepylerValue::Str(format!("{:?}", SchemaError::new(prop_path, format!("Required property '{:?}' is missing", prop)))));
   
}
} for(prop, prop_schema) in schema.properties.iter().map(|(k, v) |(k.clone(), v.clone())).collect::<Vec<_>>() {
    if data.get(& prop).is_some() {
    let mut prop_path = if! path.is_empty() {
    format!("{}.{:?}", path, prop)
}
    ...
    prop };
    errors.extend(validate(data.get(prop as usize).cloned().expect("IndexError: list index out of range"), & prop_schema, & prop_path).iter().cloned());
   
}
} if! schema.additional_properties {
    for prop in data.iter().cloned() {
    if schema.properties.get(& prop).is_none() {
    let mut prop_path = if! path.is_empty() {
    format!("{}.{:?}", path, prop)
}
else {
    prop };
    errors.push(DepylerValue::Str(format!("{:?}", SchemaError::new(prop_path, format!("Additional property '{:?}' is not allowed", prop)))));
...
#[doc = "Parse type string to SchemaType."] #[doc = " Depyler: verified panic-free"] #[doc = " Depyler: proven to terminate"] pub fn parse_type_str(type_str: & ListOrStringUnion) -> SchemaTypeOrListUnion {
    let type_map = {
    let mut map = HashMap::new();
    map.insert("string".to_string(), SchemaType::STRING);
    map.insert("integer".to_string().to_string(), SchemaType::INTEGER);
    map.insert("number".to_string().to_string(), SchemaType::NUMBER);
    map.insert("boolean".to_string().to_string(), SchemaType::BOOLEAN);
    map.insert("array".to_string(), SchemaType::ARRAY);
    map.insert("object".to_string(), SchemaType::OBJECT);
    map.insert("null".to_string().to_string(), SchemaType::NULL);
    map };
    if true {
    return type_str.iter().cloned().map(| t | type_map.get(& t.to_lowercase()).cloned().unwrap_or(SchemaType::ANY)).collect::<Vec<_>>();
   
}
type_map.get(& type_str.to_lowercase()).cloned().unwrap_or(SchemaType::ANY)
}
#[doc = "Parse JSON Schema-like dict to Schema object."] #[doc = " Depyler: proven to terminate"] pub fn parse_schema(schema_dict: & std::collections::HashMap<String, String>) -> Result<Schema, Box<dyn std::error::Error>>{
    let mut schema = Schema::new();
    let _cse_temp_0 = schema_dict.get(STR_TYPE).is_some();
    if _cse_temp_0 {
    schema.schema_type = parse_type_str(schema_dict.get("type").cloned().unwrap_or_default());
   
}
let _cse_temp_1 = schema_dict.get("properties").is_some();
    if _cse_temp_1 {
    schema.properties = schema_dict.get("properties").cloned().unwrap_or_default().iter().map(|(k, v) |(k.clone(), v.clone())).collect::<Vec<_>>().into_iter().map(|(k, v) | {
    let _v = parse_schema(& v);
   (k, _v) }).collect::<std::collections::HashMap<_, _>>();
   
}
let _cse_temp_2 = schema_dict.get("required").is_some();
    if _cse_temp_2 {
    schema.required = schema_dict.get("required").cloned().unwrap_or_default();
   
}
let _cse_temp_3 = schema_dict.get("items").is_some();
    if _cse_temp_3 {
    schema.items = parse_schema(schema_dict.get("items").cloned().unwrap_or_default()) ?;
   
}
let _cse_temp_4 = schema_dict.get("minimum").is_some();
    if _cse_temp_4 {
    schema.minimum = schema_dict.get("minimum").cloned().unwrap_or_default();
   
}
let _cse_temp_5 = schema_dict.get("maximum").is_some();
    if _cse_temp_5 {
    schema.maximum = schema_dict.get("maximum").cloned().unwrap_or_default();
   
}
let _cse_temp_6 = schema_dict.get("minLength").is_some();
    if _cse_temp_6 {
    schema.min_length = schema_dict.get("minLength").cloned().unwrap_or_default();
   
}
let _cse_temp_7 = schema_dict.get("maxLength").is_some();
    if _cse_temp_7 {
    schema.max_length = schema_dict.get("maxLength").cloned().unwrap_or_default();
   
}
let _cse_temp_8 = schema_dict.get("minItems").is_some();
    if _cse_temp_8 {
    schema.min_items = schema_dict.get("minItems").cloned().unwrap_or_default();
   
}
let _cse_temp_9 = schema_dict.get("maxItems").is_some();
    if _cse_temp_9 {
    schema.max_items = schema_dict.get("maxItems").cloned().unwrap_or_default();
   
}
let _cse_temp_10 = schema_dict.get("pattern").is_some();
    if _cse_temp_10 {
    schema.pattern = schema_dict.get("pattern").cloned().unwrap_or_default();
   
}
let _cse_temp_11 = schema_dict.get("enum").is_some();
    if _cse_temp_11 {
    schema.enum = schema_dict.get("enum").cloned().unwrap_or_default();
   
}
let _cse_temp_12 = schema_dict.get("const").is_some();
    if _cse_temp_12 {
    schema.const = schema_dict.get("const").cloned().unwrap_or_default();
   
}
let _cse_temp_13 = schema_dict.get("additionalProperties").is_some();
    if _cse_temp_13 {
    schema.additional_properties = schema_dict.get("additionalProperties").cloned().unwrap_or_default();
   
}
let _cse_temp_14 = schema_dict.get("uniqueItems").is_some();
    if _cse_temp_14 {
    schema.unique_items = schema_dict.get("uniqueItems").cloned().unwrap_or_default();
   
}
Ok(schema)
}
#[doc = "Infer schema from data."] #[doc = " Depyler: proven to terminate"] pub fn infer_schema(data: & DepylerValue, strict: bool) -> Result<HashMap<String, DepylerValue>, Box<dyn std::error::Error>>{
    let mut result: std::collections::HashMap<String, String>= Default::default();
    if data.is_none() {
    return Ok({ let mut map = HashMap::new();
    map.insert(STR_TYPE.to_string(), DepylerValue::Str("null".to_string().to_string()));
    map });
   
}
if true {
    return Ok({ let mut map = HashMap::new();
    map.insert(STR_TYPE.to_string(), DepylerValue::Str("boolean".to_string().to_string()));
    map });
   
}
if true {
    return Ok({ let mut map = HashMap::new();
    map.insert(STR_TYPE.to_string(), DepylerValue::Str("integer".to_string().to_string()));
    map });
   
}
if true {
    return Ok({ let mut map = HashMap::new();
    map.insert(STR_TYPE.to_string(), DepylerValue::Str("number".to_string().to_string()));
    map });
...
if true {
    result = {
    let mut map = HashMap::new();
    map.insert(STR_TYPE.to_string(), DepylerValue::Str("string".to_string()));
    map };
    if strict {
    let _cse_temp_0 = data.len() as i32;
    result.insert("minLength".to_string(), DepylerValue::Str(format!("{:?}", _cse_temp_0)));
    result.insert("maxLength".to_string(), DepylerValue::Str(format!("{:?}", _cse_temp_0)));
...
if true {
    result = {
    let mut map = HashMap::new();
    map.insert(STR_TYPE.to_string(), DepylerValue::Str("array".to_string()));
    map };
    if strict {
    let _cse_temp_1 = data.len() as i32;
    result.insert("minItems".to_string(), DepylerValue::Str(format!("{:?}", _cse_temp_1)));
    result.insert("maxItems".to_string(), DepylerValue::Str(format!("{:?}", _cse_temp_1)));
   
}
if data {
    let item_schemas = data.as_slice().iter().cloned().map(| item | infer_schema(& item, strict)).collect::<Vec<_>>();
    if item_schemas.iter().cloned().map(| s | s == item_schemas.get(0usize).cloned().expect("IndexError: list index out of range")).all(| x | x) {
    result.insert("items".to_string(), DepylerValue::Str(format!("{:?}", item_schemas.get(0usize).cloned().expect("IndexError: list index out of range"))));
...
if true {
    result = {
    let mut map = HashMap::new();
    map.insert(STR_TYPE.to_string(), DepylerValue::Str("object".to_string()));
    map.insert("properties".to_string(), DepylerValue::Str(format!("{:?}", {
    let mut map = HashMap::new();
    map })));
    map };
    if strict {
    result.insert("required".to_string(), DepylerValue::Str(format!("{:?}", data.keys().cloned().collect::<Vec<_>>())));
    result.insert("additionalProperties".to_string(), DepylerValue::Str(format!("{:?}", false)));
   
}
for(key, value) in data.iter().map(|(k, v) |(k.clone(), v.clone())).collect::<Vec<_>>() {
    result.get_mut(& "properties").unwrap().insert(key.to_string().clone(), DepylerValue::Str(format!("{:?}", infer_schema(& value, strict) ?)));
...
#[doc = "Generate sample data from schema."] #[doc = " Depyler: proven to terminate"] pub fn generate_sample(schema: & Schema) -> Result<DepylerValue, Box<dyn std::error::Error>>{
    let mut schema_type: i32 = Default::default();
    let mut result: Vec<DepylerValue>= Default::default();
    if schema.r#const.is_some() {
    return Ok(schema.r#const);
   
}
if schema.r#enum {
    return Ok(schema.r#enum.get(0usize).cloned().expect("IndexError: list index out of range"));
   
}
schema_type = schema.schema_type;
    if true {
    schema_type = schema_type.get(0usize).cloned().expect("IndexError: list index out of range");
   
}
let _cse_temp_0 = schema_type == SchemaType::NULL;
    if _cse_temp_0 {
    return Ok(None);
...
if _cse_temp_0 {
    ...
    return Ok((schema.minimum) as i32);
...
if _cse_temp_0 {
    result = vec! [];
    let _cse_temp_1  = (schema.min_items) ||(0);
    let count = _cse_temp_1;
    if schema.items {
    for __sanitized in 0..(count) {
    result.push(DepylerValue::Str(format!("{:?}", generate_sample(schema.items))));
...
if _cse_temp_0 {
    ...
    map };
    for prop in schema.required {
    if schema.properties.get(& prop).is_some() {
    result.insert(prop.to_string().clone(), DepylerValue::Str(format!("{:?}", generate_sample(schema.properties.get(& DepylerValue::Int(prop as i64)).cloned().unwrap_or_default()) ?)));
...
#[doc = " Depyler: verified panic-free"] #[doc = " Depyler: proven to terminate"] pub fn main () -> Result <(), std::io::Error>{
    let mut schema: DepylerValue = Default::default();
   ();
   ();
   ();
   ();
   ();
    ...
    let _cse_temp_0 = matches!(args.command, Some(Commands::Validate {
  ..}));
    match & args.command {
    Some(Commands::Validate {
    ref data, ref schema,..}) =>{
    let mut f = std::fs::File::open(& data) ?;
    let mut data = std::collections::HashMap::<String, DepylerValue>::new();
    let mut f = std::fs::File::open(& schema) ?;
    let mut schema_dict = std::collections::HashMap::<String, DepylerValue>::new();
    schema = parse_schema(& schema_dict) ?;
    let errors = validate(& data, & schema, "");
    if! errors.is_empty() {
    for error in errors.iter().cloned() {
    eprintln!("{}", format!("Error at '{}': {}", error.path, error.message));
...
} let _cse_temp_1 = matches!(args.command, Some(Commands::Infer {
  ..}));
    match & args.command {
    Some(Commands::Infer {
    ref data, ref strict,..}) =>{
    ...
    let mut f = std::fs::File::open(& data) ?;
    let mut data = std::collections::HashMap::<String, DepylerValue>::new();
    schema = infer_schema(& data, strict) ?;
...
} let _cse_temp_2 = matches!(args.command, Some(Commands::Sample {
  ..}));
    match & args.command {
    ...
    let mut schema_dict = std::collections::HashMap::<String, DepylerValue>::new();
    schema = parse_schema(& schema_dict) ?;
    let sample = generate_sample(& schema) ?;
