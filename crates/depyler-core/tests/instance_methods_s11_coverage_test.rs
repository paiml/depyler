...
";
    ...
    assert!(
        ...
        "Should transpile 'in' for dict. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should transpile set.symmetric_difference. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should transpile set.issubset. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should transpile set.issuperset. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should transpile set.isdisjoint. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should transpile set.discard. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should transpile list.index. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should transpile list.count. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should transpile list.copy. Got: {result}"
    );
}
...
"#;
    ...
    assert!(
        ...
        "Should transpile re.compile/match. Got: {result}"
    );
}
...
"#;
    ...
    assert!(
        ...
        "Should transpile split+join chain. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should transpile strip+lower chain. Got: {result}"
    );
}
...
"#;
    ...
    assert!(
        ...
        "Should transpile upper+replace chain. Got: {result}"
    );
}
