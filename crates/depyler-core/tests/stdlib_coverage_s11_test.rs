...
";
    ...
    assert!(
        ...
        "Should transpile math.floor. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should transpile math.ceil. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should transpile math.sin. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should transpile math.cos. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should transpile math.log. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should transpile math.pow. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should transpile math.fabs. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should transpile lstrip. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should transpile rstrip. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should transpile upper. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should transpile lower. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should transpile isdigit. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should transpile isalpha. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should transpile dict.keys(). Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should transpile dict.values(). Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should transpile list.pop(). Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should transpile range with step. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should transpile zip. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should transpile class methods. Got: {result}"
    );
}
