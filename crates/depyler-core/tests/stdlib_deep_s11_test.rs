...
";
    ...
    assert!(
        ...
        "Should transpile math.log with base. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should transpile math.log2. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should transpile math.log10. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should transpile math.exp. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should transpile math.gcd. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should transpile math.tan. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should transpile math.atan. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should transpile math.atan2. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should transpile math.asin. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should transpile math.acos. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should transpile map/filter combo. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should transpile sorted with key. Got: {result}"
    );
}
...
";
    let result = transpile(code);
    assert!(result.contains("fn sort_desc"), "Should transpile sorted with reverse. Got: {result}");
}
...
";
    ...
    assert!(
        ...
        "Should transpile any with generator. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should transpile all with generator. Got: {result}"
    );
}
...
"#;
    ...
    assert!(
        ...
        "Should transpile dict.get with default. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should transpile list slice [start:end]. Got: {result}"
    );
}
...
";
    let result = transpile(code);
    assert!(result.contains("fn empty_dict"), "Should transpile dict() constructor. Got: {result}");
}
...
";
    ...
    assert!(
        ...
        "Should transpile negative literal. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should transpile float literal. Got: {result}"
    );
}
