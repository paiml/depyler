...
";
    ...
    assert!(rust_code.contains("fn pi"), "Should have pi function.\nGot:\n{rust_code}");
...
";
    ...
    assert!(rust_code.contains("fn add"), "Should have add function.\nGot:\n{rust_code}");
...
";
    ...
    assert!(rust_code.contains("fn multiply"), "Should have multiply function.\nGot:\n{rust_code}");

    assert!(rust_code.contains("fn subtract"), "Should have subtract function.\nGot:\n{rust_code}");
}
...
";
    ...
    assert!(rust_code.contains("fn double"), "Should have double function.\nGot:\n{rust_code}");
...
";
    ...
    assert!(rust_code.contains("fn get_count"), "Should have get_count method.\nGot:\n{rust_code}");
}
