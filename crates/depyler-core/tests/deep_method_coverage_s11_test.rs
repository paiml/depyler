...
"#;
    ...
    assert!(
        result.contains("starts_with") || result.contains("fn starts_with"),
        "Got: {}",
        result
    );
}
...
"#;
    let result = transpile(code);
    assert!(
        result.contains("ends_with") || result.contains("fn ends_with"),
        "Got: {}",
        result
    );
}
...
"#;
    let result = transpile(code);
    assert!(
        result.contains("find") || result.contains("fn locate"),
        "Got: {}",
        result
    );
}
...
"#;
    let result = transpile(code);
    assert!(
        result.contains("rfind") || result.contains("fn last_pos"),
        "Got: {}",
        result
    );
}
...
"#;
    let result = transpile(code);
    assert!(
        result.contains("fn must_find_last"),
        "Got: {}",
        result
    );
}
...
"#;
    let result = transpile(code);
    assert!(
        result.contains("split_whitespace") || result.contains("split"),
        "Got: {}",
        result
    );
}
...
"#;
    let result = transpile(code);
    assert!(
        result.contains("lines") || result.contains("split"),
        "Got: {}",
        result
    );
}
...
"#;
    let result = transpile(code);
    assert!(
        result.contains("fn first_three"),
        "Got: {}",
        result
    );
}
...
"#;
    let result = transpile(code);
    assert!(
        result.contains("insert") || result.contains("fn set_val"),
        "Got: {}",
        result
    );
}
...
"#;
    let result = transpile(code);
    assert!(
        result.contains("unwrap_or") || result.contains("get"),
        "Got: {}",
        result
    );
}
...
"#;
    let result = transpile(code);
    assert!(
        result.contains("extend") || result.contains("fn add_all"),
        "Got: {}",
        result
    );
}
...
"#;
    let result = transpile(code);
    assert!(
        result.contains("remove") || result.contains("fn remove_item"),
        "Got: {}",
        result
    );
}
...
"#;
    let result = transpile(code);
    assert!(
        result.contains("self.val") || result.contains("Obj"),
        "Got: {}",
        result
    );
}
...
"#;
    let result = transpile(code);
    assert!(
        result.contains("Counter") || result.contains("count"),
        "Got: {}",
        result
    );
}
...
"#;
    let result = transpile(code);
    assert!(
        result.contains("parse") || result.contains("fn parse_numbers"),
        "Got: {}",
        result
    );
}
...
"#;
    let result = transpile(code);
    assert!(
        result.contains("to_string") || result.contains("fn format_float"),
        "Got: {}",
        result
    );
}
...
"#;
    let result = transpile(code);
    assert!(
        result.contains("println") || result.contains("format!"),
        "Got: {}",
        result
    );
}
...
"#;
    let result = transpile(code);
    assert!(
        result.contains("is_some") || result.contains("fn is_present"),
        "Got: {}",
        result
    );
}
...
"#;
    let result = transpile(code);
    assert!(
        result.contains("is_none") || result.contains("fn is_empty"),
        "Got: {}",
        result
    );
}
...
"#;
    let result = transpile(code);
    assert!(
        result.contains("zip") || result.contains("fn combine"),
        "Got: {}",
        result
    );
}
...
"#;
    let result = transpile(code);
    assert!(
        result.contains("fn get_filename"),
        "Got: {}",
        result
    );
}
