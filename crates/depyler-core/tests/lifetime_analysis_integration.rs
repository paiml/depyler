use depyler_core::hir::{HirFunction, HirModule, HirStmt, HirExpr, Type, FunctionProperties, Literal, BinOp};
...
fn test_lifetime_inference_with_multiple_parameters() {
    ...
    let has_lifetimes = rust_code.contains("<'") || rust_code.contains("'a") || rust_code.contains("'b");
