...
";
    let result = transpile(code);
    assert!(result.contains("fn get_fn"), "Should transpile lambda with no params. Got: {result}");
}
...
";
    ...
    assert!(
        ...
        "Should transpile lambda with two params. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should transpile lambda with three params. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should transpile lambda as sort key. Got: {result}"
    );
}
...
"#;
    ...
    assert!(
        ...
        "Should transpile f-string with no expressions. Got: {result}"
    );
}
...
"#;
    ...
    assert!(
        ...
        "Should transpile multi-expression f-string. Got: {result}"
    );
}
...
"#;
    ...
    assert!(
        ...
        "Should transpile f-string with computation. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should transpile ternary with function call. Got: {result}"
    );
}
...
"#;
    ...
    assert!(
        ...
        "Should transpile mixed regular and varargs. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should transpile compound assert. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should transpile raise RuntimeError. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should transpile startswith. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should transpile endswith. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should transpile str.replace. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should transpile str.find. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should transpile str.count. Got: {result}"
    );
}
...
"#;
    ...
    assert!(
        ...
        "Should transpile str.join. Got: {result}"
    );
}
...
"#;
    ...
    assert!(
        ...
        "Should transpile str.split with delimiter. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should transpile module constant. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should transpile float to int. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should transpile int to float. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should transpile str to int. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should transpile int to str. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should transpile bitwise XOR. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should transpile left shift. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should transpile right shift. Got: {result}"
    );
}
