...
";
    ...
    assert!(
        ...
        "math.pi should map to std::f64::consts::PI, got: {rust}"
    );
}
...
";
    ...
    assert!(
        ...
        "math.e should map to std::f64::consts::E, got: {rust}"
    );
}
...
";
    ...
    assert!(
        ...
        "math.tau should map to std::f64::consts::TAU, got: {rust}"
    );
}
...
";
    ...
    assert!(!rust.contains("extern crate math"), "NASA mode should not extern crate math: {rust}");
