...
";
    let result = transpile(code);
    assert!(result.contains("fn not_equal"), "Should transpile not with comparison. Got: {result}");
}
...
"#;
    ...
    assert!(
        ...
        "Should transpile 'in' with list literal. Got: {result}"
    );
}
...
";
    let result = transpile(code);
    assert!(result.contains("fn no_digit"), "Should transpile 'not in' with string. Got: {result}");
}
...
";
    ...
    assert!(
        ...
        "Should transpile 'in dict'. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should transpile 'in set'. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should transpile ternary. Got: {result}"
    );
}
...
"#;
    let result = transpile(code);
    assert!(result.contains("fn categorize"), "Should transpile ternary assignment. Got: {result}");
}
...
"#;
    let result = transpile(code);
    assert!(result.contains("format!"), "Should use format! for multi-var f-string. Got: {result}");
}
...
"#;
    ...
    assert!(
        ...
        "Should transpile f-string with method call. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should transpile unary minus. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should transpile unary not. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should transpile bitwise and. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should transpile bitwise or. Got: {result}"
    );
}
...
"#;
    ...
    assert!(
        ...
        "Should transpile dict literal. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should transpile nested list. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should transpile reversed(). Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should transpile int(str). Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should transpile float(str). Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should transpile list(range()). Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should transpile floor div. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should transpile power. Got: {result}"
    );
}
...
"#;
    ...
    assert!(
        ...
        "Should transpile .format(). Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should transpile sum(generator). Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should transpile any(generator). Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should transpile all(generator). Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should transpile sorted with lambda. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should transpile map with lambda. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should transpile filter with lambda. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should transpile complex bool. Got: {result}"
    );
}
