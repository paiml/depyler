...
"#;
    let result = transpile(code);
    assert!(result.contains("fn clean_whitespace"), "Should transpile compiled sub. Got: {result}");
}
...
"#;
    ...
    assert!(
        ...
        "Should transpile compiled split. Got: {result}"
    );
}
...
";
    let result = transpile(code);
    assert!(result.contains("fn read_line"), "Should transpile sys.stdin.readline. Got: {result}");
}
...
";
    ...
    assert!(
        ...
        "Should transpile sys.stdin.readlines. Got: {result}"
    );
}
...
"#;
    ...
    assert!(
        ...
        "Should transpile email validator regex. Got: {result}"
    );
}
...
"#;
    ...
    assert!(
        ...
        "Should transpile regex replace chain. Got: {result}"
    );
}
...
"#;
    ...
    assert!(
        ...
        "Should transpile regex extract with conversion. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should transpile center without fillchar. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should transpile ljust without fillchar. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should transpile rjust without fillchar. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should transpile dict.get without default. Got: {result}"
    );
}
...
";
    let result = transpile(code);
    assert!(result.contains("fn take"), "Should transpile dict.pop without default. Got: {result}");
}
