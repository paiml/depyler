...
";
    ...
    assert!(
        ...
        "Should transpile sin/cos. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should transpile os.path.join. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should transpile os.path.exists. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should transpile str.isdigit. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should transpile str.isalpha. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should transpile range(). Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should transpile sum(). Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should transpile any(). Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should transpile all(). Got: {result}"
    );
}
