...
";
    ...
    assert!(
        ...
        "Should transpile float floor division. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should transpile negative floor division. Got: {result}"
    );
}
...
"#;
    let result = transpile(code);
    assert!(result.contains("fn fmt_str"), "Should transpile string format with %. Got: {result}");
}
...
";
    ...
    assert!(
        ...
        "Should transpile set comprehension. Got: {result}"
    );
}
...
";
    let result = transpile(code);
    assert!(result.contains("fn index_map"), "Should transpile dict comprehension. Got: {result}");
}
...
";
    let result = transpile(code);
    assert!(result.contains("fn flatten"), "Should transpile nested comprehension. Got: {result}");
}
...
";
    let result = transpile(code);
    assert!(result.contains("fn evens"), "Should transpile filtered comprehension. Got: {result}");
}
...
"#;
    ...
    assert!(
        ...
        "Should transpile f-string format spec. Got: {result}"
    );
}
...
";
    let result = transpile(code);
    assert!(result.contains("fn to_tuple"), "Should transpile tuple() constructor. Got: {result}");
}
...
"#;
    let result = transpile(code);
    assert!(result.contains("fn make_dict"), "Should transpile dict() constructor. Got: {result}");
}
...
";
    let result = transpile(code);
    assert!(result.contains("fn sum_squares"), "Should transpile generator in sum. Got: {result}");
}
...
";
    let result = transpile(code);
    assert!(result.contains("fn has_positive"), "Should transpile generator in any. Got: {result}");
}
...
";
    let result = transpile(code);
    assert!(result.contains("fn all_positive"), "Should transpile generator in all. Got: {result}");
}
...
"#;
    ...
    assert!(
        ...
        "Should transpile literal string multiply. Got: {result}"
    );
}
