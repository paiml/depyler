...
";
    ...
    assert!(
        ...
        "Should apply string truthiness. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should apply list truthiness. Got: {result}"
    );
}
...
";
    ...
    assert!(
        result.contains("is_empty") || result.contains("name"),
        "Should apply negated string truthiness. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should apply negated int truthiness. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should handle unused loop var. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should handle reassigned loop var. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should unpack tuple in for loop. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should handle unused first in tuple. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should produce vec literal. Got: {result}"
    );
}
...
"#;
    ...
    assert!(
        ...
        "Should produce string vec. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should produce float vec. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should handle dict index assignment. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should handle file iteration. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should handle csv reader iteration. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should handle dict type. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should handle Optional type. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should handle Tuple return type. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should handle None check pattern. Got: {result}"
    );
}
...
"#;
    ...
    assert!(
        ...
        "Should not add truthiness conversion for bool. Got: {func_body}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should handle float truthiness. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should handle Set type annotation. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should handle range iteration. Got: {result}"
    );
}
...
";
    ...
    assert!(
        result.contains("vec!") || result.contains("Vec"),
        "Should handle empty list. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should handle empty dict. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should handle custom type. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should handle list comprehension. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should handle dict comprehension. Got: {result}"
    );
}
