...
";
    ...
    assert!(
        ...
        "Should type List[int]. Got: {result}"
    );
}
...
"#;
    ...
    assert!(
        ...
        "Should type List[str]. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should type List[float]. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should type Dict[str, int]. Got: {result}"
    );
}
...
"#;
    ...
    assert!(
        ...
        "Should type Dict[str, str]. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should type Set[int]. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should type Optional[str]. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should type Optional[int]. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should infer int type. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should infer float type. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should infer bool type. Got: {result}"
    );
}
...
"#;
    ...
    assert!(
        ...
        "Should infer string type. Got: {result}"
    );
}
...
";
    ...
    assert!(
        ...
        "Should handle int+float. Got: {result}"
    );
}
...
";
    let result = transpile(code);
    assert!(result.contains("fn make_pairs"), "Should handle List[Tuple[int,int]]. Got: {result}");
}
