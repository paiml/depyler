...
mod tests {
    ...
    fn test_w10ac_assign_simple_int() {
        ...
        assert!(result.contains("x") || !result.is_empty());
    }
    ...
    fn test_w10ac_assign_simple_string() {
        ...
        let result = transpile(code);
        assert!(result.contains("name") || !result.is_empty());
    }
    ...
    fn test_w10ac_assign_simple_float() {
        let code = "pi = 3.14159";
        let result = transpile(code);
        assert!(result.contains("pi") || !result.is_empty());
    }
    ...
    fn test_w10ac_assign_simple_bool() {
        let code = "flag = True";
        let result = transpile(code);
        assert!(result.contains("flag") || !result.is_empty());
    }
    ...
    fn test_w10ac_assign_multiple_same_value() {
        let code = "x = y = 5";
        let result = transpile(code);
        assert!(result.contains("x") || result.contains("y") || !result.is_empty());
    }
    ...
    fn test_w10ac_assign_multiple_chain() {
        let code = "a = b = c = 10";
        let result = transpile(code);
        assert!(result.contains("a") || result.contains("b") || !result.is_empty());
    }
    ...
    fn test_w10ac_assign_starred_unpack_middle() {
        ...
        let result = transpile(code);
        assert!(result.contains("first") || result.contains("middle") || !result.is_empty());
    }
    ...
    fn test_w10ac_assign_starred_unpack_end() {
        ...
        let result = transpile(code);
        assert!(result.contains("a") || result.contains("tail") || !result.is_empty());
    }
    ...
    fn test_w10ac_assign_nested_unpack_deep() {
        ...
        let result = transpile(code);
        assert!(result.contains("a") || result.contains("c") || !result.is_empty());
    }
    ...
    fn test_w10ac_assign_nested_unpack_triple() {
        ...
        let result = transpile(code);
        assert!(result.contains("x") || result.contains("z") || !result.is_empty());
    }
    ...
    fn test_w10ac_assign_augmented_sub() {
        let code = "y = 10\ny -= 2";
        let result = transpile(code);
        assert!(result.contains("y") || !result.is_empty());
    }
    ...
    fn test_w10ac_assign_augmented_mul() {
        let code = "z = 4\nz *= 3";
        let result = transpile(code);
        assert!(result.contains("z") || !result.is_empty());
    }
    ...
    fn test_w10ac_assign_augmented_div() {
        let code = "a = 20\na /= 4";
        let result = transpile(code);
        assert!(result.contains("a") || !result.is_empty());
    }
    ...
    fn test_w10ac_assign_augmented_floordiv() {
        let code = "b = 17\nb //= 3";
        let result = transpile(code);
        assert!(result.contains("b") || !result.is_empty());
    }
    ...
    fn test_w10ac_assign_augmented_mod() {
        let code = "c = 17\nc %= 5";
        let result = transpile(code);
        assert!(result.contains("c") || !result.is_empty());
    }
    ...
    fn test_w10ac_assign_augmented_pow() {
        let code = "d = 2\nd **= 8";
        let result = transpile(code);
        assert!(result.contains("d") || !result.is_empty());
    }
    ...
    fn test_w10ac_assign_augmented_bitand() {
        let code = "e = 12\ne &= 7";
        let result = transpile(code);
        assert!(result.contains("e") || !result.is_empty());
    }
    ...
    fn test_w10ac_assign_augmented_bitor() {
        let code = "f = 5\nf |= 3";
        let result = transpile(code);
        assert!(result.contains("f") || !result.is_empty());
    }
    ...
    fn test_w10ac_assign_augmented_bitxor() {
        let code = "g = 10\ng ^= 6";
        let result = transpile(code);
        assert!(result.contains("g") || !result.is_empty());
    }
    ...
    fn test_w10ac_assign_augmented_lshift() {
        let code = "h = 3\nh <<= 2";
        let result = transpile(code);
        assert!(result.contains("h") || !result.is_empty());
    }
    ...
    fn test_w10ac_assign_augmented_rshift() {
        let code = "i = 32\ni >>= 2";
        let result = transpile(code);
        assert!(result.contains("i") || !result.is_empty());
    }
    ...
    fn test_w10ac_assign_type_annotated_int() {
        let code = "x: int = 5";
        let result = transpile(code);
        assert!(result.contains("x") || result.contains("i32") || !result.is_empty());
    }
    ...
    fn test_w10ac_assign_type_annotated_str() {
        ...
        let result = transpile(code);
        assert!(result.contains("name") || result.contains("String") || !result.is_empty());
    }
    ...
    fn test_w10ac_assign_type_annotated_list() {
        ...
        let result = transpile(code);
        assert!(result.contains("items") || result.contains("Vec") || !result.is_empty());
    }
    ...
    fn test_w10ac_assign_walrus_if() {
        let code = "if (n := 5) > 3:\n    pass";
        let result = transpile(code);
        assert!(result.contains("n") || result.contains("if") || !result.is_empty());
    }
    ...
    fn test_w10ac_assign_walrus_while() {
        ...
        let result = transpile(code);
        assert!(result.contains("line") || result.contains("while") || !result.is_empty());
    }
    ...
    fn test_w10ac_assign_chained_method_call() {
        ...
        let result = transpile(code);
        assert!(result.contains("x") || result.contains("obj") || !result.is_empty());
    }
    ...
    fn test_w10ac_assign_from_function_call() {
        let code = "def f():\n    return 5\nresult = f()";
        let result = transpile(code);
        assert!(result.contains("result") || result.contains("f") || !result.is_empty());
    }
    ...
    fn test_w10ac_assign_from_builtin() {
        ...
        let result = transpile(code);
        assert!(result.contains("length") || result.contains("len") || !result.is_empty());
    }
    ...
    fn test_w10ac_assign_from_ternary() {
        ...
        let result = transpile(code);
        assert!(result.contains("x") || result.contains("if") || !result.is_empty());
    }
    ...
    fn test_w10ac_assign_from_ternary_complex() {
        ...
        let result = transpile(code);
        assert!(result.contains("result") || !result.is_empty());
    }
    ...
    fn test_w10ac_assign_destructure_mixed() {
        let code = "(a, [b, c]), d = ((1, [2, 3]), 4)";
        let result = transpile(code);
        assert!(result.contains("a") || result.contains("d") || !result.is_empty());
    }
    ...
    fn test_w10ac_assign_to_class_field() {
        let code = "class C:\n    def __init__(self):\n        self.x = 5";
        let result = transpile(code);
        assert!(result.contains("self") || result.contains("x") || !result.is_empty());
    }
    ...
    fn test_w10ac_assign_list_literal() {
        ...
        let result = transpile(code);
        assert!(result.contains("nums") || !result.is_empty());
    }
    ...
    fn test_w10ac_assign_dict_literal() {
        ...
        let result = transpile(code);
        assert!(result.contains("data") || !result.is_empty());
    }
    ...
    fn test_w10ac_assign_set_literal() {
        ...
        let result = transpile(code);
        assert!(result.contains("unique") || !result.is_empty());
    }
    ...
    fn test_w10ac_assign_tuple_literal() {
        ...
        let result = transpile(code);
        assert!(result.contains("coords") || !result.is_empty());
    }
    ...
    fn test_w10ac_assign_comprehension_list() {
        ...
        let result = transpile(code);
        assert!(result.contains("squares") || !result.is_empty());
    }
    ...
    fn test_w10ac_assign_comprehension_dict() {
        ...
        let result = transpile(code);
        assert!(result.contains("sq_dict") || !result.is_empty());
    }
    ...
    fn test_w10ac_assign_slice() {
        ...
        let result = transpile(code);
        assert!(result.contains("part") || !result.is_empty());
    }
    ...
    fn test_w10ac_control_if_simple() {
        let code = "if True:\n    pass";
        let result = transpile(code);
        assert!(result.contains("if") || !result.is_empty());
    }
    ...
    fn test_w10ac_control_if_else() {
        let code = "if False:\n    pass\nelse:\n    pass";
        let result = transpile(code);
        assert!(result.contains("if") || result.contains("else") || !result.is_empty());
    }
    ...
    fn test_w10ac_control_if_elif() {
        let code = "if x == 1:\n    pass\nelif x == 2:\n    pass";
        let result = transpile(code);
        assert!(result.contains("if") || result.contains("elif") || !result.is_empty());
    }
    ...
    fn test_w10ac_control_while_simple() {
        let code = "while True:\n    break";
        let result = transpile(code);
        assert!(result.contains("while") || result.contains("break") || !result.is_empty());
    }
    ...
    fn test_w10ac_control_while_with_condition() {
        let code = "x = 5\nwhile x > 0:\n    x -= 1";
        let result = transpile(code);
        assert!(result.contains("while") || !result.is_empty());
    }
    ...
    fn test_w10ac_control_while_break() {
        let code = "while True:\n    break";
        let result = transpile(code);
        assert!(result.contains("break") || !result.is_empty());
    }
    ...
    fn test_w10ac_control_while_continue() {
        let code = "x = 0\nwhile x < 10:\n    x += 1\n    continue";
        let result = transpile(code);
        assert!(result.contains("continue") || !result.is_empty());
    }
    ...
    fn test_w10ac_control_while_break_continue() {
        let code = "while True:\n    if cond:\n        break\n    continue";
        let result = transpile(code);
        assert!(result.contains("break") || result.contains("continue") || !result.is_empty());
    }
    ...
    fn test_w10ac_control_for_range() {
        ...
        let result = transpile(code);
        assert!(result.contains("for") || result.contains("range") || !result.is_empty());
    }
    ...
    fn test_w10ac_control_for_list() {
        ...
        let result = transpile(code);
        assert!(result.contains("for") || !result.is_empty());
    }
    ...
    fn test_w10ac_control_for_zip() {
        ...
        let result = transpile(code);
        assert!(result.contains("zip") || !result.is_empty());
    }
    ...
    fn test_w10ac_control_for_range_step() {
        ...
        let result = transpile(code);
        assert!(result.contains("range") || !result.is_empty());
    }
    ...
    fn test_w10ac_control_try_except_basic() {
        let code = "try:\n    pass\nexcept:\n    pass";
        let result = transpile(code);
        assert!(result.contains("try") || result.contains("except") || !result.is_empty());
    }
    ...
    fn test_w10ac_control_try_except_type() {
        let code = "try:\n    pass\nexcept ValueError:\n    pass";
        let result = transpile(code);
        assert!(result.contains("ValueError") || !result.is_empty());
    }
    ...
    fn test_w10ac_control_try_except_else() {
        let code = "try:\n    pass\nexcept:\n    pass\nelse:\n    pass";
        let result = transpile(code);
        assert!(result.contains("else") || !result.is_empty());
    }
    ...
    fn test_w10ac_control_try_except_finally() {
        let code = "try:\n    pass\nexcept:\n    pass\nfinally:\n    pass";
        let result = transpile(code);
        assert!(result.contains("finally") || !result.is_empty());
    }
    ...
    fn test_w10ac_control_try_full_form() {
        let code =
            "try:\n    pass\nexcept ValueError:\n    pass\nelse:\n    pass\nfinally:\n    pass";
        let result = transpile(code);
        assert!(result.contains("try") || !result.is_empty());
    }
    ...
    fn test_w10ac_control_with_statement() {
        ...
        let result = transpile(code);
        assert!(result.contains("with") || result.contains("open") || !result.is_empty());
    }
    ...
    fn test_w10ac_control_with_multiple() {
        ...
        let result = transpile(code);
        assert!(result.contains("f1") || result.contains("f2") || !result.is_empty());
    }
    ...
    fn test_w10ac_control_match_simple() {
        let code = "match x:\n    case 1:\n        pass";
        let result = transpile(code);
        assert!(result.contains("match") || result.contains("case") || !result.is_empty());
    }
    ...
    fn test_w10ac_control_match_multiple_cases() {
        let code = "match x:\n    case 1:\n        pass\n    case 2:\n        pass\n    case _:\n        pass";
        let result = transpile(code);
        assert!(result.contains("match") || !result.is_empty());
    }
    ...
    fn test_w10ac_func_with_param() {
        let code = "def add(x):\n    return x + 1";
        let result = transpile(code);
        assert!(result.contains("add") || !result.is_empty());
    }
    ...
    fn test_w10ac_func_with_default() {
        ...
        let result = transpile(code);
        assert!(result.contains("greet") || !result.is_empty());
    }
    ...
    fn test_w10ac_func_with_args() {
        let code = "def f(*args):\n    return args";
        let result = transpile(code);
        assert!(result.contains("args") || !result.is_empty());
    }
    ...
    fn test_w10ac_func_with_kwargs() {
        ...
        let result = transpile(code);
        assert!(result.contains("kwargs") || !result.is_empty());
    }
    ...
    fn test_w10ac_func_with_args_kwargs() {
        ...
        let result = transpile(code);
        assert!(result.contains("args") || result.contains("kwargs") || !result.is_empty());
    }
    ...
    fn test_w10ac_func_recursive_factorial() {
        let code = "def fact(n):\n    if n <= 1:\n        return 1\n    return n * fact(n-1)";
        let result = transpile(code);
        assert!(result.contains("fact") || !result.is_empty());
    }
    ...
    fn test_w10ac_func_recursive_fibonacci() {
        ...
        let result = transpile(code);
        assert!(result.contains("fib") || !result.is_empty());
    }
    ...
    fn test_w10ac_func_multiple_returns() {
        let code = "def f(x):\n    if x > 0:\n        return 1\n    elif x < 0:\n        return -1\n    return 0";
        let result = transpile(code);
        assert!(result.contains("return") || !result.is_empty());
    }
    ...
    fn test_w10ac_func_return_none_explicit() {
        let code = "def f():\n    return None";
        let result = transpile(code);
        assert!(result.contains("None") || !result.is_empty());
    }
    ...
    fn test_w10ac_func_generator_simple() {
        let code = "def gen():\n    yield 1";
        let result = transpile(code);
        assert!(result.contains("yield") || !result.is_empty());
    }
    ...
    fn test_w10ac_func_with_decorator() {
        let code = "@decorator\ndef f():\n    pass";
        let result = transpile(code);
        assert!(result.contains("f") || result.contains("decorator") || !result.is_empty());
    }
    ...
    fn test_w10ac_func_with_multiple_decorators() {
        let code = "@dec1\n@dec2\ndef f():\n    pass";
        let result = transpile(code);
        assert!(result.contains("dec1") || result.contains("dec2") || !result.is_empty());
    }
    ...
    fn test_w10ac_func_lambda_simple() {
        ...
        let result = transpile(code);
        assert!(result.contains("lambda") || !result.is_empty());
    }
    ...
    fn test_w10ac_func_nested_simple() {
        let code = "def outer():\n    def inner():\n        return 5\n    return inner()";
        let result = transpile(code);
        assert!(result.contains("inner") || result.contains("outer") || !result.is_empty());
    }
    ...
    fn test_w10ac_func_nested_with_closure() {
        ...
        let result = transpile(code);
        assert!(result.contains("inner") || !result.is_empty());
    }
    ...
    fn test_w10ac_func_nested_closure_modify() {
        let code = "def outer(x):\n    def inner():\n        nonlocal x\n        x += 1\n        return x\n    return inner()";
        let result = transpile(code);
        assert!(result.contains("nonlocal") || !result.is_empty());
    }
    ...
    fn test_w10ac_func_async_def() {
        ...
        let result = transpile(code);
        assert!(result.contains("async") || !result.is_empty());
    }
    ...
    fn test_w10ac_func_async_with_await() {
        let code = "async def f():\n    await other()";
        let result = transpile(code);
        assert!(result.contains("async") || result.contains("await") || !result.is_empty());
    }
    ...
    return 5"#;
        let result = transpile(code);
        assert!(result.contains("docstring") || result.contains("f") || !result.is_empty());
    }
    ...
    fn test_w10ac_func_with_type_hints() {
        ...
        let result = transpile(code);
        assert!(result.contains("f") || result.contains("i32") || !result.is_empty());
    }
    ...
    fn test_w10ac_class_with_init() {
        let code = "class C:\n    def __init__(self):\n        pass";
        let result = transpile(code);
        assert!(result.contains("__init__") || result.contains("C") || !result.is_empty());
    }
    ...
    fn test_w10ac_class_multiple_methods() {
        let code = "class C:\n    def m1(self):\n        pass\n    def m2(self):\n        pass";
        let result = transpile(code);
        assert!(result.contains("m1") || result.contains("m2") || !result.is_empty());
    }
    ...
    fn test_w10ac_class_with_str() {
        let code = "class C:\n    def __str__(self):\n        return 'C'";
        let result = transpile(code);
        assert!(result.contains("__str__") || !result.is_empty());
    }
    ...
    fn test_w10ac_class_with_repr() {
        let code = "class C:\n    def __repr__(self):\n        return 'C()'";
        let result = transpile(code);
        assert!(result.contains("__repr__") || !result.is_empty());
    }
    ...
    fn test_w10ac_class_str_and_repr() {
        let code = "class C:\n    def __str__(self):\n        return 'C'\n    def __repr__(self):\n        return 'C()'";
        let result = transpile(code);
        assert!(result.contains("__str__") || result.contains("__repr__") || !result.is_empty());
    }
    ...
    fn test_w10ac_class_with_eq() {
        ...
        let result = transpile(code);
        assert!(result.contains("__eq__") || !result.is_empty());
    }
    ...
    fn test_w10ac_class_with_lt() {
        ...
        let result = transpile(code);
        assert!(result.contains("__lt__") || !result.is_empty());
    }
    ...
    fn test_w10ac_class_with_le() {
        ...
        let result = transpile(code);
        assert!(result.contains("__le__") || !result.is_empty());
    }
    ...
    fn test_w10ac_class_with_gt() {
        ...
        let result = transpile(code);
        assert!(result.contains("__gt__") || !result.is_empty());
    }
    ...
    fn test_w10ac_class_with_ge() {
        ...
        let result = transpile(code);
        assert!(result.contains("__ge__") || !result.is_empty());
    }
    ...
    fn test_w10ac_class_all_comparisons() {
        let code = "class C:\n    def __eq__(self, o):\n        return True\n    def __lt__(self, o):\n        return False";
        let result = transpile(code);
        assert!(result.contains("__eq__") || result.contains("__lt__") || !result.is_empty());
    }
    ...
    fn test_w10ac_class_with_add() {
        ...
        let result = transpile(code);
        assert!(result.contains("__add__") || !result.is_empty());
    }
    ...
    fn test_w10ac_class_with_sub() {
        ...
        let result = transpile(code);
        assert!(result.contains("__sub__") || !result.is_empty());
    }
    ...
    fn test_w10ac_class_with_mul() {
        ...
        let result = transpile(code);
        assert!(result.contains("__mul__") || !result.is_empty());
    }
    ...
    fn test_w10ac_class_with_truediv() {
        ...
        let result = transpile(code);
        assert!(result.contains("__truediv__") || !result.is_empty());
    }
    ...
    fn test_w10ac_class_arithmetic_ops() {
        let code = "class C:\n    def __add__(self, o):\n        return self\n    def __mul__(self, o):\n        return self";
        let result = transpile(code);
        assert!(result.contains("__add__") || result.contains("__mul__") || !result.is_empty());
    }
    ...
    fn test_w10ac_class_with_contains() {
        ...
        let result = transpile(code);
        assert!(result.contains("__contains__") || !result.is_empty());
    }
    ...
    fn test_w10ac_class_with_iter() {
        let code = "class C:\n    def __iter__(self):\n        return self";
        let result = transpile(code);
        assert!(result.contains("__iter__") || !result.is_empty());
    }
    ...
    fn test_w10ac_class_with_next() {
        let code = "class C:\n    def __next__(self):\n        raise StopIteration";
        let result = transpile(code);
        assert!(result.contains("__next__") || !result.is_empty());
    }
    ...
    fn test_w10ac_class_iterator() {
        let code = "class C:\n    def __iter__(self):\n        return self\n    def __next__(self):\n        raise StopIteration";
        let result = transpile(code);
        assert!(result.contains("__iter__") || result.contains("__next__") || !result.is_empty());
    }
    ...
    fn test_w10ac_class_with_len() {
        let code = "class C:\n    def __len__(self):\n        return 0";
        let result = transpile(code);
        assert!(result.contains("__len__") || !result.is_empty());
    }
    ...
    fn test_w10ac_class_with_getitem() {
        ...
        let result = transpile(code);
        assert!(result.contains("__getitem__") || !result.is_empty());
    }
    ...
    fn test_w10ac_class_with_setitem() {
        ...
        let result = transpile(code);
        assert!(result.contains("__setitem__") || !result.is_empty());
    }
    ...
    fn test_w10ac_class_container_protocol() {
        ...
        let result = transpile(code);
        assert!(result.contains("__len__") || result.contains("__getitem__") || !result.is_empty());
    }
    ...
    fn test_w10ac_class_with_classmethod() {
        let code = "class C:\n    @classmethod\n    def f(cls):\n        return cls";
        let result = transpile(code);
        assert!(result.contains("classmethod") || !result.is_empty());
    }
    ...
    fn test_w10ac_class_with_staticmethod() {
        let code = "class C:\n    @staticmethod\n    def f():\n        return 5";
        let result = transpile(code);
        assert!(result.contains("staticmethod") || !result.is_empty());
    }
    ...
    fn test_w10ac_class_inheritance_simple() {
        let code = "class Base:\n    pass\nclass Derived(Base):\n    pass";
        let result = transpile(code);
        assert!(result.contains("Base") || result.contains("Derived") || !result.is_empty());
    }
    ...
    fn test_w10ac_class_inheritance_with_super() {
        let code = "class Base:\n    def __init__(self):\n        pass\nclass Derived(Base):\n    def __init__(self):\n        super().__init__()";
        let result = transpile(code);
        assert!(result.contains("super") || !result.is_empty());
    }
    ...
    fn test_w10ac_class_with_enter_exit() {
        ...
        let result = transpile(code);
        assert!(result.contains("__enter__") || result.contains("__exit__") || !result.is_empty());
    }
    ...
    fn test_w10ac_class_context_manager_full() {
        ...
        let result = transpile(code);
        assert!(result.contains("__enter__") || !result.is_empty());
    }
    ...
    fn test_w10ac_class_with_property() {
        let code = "class C:\n    @property\n    def x(self):\n        return 5";
        let result = transpile(code);
        assert!(result.contains("property") || !result.is_empty());
    }
    ...
    fn test_w10ac_class_with_setter() {
        let code = "class C:\n    @property\n    def x(self):\n        return 5\n    @x.setter\n    def x(self, val):\n        pass";
        let result = transpile(code);
        assert!(result.contains("property") || result.contains("setter") || !result.is_empty());
    }
    ...
    fn test_w10ac_except_raise_valueerror() {
        ...
        let result = transpile(code);
        assert!(result.contains("ValueError") || result.contains("raise") || !result.is_empty());
    }
    ...
    fn test_w10ac_except_raise_typeerror() {
        ...
        let result = transpile(code);
        assert!(result.contains("TypeError") || !result.is_empty());
    }
    ...
    fn test_w10ac_except_raise_keyerror() {
        ...
        let result = transpile(code);
        assert!(result.contains("KeyError") || !result.is_empty());
    }
    ...
    fn test_w10ac_except_raise_indexerror() {
        ...
        let result = transpile(code);
        assert!(result.contains("IndexError") || !result.is_empty());
    }
    ...
    fn test_w10ac_except_raise_custom() {
        ...
        let result = transpile(code);
        assert!(result.contains("MyError") || !result.is_empty());
    }
    ...
    fn test_w10ac_except_raise_from() {
        ...
        let result = transpile(code);
        assert!(result.contains("from") || !result.is_empty());
    }
    ...
    fn test_w10ac_except_bare() {
        let code = "try:\n    pass\nexcept:\n    pass";
        let result = transpile(code);
        assert!(result.contains("except") || !result.is_empty());
    }
    ...
    fn test_w10ac_except_reraise() {
        let code = "try:\n    pass\nexcept ValueError:\n    raise";
        let result = transpile(code);
        assert!(result.contains("raise") || !result.is_empty());
    }
    ...
    fn test_w10ac_except_custom_class() {
        let code = "class MyError(Exception):\n    pass";
        let result = transpile(code);
        assert!(result.contains("MyError") || result.contains("Exception") || !result.is_empty());
    }
    ...
    fn test_w10ac_except_custom_with_attributes() {
        ...
        let result = transpile(code);
        assert!(result.contains("code") || result.contains("msg") || !result.is_empty());
    }
    ...
    fn test_w10ac_except_multiple_with_as() {
        ...
        let result = transpile(code);
        assert!(result.contains("e1") || result.contains("e2") || !result.is_empty());
    }
    ...
    fn test_w10ac_except_custom_inherit_valueerror() {
        ...
        let result = transpile(code);
        assert!(result.contains("MyError") || result.contains("ValueError") || !result.is_empty());
    }
    ...
    fn test_w10ac_except_exception_group() {
        ...
        let result = transpile(code);
        assert!(result.contains("MyErrorGroup") || !result.is_empty());
    }
}
