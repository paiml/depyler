...
fn apply_string_replacements(code: String) -> String {
    code.replace(" ; ", ";\n    ")
        ...
        .replace("panic !", "panic!")
        .replace("vec !", "vec!")
        .replace("eprintln !", "eprintln!")
        .replace("write !", "write!")
        .replace("writeln !", "writeln!")
        .replace("assert !", "assert!")
        .replace("assert_eq !", "assert_eq!")
        .replace("debug !", "debug!")
        .replace("todo !", "todo!")
        .replace("unimplemented !", "unimplemented!")
...
mod tests {
    ...
    fn test_apply_string_replacements_macros() {
        let test_cases =
            vec![("println !", "println!"), ("vec !", "vec!"), ("format !", "format!")];
    ...
    fn test_property_replacement_idempotency() {
        ...
        for input in inputs {
            ...
            assert_eq!(once, twice, "Replacements should be idempotent for '{}'", input);
        }
    }
