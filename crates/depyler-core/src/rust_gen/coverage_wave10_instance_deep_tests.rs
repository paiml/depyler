...
"#;
        let result = transpile(py);
        assert!(result.contains("setdefault") || !result.is_empty());
    }
...
"#;
        let result = transpile(py);
        assert!(result.contains("popitem") || !result.is_empty());
    }
...
"#;
        let result = transpile(py);
        assert!(result.contains("update") || !result.is_empty());
    }
...
"#;
        let result = transpile(py);
        assert!(result.contains("items") || !result.is_empty());
    }
...
"#;
        let result = transpile(py);
        assert!(result.contains("copy") || result.contains("clone") || !result.is_empty());
    }
...
";
        let result = transpile(py);
        assert!(result.contains("add") || result.contains("insert") || !result.is_empty());
    }
...
";
        let result = transpile(py);
        assert!(result.contains("discard") || result.contains("remove") || !result.is_empty());
    }
...
";
        let result = transpile(py);
        assert!(result.contains("issubset") || result.contains("is_subset") || !result.is_empty());
    }
...
";
        let result = transpile(py);
        assert!(
            result.contains("issuperset") || result.contains("is_superset") || !result.is_empty()
        );
    }
...
";
        let result = transpile(py);
        assert!(result.contains("update") || result.contains("extend") || !result.is_empty());
    }
...
";
        let result = transpile(py);
        assert!(
            result.contains("isdisjoint") || result.contains("is_disjoint") || !result.is_empty()
        );
    }
...
";
        let result = transpile(py);
        assert!(result.contains("index") || !result.is_empty());
    }
...
";
        let result = transpile(py);
        assert!(result.contains("count") || !result.is_empty());
    }
...
"#;
        let result = transpile(py);
        assert!(result.contains("center") || !result.is_empty());
    }
...
"#;
        let result = transpile(py);
        assert!(result.contains("ljust") || !result.is_empty());
    }
...
"#;
        let result = transpile(py);
        assert!(result.contains("rjust") || !result.is_empty());
    }
...
"#;
        let result = transpile(py);
        assert!(result.contains("zfill") || !result.is_empty());
    }
...
"#;
        let result = transpile(py);
        assert!(result.contains("expandtabs") || !result.is_empty());
    }
...
"#;
        let result = transpile(py);
        assert!(result.contains("encode") || !result.is_empty());
    }
...
"#;
        let result = transpile(py);
        assert!(result.contains("index") || result.contains("find") || !result.is_empty());
    }
...
"#;
        let result = transpile(py);
        assert!(result.contains("rindex") || result.contains("rfind") || !result.is_empty());
    }
...
"#;
        let result = transpile(py);
        assert!(result.contains("partition") || !result.is_empty());
    }
...
"#;
        let result = transpile(py);
        assert!(result.contains("rpartition") || !result.is_empty());
    }
...
"#;
        let result = transpile(py);
        assert!(result.contains("swapcase") || !result.is_empty());
    }
...
"#;
        let result = transpile(py);
        assert!(result.contains("title") || !result.is_empty());
    }
...
"#;
        let result = transpile(py);
        assert!(result.contains("capitalize") || !result.is_empty());
    }
...
"#;
        let result = transpile(py);
        assert!(result.contains("casefold") || result.contains("lowercase") || !result.is_empty());
    }
...
"#;
        let result = transpile(py);
        assert!(
            result.contains("isalnum") || result.contains("is_alphanumeric") || !result.is_empty()
        );
    }
...
"#;
        let result = transpile(py);
        assert!(result.contains("isdigit") || result.contains("is_numeric") || !result.is_empty());
    }
...
"#;
        let result = transpile(py);
        assert!(result.contains("istitle") || !result.is_empty());
    }
...
"#;
        let result = transpile(py);
        assert!(
            result.contains("startswith") || result.contains("starts_with") || !result.is_empty()
        );
    }
...
"#;
        let result = transpile(py);
        assert!(result.contains("endswith") || result.contains("ends_with") || !result.is_empty());
    }
...
"#;
        let result = transpile(py);
        assert!(result.contains("decode") || !result.is_empty());
    }
...
"#;
        let result = transpile(py);
        assert!(result.contains("hex") || !result.is_empty());
    }
...
";
        let result = transpile(py);
        assert!(result.contains("map") || !result.is_empty());
    }
...
";
        let result = transpile(py);
        assert!(result.contains("filter") || !result.is_empty());
    }
...
";
        let result = transpile(py);
        assert!(result.contains("reversed") || result.contains("reverse") || !result.is_empty());
    }
...
";
        let result = transpile(py);
        assert!(result.contains("sorted") || result.contains("sort") || !result.is_empty());
    }
...
";
        let result = transpile(py);
        assert!(result.contains("any") || !result.is_empty());
    }
...
";
        let result = transpile(py);
        assert!(result.contains("all") || !result.is_empty());
    }
...
";
        let result = transpile(py);
        assert!(result.contains("sum") || !result.is_empty());
    }
...
";
        let result = transpile(py);
        assert!(result.contains("next") || result.contains("iter") || !result.is_empty());
    }
...
"#;
        let result = transpile(py);
        assert!(result.contains("open") || result.contains("File") || !result.is_empty());
    }
...
"#;
        let result = transpile(py);
        assert!(result.contains("read") || !result.is_empty());
    }
...
"#;
        let result = transpile(py);
        assert!(result.contains("readline") || result.contains("read_line") || !result.is_empty());
    }
...
"#;
        let result = transpile(py);
        assert!(
            result.contains("readlines") || result.contains("read_to_string") || !result.is_empty()
        );
    }
...
"#;
        let result = transpile(py);
        assert!(result.contains("writelines") || result.contains("write") || !result.is_empty());
    }
...
"#;
        let result = transpile(py);
        assert!(result.contains("print") || !result.is_empty());
    }
...
"#;
        let result = transpile(py);
        assert!(result.contains("seek") || !result.is_empty());
    }
...
"#;
        let result = transpile(py);
        assert!(result.contains("tell") || !result.is_empty());
    }
...
"#;
        let result = transpile(py);
        assert!(result.contains("close") || !result.is_empty());
    }
...
"#;
        let result = transpile(py);
        assert!(result.contains("flush") || !result.is_empty());
    }
}
