...
use crate::hir::{AssignTarget, HirComprehension, HirExpr, HirFunction, HirStmt, Type};
    ...
    fn analyze_expr_for_param(
        ...
        match expr {
            ...
            HirExpr::Slice { base, start, stop, step } => {
                self.analyze_slice_for_param(param, base, start, stop, step, usage, in_loop, in_return);
            }
            HirExpr::Borrow { expr, .. } => {
